...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/realms/RealmsScreen.class */
public abstract class RealmsScreen extends Screen {
    ...
    protected RealmsLabel addLabel(RealmsLabel $$0) {
        this.labels.add($$0);
        return (RealmsLabel) addRenderableOnly($$0);
    }

    public Component createLabelNarration() {
        return CommonComponents.joinLines((Collection<? extends Component>) this.labels.stream().map((v0) -> {
            return v0.getText();
