...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/tags/BiomeTags.class */
public class BiomeTags {
    ...
    private static TagKey<Biome> create(String $$0) {
        return TagKey.create(Registries.BIOME, Identifier.withDefaultNamespace($$0));
    }
}
