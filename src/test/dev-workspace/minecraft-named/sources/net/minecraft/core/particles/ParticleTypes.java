...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/core/particles/ParticleTypes.class */
public class ParticleTypes {
    ...
    public static final ParticleType<DustParticleOptions> DUST = register("dust", false, $$0 -> {
        return DustParticleOptions.CODEC;
    }, $$02 -> {
        return DustParticleOptions.STREAM_CODEC;
    });
    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register("dust_color_transition", false, $$0 -> {
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register("sculk_charge", true, $$0 -> {
    ...
    public static final ParticleType<ItemParticleOption> ITEM = register(DecoratedPotBlockEntity.TAG_ITEM, false, ItemParticleOption::codec, ItemParticleOption::streamCodec);
    public static final ParticleType<VibrationParticleOption> VIBRATION = register("vibration", true, $$0 -> {
        return VibrationParticleOption.CODEC;
    }, $$02 -> {
        return VibrationParticleOption.STREAM_CODEC;
    });
    public static final ParticleType<TrailParticleOption> TRAIL = register("trail", false, $$0 -> {
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = register("shriek", false, $$0 -> {
    ...
    public static final Codec<ParticleOptions> CODEC = BuiltInRegistries.PARTICLE_TYPE.byNameCodec().dispatch(ChunkRegionIoEvent.Fields.TYPE, (v0) -> {
        return v0.getType();
    }, (v0) -> {
        return v0.codec();
    });
    ...
    private static SimpleParticleType register(String $$0, boolean $$1) {
        return (SimpleParticleType) Registry.register(BuiltInRegistries.PARTICLE_TYPE, $$0, new SimpleParticleType($$1));
    }
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(String $$0, boolean $$1, final Function<ParticleType<T>, MapCodec<T>> $$2, final Function<ParticleType<T>, StreamCodec<? super RegistryFriendlyByteBuf, T>> $$3) {
        return (ParticleType) Registry.register(BuiltInRegistries.PARTICLE_TYPE, $$0, new ParticleType<T>($$1) { // from class: net.minecraft.core.particles.ParticleTypes.1
