...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/util/datafix/fixes/ItemStackTheFlatteningFix.class */
public class ItemStackTheFlatteningFix extends DataFix {
    ...
    private static final Set<String> IDS = (Set) MAP.keySet().stream().map($$0 -> {
        return $$0.substring(0, $$0.indexOf(46));
    ...
    public TypeRewriteRule makeRule() {
        ...
        return fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, $$22 -> {
            Optional<Pair<String, String>> $$3 = $$22.getOptional($$1);
            if ($$3.isEmpty()) {
                return $$22;
            }
            Typed typed = $$22;
            Dynamic<?> $$5 = (Dynamic) $$22.get(DSL.remainderFinder());
            int $$6 = $$5.get("Damage").asInt(0);
            String $$7 = updateItem((String) $$3.get().getSecond(), $$6);
            if ($$7 != null) {
                typed = typed.set($$1, Pair.of(References.ITEM_NAME.typeName(), $$7));
            }
            if (DAMAGE_IDS.contains($$3.get().getSecond())) {
                Typed<?> $$8 = $$22.getOrCreateTyped($$2);
                Dynamic<?> $$9 = (Dynamic) $$8.get(DSL.remainderFinder());
                typed = typed.set($$2, $$8.set(DSL.remainderFinder(), $$9.set("Damage", $$9.createInt($$6))));
            }
            Typed<?> $$4 = typed.set(DSL.remainderFinder(), $$5.remove("Damage"));
            return $$4;
        });
    }
