...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/util/datafix/fixes/ItemLoreFix.class */
public class ItemLoreFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return fixTypeEverywhereTyped("Item Lore componentize", $$0, $$42 -> {
