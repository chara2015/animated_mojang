...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/util/datafix/fixes/ItemStackSpawnEggFix.class */
public class ItemStackSpawnEggFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + getOutputSchema().getVersionKey(), $$0, $$42 -> {
            Optional<Pair<String, String>> $$5 = $$42.getOptional($$1);
            if ($$5.isPresent() && Objects.equals($$5.get().getSecond(), this.itemType)) {
                Typed<?> $$6 = $$42.getOrCreateTyped($$3);
                Typed<?> $$7 = $$6.getOrCreateTyped($$4);
                Optional<String> $$8 = $$7.getOptional($$2);
                if ($$8.isPresent()) {
                    return $$42.set($$1, Pair.of(References.ITEM_NAME.typeName(), MAP.getOrDefault($$8.get(), "minecraft:pig_spawn_egg")));
                }
            }
            return $$42;
        });
