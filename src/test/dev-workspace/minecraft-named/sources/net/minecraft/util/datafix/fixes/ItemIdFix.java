...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/util/datafix/fixes/ItemIdFix.class */
public class ItemIdFix extends DataFix {
    private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap) DataFixUtils.make(new Int2ObjectOpenHashMap(), $$0 -> {
        ...
        $$0.put(ClientboundGameEventPacket.DEMO_PARAM_HINT_1, "minecraft:iron_bars");
        $$0.put(ClientboundGameEventPacket.DEMO_PARAM_HINT_2, "minecraft:glass_pane");
        $$0.put(ClientboundGameEventPacket.DEMO_PARAM_HINT_3, "minecraft:melon_block");
        $$0.put(LivingEntity.SADDLE_OFFSET, "minecraft:vine");
        ...
        $$0.put(AdvancementsScreen.WINDOW_INSIDE_HEIGHT, "minecraft:nether_brick_fence");
        $$0.put(BookEditScreen.TEXT_WIDTH, "minecraft:nether_brick_stairs");
        ...
        $$0.put(BookEditScreen.TEXT_HEIGHT, "minecraft:wooden_slab");
        ...
        $$0.put(RecipeBookComponent.IMAGE_WIDTH, "minecraft:light_weighted_pressure_plate");
        ...
        $$0.put(TutorialToast.PROGRESS_BAR_WIDTH, "minecraft:hopper");
        ...
        $$0.put(InputConstants.KEY_RETURN, "minecraft:iron_pickaxe");
        $$0.put(InputConstants.KEY_TAB, "minecraft:iron_axe");
        $$0.put(InputConstants.KEY_BACKSPACE, "minecraft:flint_and_steel");
        $$0.put(260, "minecraft:apple");
        $$0.put(InputConstants.KEY_DELETE, "minecraft:bow");
        $$0.put(InputConstants.KEY_RIGHT, "minecraft:arrow");
        $$0.put(InputConstants.KEY_LEFT, "minecraft:coal");
        $$0.put(InputConstants.KEY_DOWN, "minecraft:diamond");
        $$0.put(InputConstants.KEY_UP, "minecraft:iron_ingot");
        $$0.put(InputConstants.KEY_PAGEUP, "minecraft:gold_ingot");
        $$0.put(InputConstants.KEY_PAGEDOWN, "minecraft:iron_sword");
        $$0.put(InputConstants.KEY_HOME, "minecraft:wooden_sword");
        $$0.put(InputConstants.KEY_END, "minecraft:wooden_shovel");
        ...
        $$0.put(InputConstants.KEY_CAPSLOCK, "minecraft:stick");
        $$0.put(InputConstants.KEY_SCROLLLOCK, "minecraft:bowl");
        $$0.put(InputConstants.KEY_NUMLOCK, "minecraft:mushroom_stew");
        $$0.put(InputConstants.KEY_PRINTSCREEN, "minecraft:golden_sword");
        $$0.put(InputConstants.KEY_PAUSE, "minecraft:golden_shovel");
        $$0.put(285, "minecraft:golden_pickaxe");
        $$0.put(SharedConstants.SNAPSHOT_NETWORK_PROTOCOL_VERSION, "minecraft:golden_axe");
        $$0.put(287, "minecraft:string");
        $$0.put(288, "minecraft:feather");
        $$0.put(289, "minecraft:gunpowder");
        $$0.put(InputConstants.KEY_F1, "minecraft:wooden_hoe");
        $$0.put(InputConstants.KEY_F2, "minecraft:stone_hoe");
        $$0.put(InputConstants.KEY_F3, "minecraft:iron_hoe");
        $$0.put(InputConstants.KEY_F4, "minecraft:diamond_hoe");
        $$0.put(InputConstants.KEY_F5, "minecraft:golden_hoe");
        $$0.put(InputConstants.KEY_F6, "minecraft:wheat_seeds");
        $$0.put(InputConstants.KEY_F7, "minecraft:wheat");
        $$0.put(InputConstants.KEY_F8, "minecraft:bread");
        $$0.put(InputConstants.KEY_F9, "minecraft:leather_helmet");
        $$0.put(InputConstants.KEY_F10, "minecraft:leather_chestplate");
        $$0.put(300, "minecraft:leather_leggings");
        $$0.put(InputConstants.KEY_F12, "minecraft:leather_boots");
        $$0.put(InputConstants.KEY_F13, "minecraft:chainmail_helmet");
        $$0.put(InputConstants.KEY_F14, "minecraft:chainmail_chestplate");
        $$0.put(InputConstants.KEY_F15, "minecraft:chainmail_leggings");
        $$0.put(InputConstants.KEY_F16, "minecraft:chainmail_boots");
        $$0.put(InputConstants.KEY_F17, "minecraft:iron_helmet");
        $$0.put(InputConstants.KEY_F18, "minecraft:iron_chestplate");
        $$0.put(InputConstants.KEY_F19, "minecraft:iron_leggings");
        $$0.put(InputConstants.KEY_F20, "minecraft:iron_boots");
        $$0.put(310, "minecraft:diamond_helmet");
        $$0.put(InputConstants.KEY_F22, "minecraft:diamond_chestplate");
        $$0.put(InputConstants.KEY_F23, "minecraft:diamond_leggings");
        $$0.put(InputConstants.KEY_F24, "minecraft:diamond_boots");
        $$0.put(InputConstants.KEY_F25, "minecraft:golden_helmet");
        ...
        $$0.put(InputConstants.KEY_NUMPAD1, "minecraft:painting");
        $$0.put(InputConstants.KEY_NUMPAD2, "minecraft:golden_apple");
        $$0.put(InputConstants.KEY_NUMPAD3, "minecraft:sign");
        $$0.put(InputConstants.KEY_NUMPAD4, "minecraft:wooden_door");
        $$0.put(InputConstants.KEY_NUMPAD5, "minecraft:bucket");
        $$0.put(InputConstants.KEY_NUMPAD6, "minecraft:water_bucket");
        $$0.put(InputConstants.KEY_NUMPAD7, "minecraft:lava_bucket");
        $$0.put(InputConstants.KEY_NUMPAD8, "minecraft:minecart");
        $$0.put(InputConstants.KEY_NUMPAD9, "minecraft:saddle");
        $$0.put(InputConstants.KEY_NUMPADCOMMA, "minecraft:iron_door");
        $$0.put(331, "minecraft:redstone");
        $$0.put(332, "minecraft:snowball");
        $$0.put(333, "minecraft:boat");
        $$0.put(InputConstants.KEY_ADD, "minecraft:leather");
        $$0.put(InputConstants.KEY_NUMPADENTER, "minecraft:milk_bucket");
        $$0.put(InputConstants.KEY_NUMPADEQUALS, "minecraft:brick");
        $$0.put(337, "minecraft:clay_ball");
        $$0.put(338, "minecraft:reeds");
        $$0.put(339, "minecraft:paper");
        $$0.put(InputConstants.KEY_LSHIFT, "minecraft:book");
        $$0.put(InputConstants.KEY_LCONTROL, "minecraft:slime_ball");
        $$0.put(InputConstants.KEY_LALT, "minecraft:chest_minecart");
        $$0.put(InputConstants.KEY_LSUPER, "minecraft:furnace_minecart");
        $$0.put(InputConstants.KEY_RSHIFT, "minecraft:egg");
        $$0.put(InputConstants.KEY_RCONTROL, "minecraft:compass");
        $$0.put(InputConstants.KEY_RALT, "minecraft:fishing_rod");
        $$0.put(InputConstants.KEY_RSUPER, "minecraft:clock");
        ...
        $$0.put(OfferFlowerGoal.OFFER_TICKS, "minecraft:pumpkin_pie");
        $$0.put(RealmsError.AuthenticationError.ERROR_CODE, "minecraft:fireworks");
        ...
        $$0.defaultReturnValue(JigsawBlockEntity.DEFAULT_FINAL_STATE);
    });
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder(Entity.TAG_ID, $$0);
        return fixTypeEverywhereTyped("ItemIdFix", getInputSchema().getType(References.ITEM_STACK), getOutputSchema().getType(References.ITEM_STACK), $$22 -> {
            return $$22.update($$2, $$1, $$02 -> {
                return (Pair) $$02.map($$02 -> {
                    return Pair.of(References.ITEM_NAME.typeName(), getItem($$02.intValue()));
                }, $$03 -> {
                    return $$03;
                });
            });
