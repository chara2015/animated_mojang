...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/level/storage/loot/predicates/LootItemConditions.class */
public class LootItemConditions {
    ...
    private static LootItemConditionType register(String $$0, MapCodec<? extends LootItemCondition> $$1) {
        return (LootItemConditionType) Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, Identifier.withDefaultNamespace($$0), new LootItemConditionType($$1));
    }
}
