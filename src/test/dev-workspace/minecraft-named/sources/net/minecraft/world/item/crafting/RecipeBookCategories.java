...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/item/crafting/RecipeBookCategories.class */
public class RecipeBookCategories {
    ...
    private static RecipeBookCategory register(String $$0) {
        return (RecipeBookCategory) Registry.register(BuiltInRegistries.RECIPE_BOOK_CATEGORY, $$0, new RecipeBookCategory());
    }
