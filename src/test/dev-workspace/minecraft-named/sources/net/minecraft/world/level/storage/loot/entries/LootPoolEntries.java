...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/level/storage/loot/entries/LootPoolEntries.class */
public class LootPoolEntries {
    public static final Codec<LootPoolEntryContainer> CODEC = BuiltInRegistries.LOOT_POOL_ENTRY_TYPE.byNameCodec().dispatch((v0) -> {
        return v0.getType();
    }, (v0) -> {
        return v0.codec();
    });
    public static final LootPoolEntryType EMPTY = register("empty", EmptyLootItem.CODEC);
    public static final LootPoolEntryType ITEM = register(DecoratedPotBlockEntity.TAG_ITEM, LootItem.CODEC);
    ...
    private static LootPoolEntryType register(String $$0, MapCodec<? extends LootPoolEntryContainer> $$1) {
        return (LootPoolEntryType) Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, Identifier.withDefaultNamespace($$0), new LootPoolEntryType($$1));
    }
}
