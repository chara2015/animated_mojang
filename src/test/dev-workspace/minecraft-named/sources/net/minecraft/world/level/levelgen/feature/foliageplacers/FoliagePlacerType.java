...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/level/levelgen/feature/foliageplacers/FoliagePlacerType.class */
public class FoliagePlacerType<P extends FoliagePlacer> {
    ...
    private static <P extends FoliagePlacer> FoliagePlacerType<P> register(String $$0, MapCodec<P> $$1) {
        return (FoliagePlacerType) Registry.register(BuiltInRegistries.FOLIAGE_PLACER_TYPE, $$0, new FoliagePlacerType($$1));
    }
