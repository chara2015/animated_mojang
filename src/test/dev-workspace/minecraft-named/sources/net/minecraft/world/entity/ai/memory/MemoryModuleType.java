...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/entity/ai/memory/MemoryModuleType.class */
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<Set<GlobalPos>> VISITED_BLOCK_POSITIONS = register("visited_block_positions", GlobalPos.CODEC.listOf().xmap((v0) -> {
        return Sets.newHashSet(v0);
    }, (v0) -> {
        return Lists.newArrayList(v0);
    }));
    public static final MemoryModuleType<Set<GlobalPos>> UNREACHABLE_TRANSPORT_BLOCK_POSITIONS = register("unreachable_transport_block_positions", GlobalPos.CODEC.listOf().xmap((v0) -> {
        return Sets.newHashSet(v0);
    }, (v0) -> {
        return Lists.newArrayList(v0);
    }));
    ...
    public static final MemoryModuleType<UUID> ANGRY_AT = register(NeutralMob.TAG_ANGRY_AT, UUIDUtil.CODEC);
    ...
    private static <U> MemoryModuleType<U> register(String $$0, Codec<U> $$1) {
        return (MemoryModuleType) Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, Identifier.withDefaultNamespace($$0), new MemoryModuleType(Optional.of($$1)));
    }

    private static <U> MemoryModuleType<U> register(String $$0) {
        return (MemoryModuleType) Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, Identifier.withDefaultNamespace($$0), new MemoryModuleType(Optional.empty()));
    }
}
