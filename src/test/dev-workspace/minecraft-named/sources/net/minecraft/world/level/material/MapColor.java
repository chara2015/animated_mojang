...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/level/material/MapColor.class */
public class MapColor {
    ...
    public static final MapColor FIRE = new MapColor(4, DustParticleOptions.REDSTONE_PARTICLE_COLOR);
    ...
    public static int getColorFromPackedId(int $$0) {
        int $$1 = $$0 & 255;
        return byIdUnsafe($$1 >> 2).calculateARGBColor(Brightness.byIdUnsafe($$1 & 3));
    }
    ...
    /* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/world/level/material/MapColor$Brightness.class */
