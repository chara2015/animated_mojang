...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/client/data/models/model/ModelTemplates.class */
public class ModelTemplates {
    public static final ModelTemplate CUBE = create(PartNames.CUBE, TextureSlot.PARTICLE, TextureSlot.NORTH, TextureSlot.SOUTH, TextureSlot.EAST, TextureSlot.WEST, TextureSlot.UP, TextureSlot.DOWN);
    ...
    public static final ModelTemplate[] STEMS = (ModelTemplate[]) IntStream.range(0, 8).mapToObj($$0 -> {
        return create("stem_growth" + $$0, "_stage" + $$0, TextureSlot.STEM);
    }).toArray($$02 -> {
        return new ModelTemplate[$$02];
    });
    ...
    public static final ModelTemplate DRIED_GHAST = create("dried_ghast", TextureSlot.PARTICLE, TextureSlot.TOP, TextureSlot.BOTTOM, TextureSlot.NORTH, TextureSlot.SOUTH, TextureSlot.EAST, TextureSlot.WEST, TextureSlot.TENTACLES);
    ...
    private static ModelTemplate create(String $$0, TextureSlot... $$1) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("block/" + $$0)), Optional.empty(), $$1);
    }

    private static ModelTemplate createItem(String $$0, TextureSlot... $$1) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("item/" + $$0)), Optional.empty(), $$1);
    }

    private static ModelTemplate createItem(String $$0, String $$1, TextureSlot... $$2) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("item/" + $$0)), Optional.of($$1), $$2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static ModelTemplate create(String $$0, String $$1, TextureSlot... $$2) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("block/" + $$0)), Optional.of($$1), $$2);
    }
}
