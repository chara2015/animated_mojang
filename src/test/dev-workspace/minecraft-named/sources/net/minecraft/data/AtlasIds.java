...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/data/AtlasIds.class */
public class AtlasIds {
    ...
    public static final Identifier BLOCKS = Identifier.withDefaultNamespace(StructureTemplate.BLOCKS_TAG);
