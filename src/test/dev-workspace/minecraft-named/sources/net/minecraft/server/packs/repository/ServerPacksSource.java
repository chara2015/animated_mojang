...
/* JADX INFO: loaded from: minecraft-client-1.21.11-named.jar:net/minecraft/server/packs/repository/ServerPacksSource.class */
public class ServerPacksSource extends BuiltInPackSource {
    ...
    public static PackRepository createVanillaTrustedRepository() {
        return new PackRepository(new ServerPacksSource(new DirectoryValidator($$0 -> {
            return true;
        })));
    }
