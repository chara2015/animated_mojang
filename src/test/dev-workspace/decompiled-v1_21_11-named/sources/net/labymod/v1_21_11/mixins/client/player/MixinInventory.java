...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/player/MixinInventory.class */
...
public class MixinInventory implements net.labymod.api.client.entity.player.Inventory {
    ...
    @Shadow
    @Final
    public NonNullList<ItemStack> l;
    ...
    public net.labymod.api.client.world.item.ItemStack itemStackAt(int index) {
        try {
            ItemStack itemStack = (ItemStack) this.l.get(index);
