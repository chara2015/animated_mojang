...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/renderer/entity/layers/MixinCapeLayer.class */
@Mixin({CapeLayer.class})
public class MixinCapeLayer {

    @Shadow
    @Final
    private HumanoidModel<AvatarRenderState> a;
