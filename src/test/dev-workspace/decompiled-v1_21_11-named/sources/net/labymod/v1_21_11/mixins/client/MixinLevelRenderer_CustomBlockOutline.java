...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/MixinLevelRenderer_CustomBlockOutline.class */
@Mixin({LevelRenderer.class})
public class MixinLevelRenderer_CustomBlockOutline {

    @Shadow
    private ClientLevel s;

    @Shadow
    @Final
    private RenderBuffers m;
    ...
    private void labyMod$renderCustomBlockOutline(LevelRenderer instance, PoseStack poseStack, VertexConsumer lineConsumer, double x, double y, double z, BlockOutlineRenderState state, int color, float lineWidth, Operation<Void> original) {
        BlockOutlineUtil.renderBlockOutline(this.s, this.m.bufferSource(), lineConsumer, poseStack, x, y, z, state, color, lineWidth);
    }
}
