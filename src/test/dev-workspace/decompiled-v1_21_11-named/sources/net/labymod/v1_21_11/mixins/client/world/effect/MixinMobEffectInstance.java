package net.labymod.v1_21_11.mixins.client.world.effect;
...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/world/effect/MixinMobEffectInstance.class */
...
public abstract class MixinMobEffectInstance implements PotionEffect {
    ...
    public String getTranslationKey() {
        TranslatableComponent translatableComponentFromMinecraftComponent = Laby.labyAPI().minecraft().componentMapper().fromMinecraftComponent(((MobEffect) this.g.value()).getDisplayName());
        if (translatableComponentFromMinecraftComponent instanceof TranslatableComponent) {
            return translatableComponentFromMinecraftComponent.key();
        }
    ...
    public void renderIcon(ScreenContext context, int x, int y, int width, int height) {
        ...
        if (this.labyMod$graphics == null) {
            ...
            this.labyMod$graphics = new GuiGraphics(minecraft, GameRendererAccessor.self(Minecraft.getInstance().gameRenderer).labyMod$getGuiRenderState(), 0, 0);
        }
    ...
    private Identifier labyMod$cacheIcon() {
        ...
        Identifier resourceLocation = BuiltInRegistries.MOB_EFFECT.getKey((MobEffect) this.g.value());
        if (resourceLocation == null) {
            return null;
        }
        this.labyMod$iconSprite = Gui.getMobEffectSprite(this.g);
        return this.labyMod$iconSprite;
    }
}
