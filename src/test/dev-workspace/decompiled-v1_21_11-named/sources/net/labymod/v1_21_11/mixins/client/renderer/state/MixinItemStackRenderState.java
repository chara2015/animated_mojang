...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/renderer/state/MixinItemStackRenderState.class */
@Mixin({ItemStackRenderState.class})
public class MixinItemStackRenderState implements ItemStackRenderStateAccessor {

    @Shadow
    private ItemDisplayContext a;
