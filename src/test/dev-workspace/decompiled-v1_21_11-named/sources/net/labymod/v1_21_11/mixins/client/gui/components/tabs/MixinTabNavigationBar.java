package net.labymod.v1_21_11.mixins.client.gui.components.tabs;
...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
...
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends AbstractContainerEventHandler implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    ...
    @Override // net.labymod.v1_21_11.client.gui.TabNavigationBarAccessor
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        ...
        Laby.labyAPI().minecraft().updateMouse(mouseX, mouseY, mouse -> {
            boolean rendered = this.watcher.render(Stack.create(JomlMatrix3x2fStackProvider.fromGuiGraphics(graphics)), mouse, partialTicks);
            if (rendered) {
                ci.cancel();
            }
        });
