package net.labymod.v1_21_11.client.world.lighting;
...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/world/lighting/VersionedLightingLayerMapper.class */
@Singleton
...
public class VersionedLightingLayerMapper implements LightingLayerMapper {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_11.client.world.lighting.VersionedLightingLayerMapper$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/world/lighting/VersionedLightingLayerMapper$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$LightLayer;
        static final /* synthetic */ int[] $SwitchMap$net$labymod$api$client$world$lighting$LightType = new int[LightType.values().length];
    ...
    public Object toMinecraft(LightType value) throws MatchException {
        switch (AnonymousClass1.$SwitchMap$net$labymod$api$client$world$lighting$LightType[value.ordinal()]) {
            case 1:
