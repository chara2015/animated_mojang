...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/gui/screens/MixinLanguageSelectScreen.class */
...
public class MixinLanguageSelectScreen {
    ...
    private boolean labyMod$fasterLanguageReload(Minecraft instance) {
        boolean fastLanguageReload = ((Boolean) Laby.labyAPI().config().other().fastLanguageReload().get()).booleanValue();
        if (fastLanguageReload) {
            this.v.onResourceManagerReload(instance.getResourceManager());
