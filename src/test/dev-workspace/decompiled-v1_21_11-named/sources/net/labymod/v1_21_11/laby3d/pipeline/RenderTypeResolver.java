...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/laby3d/pipeline/RenderTypeResolver.class */
public final class RenderTypeResolver {
    ...
    private static final Function<LevelMaterial, RenderType> DYNAMIC_TYPES = MEMOIZE.memoize(levelMaterial -> {
        RenderSetup.RenderSetupBuilder builder = RenderSetup.builder((RenderPipeline) LINKER.get(levelMaterial.renderState())).bufferSize(SMALL_BUFFER_SIZE);
