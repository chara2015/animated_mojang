...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/laby3d/buffer/VersionedGameVertexConsumer.class */
public class VersionedGameVertexConsumer implements GameVertexConsumer {
    ...
    public net.labymod.laby3d.api.vertex.VertexConsumer setPackedLight(int lightCoords) {
        short u = (short) (lightCoords & MASK);
        short v = (short) ((lightCoords >> SHIFT) & MASK);
    ...
    public net.labymod.laby3d.api.vertex.VertexConsumer setPackedOverlay(int overlayCoords) {
        short u = (short) (overlayCoords & MASK);
        short v = (short) ((overlayCoords >> SHIFT) & MASK);
