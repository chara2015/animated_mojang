package net.labymod.v1_21_4.mixins.server.network;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/server/network/MixinServerGamePacketListenerImpl.class */
@Mixin({asg.class})
public class MixinServerGamePacketListenerImpl {
    ...
    private void labyMod$fireDisconnectEventPre(wp reason, InsertInfo ci) {
    ...
    private void labyMod$fireDisconnectEventPost(wp reason, InsertInfo ci) {
        GameProfile profile = this.f.gh();
