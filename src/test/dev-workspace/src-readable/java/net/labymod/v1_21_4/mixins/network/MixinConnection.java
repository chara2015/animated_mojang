package net.labymod.v1_21_4.mixins.network;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/network/MixinConnection.class */
@Mixin({vi.class})
...
public abstract class MixinConnection implements NettyConnection {
    ...
    public wp labyMod4$modifyReason(wp component) {
        ...
        return (wp) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY))).reason());
    }
}
