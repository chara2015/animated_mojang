...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/gui/MixinPlayerTabOverlay.class */
@Mixin({fpv.class})
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(fof graphics, int screenWidth, fcg scoreboard, fby objective, InsertInfo ci) {
