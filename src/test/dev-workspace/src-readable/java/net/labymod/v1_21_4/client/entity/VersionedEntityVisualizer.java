...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        cjw cjwVar = (bum) entity;
        if (cjwVar instanceof cjt) {
            cjt part = (cjt) cjwVar;
            cjwVar = part.a;
        }
        ...
        dispatcher.a(cjwVar, 0.0d, 0.0d, 0.0d, context.getTickDelta(), (ffv) context.stack().getProvider().getPoseStack(), flk.Q().aR().c(), RenderEnvironmentContext.FULL_BRIGHT);
        fer.d();
