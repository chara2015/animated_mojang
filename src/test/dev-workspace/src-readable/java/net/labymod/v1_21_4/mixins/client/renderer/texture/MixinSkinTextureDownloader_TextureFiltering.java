...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/renderer/texture/MixinSkinTextureDownloader_TextureFiltering.class */
@Mixin({hem.class})
public class MixinSkinTextureDownloader_TextureFiltering {
    ...
    private static void labyMod$setTextureFiltering(hev instance, akv $$0, hee $$1, Operation<Void> original) {
