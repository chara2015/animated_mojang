package net.labymod.v1_21_4.client.render.model;

import net.labymod.api.util.math.Transformation;
import net.labymod.api.util.math.vector.FloatVector3;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/render/model/ModelPartAnimationTransformation.class */
public class ModelPartAnimationTransformation extends Transformation {
    public ModelPartAnimationTransformation(gfe modelPart, Transformation modelPartTransform) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/render/model/ModelPartAnimationTransformation$ModelPartPositionVector.class */
    private static class ModelPartPositionVector extends FloatVector3 {
        private final gfe modelPart;
        private final FloatVector3 modelPartTranslation;

        public ModelPartPositionVector(gfe modelPart, FloatVector3 modelPartTranslation) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/render/model/ModelPartAnimationTransformation$ModelPartRotationVector.class */
    private static class ModelPartRotationVector extends FloatVector3 {
        private final gfe modelPart;

        public ModelPartRotationVector(gfe modelPart) {
            this.modelPart = modelPart;
        }
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/render/model/ModelPartAnimationTransformation$ModelPartScaleVector.class */
    private static class ModelPartScaleVector extends FloatVector3 {
        private final gfe modelPart;

        public ModelPartScaleVector(gfe modelPart) {
            this.modelPart = modelPart;
        }
