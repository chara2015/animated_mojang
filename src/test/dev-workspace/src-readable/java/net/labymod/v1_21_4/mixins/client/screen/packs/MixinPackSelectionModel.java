package net.labymod.v1_21_4.mixins.client.screen.packs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({fyb.class})
public class MixinPackSelectionModel {
    ...
    private List<atx> getAvailablePacks() {
        List<atx> list = new ArrayList<>();
        for (atx pack : this.a.d()) {
