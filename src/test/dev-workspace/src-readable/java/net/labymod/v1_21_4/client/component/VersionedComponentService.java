package net.labymod.v1_21_4.client.component;
...
import net.labymod.v1_21_4.client.network.chat.serializer.VersionedComponentSerializerWrapper;
import net.labymod.v1_21_4.client.network.chat.serializer.VersionedStyleSerializer;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/component/VersionedComponentService.class */
@Singleton
...
public class VersionedComponentService extends ComponentService {
    ...
    public TextComponent createTextComponent(String text) {
        return (TextComponent) wp.b(text).getLabyComponent();
    }
    ...
    protected IconComponent createIconComponent(Icon icon) {
        return (IconComponent) xd.a(new VersionedIconContents(icon)).getLabyComponent();
    }
    ...
    public TextComponent createEmptyComponent() {
        return (TextComponent) wp.i().getLabyComponent();
    }
    ...
    public <T> HoverEvent<T> createHoverEvent(@NotNull HoverEvent.Action<T> action, @NotNull T t) {
        ...
        if (action == HoverEvent.Action.SHOW_TEXT) {
            if (t instanceof VersionedBaseComponent) {
                ...
                return new wv<>(a.a, component.holder);
            }
    ...
    public ClickEvent createClickEvent(ClickEvent.Action action, @NotNull String value) {
        ...
        return new wn(vanillaAction, value);
    }
    ...
    public TextColor getParsedTextColor(String value) {
        DataResult<xo> result = xo.a(value);
    ...
    public TranslatableComponent createTranslatableComponent(String key, Component... arguments) {
        return (TranslatableComponent) wp.a(key, arguments).getLabyComponent();
    }
    ...
    public TranslatableComponent createTranslatableComponent(String key, Style style, List<Component> children, List<Component> arguments) {
        ya contents;
        if (arguments == null) {
            contents = new ya(key, key, new Object[0]);
        } else {
            contents = new ya(key, key, arguments.toArray(new Component[0]));
        }
    ...
    public Style getEmptyStyle() {
        xm style = xm.a;
        if (style == null) {
            style = new xm((xo) null, (Integer) null, (Boolean) null, (Boolean) null, (Boolean) null, (Boolean) null, (Boolean) null, (wn) null, (wv) null, (String) null, (akv) null);
        }
        return (Style) style;
    }
    ...
    public Style createStyleFromBuilder(TextColor color, Integer shadowColor, Boolean bold, Boolean italic, Boolean underlined, Boolean strikethrough, Boolean obfuscated, ClickEvent clickEvent, HoverEvent<?> hoverEvent, String insertion, GlyphSourceDescription glyphSourceDescription) throws MatchException {
        akv akvVar;
        xo xoVar = (xo) color;
        wn wnVar = (wn) clickEvent;
        wv wvVar = (wv) hoverEvent;
        if (glyphSourceDescription instanceof GlyphSourceDescription.Resource) {
            try {
                ...
                akvVar = (akv) id.getMinecraftLocation();
            } catch (Throwable th) {
        ...
        return new xm(xoVar, shadowColor, bold, italic, underlined, strikethrough, obfuscated, wnVar, wvVar, insertion, akvVar);
    }
    ...
    public Serializer createStyleSerializer() {
        return new VersionedStyleSerializer();
    }
    ...
    private Component applyStyleAndSiblings(wq componentContents, Style style, List<Component> children) {
        xm vanillaStyle;
        if (style == null) {
            vanillaStyle = xm.a;
        } else {
            vanillaStyle = (xm) style;
        }
        Component result = new xd(componentContents, new ArrayList(), vanillaStyle).getLabyComponent();
        if (children != null) {
