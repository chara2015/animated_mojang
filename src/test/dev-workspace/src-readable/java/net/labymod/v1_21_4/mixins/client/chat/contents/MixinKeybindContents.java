...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/chat/contents/MixinKeybindContents.class */
@Mixin({xt.class})
public abstract class MixinKeybindContents implements KeybindContentsAccessor {
    ...
    @Shadow
    protected abstract wp c();

    @Override // net.labymod.v1_21_4.client.network.chat.contents.KeybindContentsAccessor
