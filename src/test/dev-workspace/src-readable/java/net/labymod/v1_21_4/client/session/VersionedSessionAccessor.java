...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/session/VersionedSessionAccessor.class */
@Singleton
...
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<flw> {
    ...
    public flw toGameSession(Session session) {
        return (flw) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(flw gameSession) {
        if (gameSession == null) {
            return null;
        }
