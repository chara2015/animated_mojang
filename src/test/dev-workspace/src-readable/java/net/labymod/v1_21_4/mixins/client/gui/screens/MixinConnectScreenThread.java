...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/gui/screens/MixinConnectScreenThread.class */
...
public class MixinConnectScreenThread {
    ...
    private Optional<ghr> labyMod$resolveAddress(ghu resolver, ghs address) {
        InetSocketAddress resolved = ConnectAddressResolver.resolve(address.a(), address.b(), this.e);
        return resolved == null ? Optional.empty() : Optional.of(ghr.a(resolved));
    }
    ...
    public wp labyMod$fireServerKickEvent(wp reason) {
        ...
        return (wp) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN))).reason());
    }
}
