package net.labymod.v1_21_4.mixins.client.gui.components.tabs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({fqz.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fqp implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    private final WidgetWatcher<T> watcher = new WidgetWatcher<>();
    private final Map<fqx, TabNavigationBarAccessor.VersionedTab> versionedTabs = new HashMap();

    @Shadow
    @Final
    private ImmutableList<fqx> i;

    @Shadow
    @Final
    private fqy h;
    private fqx labyMod$currentTab;

    @Override // net.labymod.v1_21_4.client.gui.TabNavigationBarAccessor
    public ImmutableList<fqx> getTabs() {
        return this.i;
    }

    @Override // net.labymod.v1_21_4.client.gui.TabNavigationBarAccessor
    public fqy getTabManager() {
        return this.h;
    }
    ...
    @Override // net.labymod.v1_21_4.client.gui.TabNavigationBarAccessor
    public TabNavigationBarAccessor.VersionedTab versionedTabOf(fqx tab) {
    ...
    public void render(fof graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        fqx tab = this.h.a();
