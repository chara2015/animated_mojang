...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/component/VersionedIconContents.class */
public class VersionedIconContents implements wq {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull xm style) {
