...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/font/component/VersionedComponentMapper.class */
...
public class VersionedComponentMapper implements ComponentMapper {
    ...
    public String getTranslationKeyOfComponent(Object minecraftComponent) {
        if (minecraftComponent instanceof wp) {
            wp component = (wp) minecraftComponent;
            ya yaVarB = component.b();
            if (yaVarB instanceof ya) {
                return yaVarB.b();
            }
            return null;
        }
