...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/util/MixinWalkAnimationState.class */
@Mixin({bwj.class})
public class MixinWalkAnimationState implements WalkAnimationStateAccessor {
    ...
    @Override // net.labymod.v1_21_4.client.util.WalkAnimationStateAccessor
