...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/server/VersionedIntegratedServer.class */
@Singleton
...
public class VersionedIntegratedServer extends AbstractIntegratedServer {
    ...
    public boolean isLanWorldOpened() {
        hje server;
        return flk.Q().T() && (server = flk.Q().V()) != null && server.r();
    }
    ...
    public LocalWorld getLocalWorld() throws MatchException {
        ...
        GameMode gameMode;
        if (!flk.Q().T() || (minecraftServerAccessorV = flk.Q().V()) == null) {
            return null;
        }
        dgg gameType = minecraftServerAccessorV.bd();
        if (gameType == null) {
            gameType = dgg.a;
        }
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_4.server.VersionedIntegratedServer$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/server/VersionedIntegratedServer$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[dgg.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dgg.b.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dgg.a.ordinal()] = 2;
    ...
    public boolean publishLanWorld(int port, net.labymod.core.client.worldsharing.model.GameMode gameMode, boolean allowCheats) {
        hje server = getServer();
        if (server == null) {
            return false;
        }
        return server.a(dgg.a(gameMode.getId()), allowCheats, port);
    }
    ...
    public void changeDifficulty(GameDifficulty difficulty) {
        ...
        server.a(bsi.a(difficulty.getId()), true);
    }
    ...
    public void setCheatsEnabled(boolean enabled) {
        ...
        avd playerList = server.ag();
        playerList.b(enabled);
        for (are pl : playerList.t()) {
            playerList.e(pl);
        }
    }
    ...
    public void kickPlayer(String name, Object reason) {
        ...
        asg asgVar = profile.f;
        if (reason instanceof wp) {
            wp component = (wp) reason;
            wpVarB = component;
        } else {
            wpVarB = wp.b(reason.toString());
        }
        asgVar.a(wpVarB);
    }
    ...
    public UUID setWhitelist(String name, boolean add) {
        ...
        if (add) {
            server.ag().i().a(new avm(profile));
        } else {
            server.ag().i().b(new avm(profile));
        }
