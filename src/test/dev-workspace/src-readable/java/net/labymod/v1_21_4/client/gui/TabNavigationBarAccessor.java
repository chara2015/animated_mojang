...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<fqx> getTabs();

    fqy getTabManager();

    VersionedTab versionedTabOf(fqx fqxVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gui/TabNavigationBarAccessor$VersionedTab.class */
