...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/network/chat/VersionedBaseComponent.class */
public abstract class VersionedBaseComponent<T extends Component, C> implements BaseComponent<T> {
    public final xd holder;

    public VersionedBaseComponent(xd holder) {
        this.holder = holder;
    }
