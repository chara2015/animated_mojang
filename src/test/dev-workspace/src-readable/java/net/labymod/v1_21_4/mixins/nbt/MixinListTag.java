...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/nbt/MixinListTag.class */
@Mixin({tw.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, un unVar);

    @Shadow
    public abstract boolean a(int i, un unVar);

    @Shadow
    public abstract void c(int i, un unVar);

    @Shadow
    public abstract un shadow$c(int i);
