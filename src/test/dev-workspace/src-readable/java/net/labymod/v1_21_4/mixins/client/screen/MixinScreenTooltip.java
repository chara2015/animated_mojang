...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/screen/MixinScreenTooltip.class */
@Mixin({fum.class})
public abstract class MixinScreenTooltip {
    ...
    private void labyMod$renderTooltip(fof graphics, fod font, List<ayl> values, fwx positioner, int mouseX, int mouseY) {
