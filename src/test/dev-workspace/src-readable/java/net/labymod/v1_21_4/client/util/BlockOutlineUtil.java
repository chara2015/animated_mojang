...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/util/BlockOutlineUtil.class */
public class BlockOutlineUtil {
    public static void renderBlockOutline(dgj level, glz bufferSource, ffz lineConsumer, ffv poseStack, bum entity, double x, double y, double z, ji blockPos, dwy blockState, int color) {
        ...
        fbv shape = blockState.a(level, blockPos, fbg.a(entity));
        ...
        if (overlayColor != null) {
            ffz overlayConsumer = bufferSource.getBuffer(OverlayRenderType.INSTANCE);
    ...
    private static a drawLines(ffz vertexConsumer, a pose, double x, double y, double z, Color color) {
    ...
    private static a drawBoxes(ffz vertexConsumer, a pose, double x, double y, double z, Color color) {
        float red = color.getRed() / 255.0f;
        float green = color.getGreen() / 255.0f;
        float blue = color.getBlue() / 255.0f;
        float alpha = color.getAlpha() / 255.0f;
    ...
    private static ffz addVertex(ffz vertexConsumer, Matrix4f matrix, double x, double y, double z) {
