package net.labymod.v1_18_2.mixins.authlib;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/authlib/MixinYggdrasilMinecraftSessionService.class */
...
public abstract class MixinYggdrasilMinecraftSessionService {
    ...
    @Overwrite
    public void joinServer(GameProfile profile, String authenticationToken, String serverId) throws InsufficientPrivilegesException, AuthenticationException, InvalidCredentialsException, AuthenticationUnavailableException {
        try {
