package net.labymod.v1_18_2.laby3d.pipeline.target;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    private final drz wrapped;

    public VersionedRenderTarget(drz wrapped) {
        this.wrapped = wrapped;
    }

    public void clear(boolean unbindTarget) {
        this.wrapped.b(dyr.a);
        if (!unbindTarget) {
            this.wrapped.a(true);
        }
    }
    ...
    public void resize(int newWidth, int newHeight) {
        this.wrapped.a(newWidth, newHeight, dyr.a);
    }
