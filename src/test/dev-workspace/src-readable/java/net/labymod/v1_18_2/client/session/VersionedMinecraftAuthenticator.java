...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/session/VersionedMinecraftAuthenticator.class */
@Singleton
...
public class VersionedMinecraftAuthenticator extends DefaultsAbstractMinecraftAuthenticator {
    ...
    public VersionedMinecraftAuthenticator() {
        ...
        YggdrasilAuthenticationService yggdrasilAuthenticationServiceX = dyr.D().X();
        if (yggdrasilAuthenticationServiceX instanceof YggdrasilAuthenticationService) {
            yggdrasilAuthenticationService = yggdrasilAuthenticationServiceX;
        } else {
