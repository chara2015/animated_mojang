...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/nbt/MixinCompoundTag.class */
@Mixin({ok.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, pd> x;

    @Shadow
    public abstract pd a(String str, pd pdVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract pd shadow$c(String str);
    ...
    @Shadow
    public abstract ok shadow$p(String str);

    @Shadow
    public abstract oq c(String str, int i);
