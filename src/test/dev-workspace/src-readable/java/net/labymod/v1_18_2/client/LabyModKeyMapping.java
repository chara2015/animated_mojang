...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends dyo {
    private static final Function<Hotkey, dyo> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        dyo labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static dyo create(Hotkey hotkey) {
