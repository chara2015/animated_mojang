...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gui/screen/widget/converter/TextFieldConverter.class */
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<eam, TextFieldWidget> {
    ...
    public TextFieldWidget createDefault(eam source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(eam source, TextFieldWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
