...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({edj.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(edw screen, dtm poseStack, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
