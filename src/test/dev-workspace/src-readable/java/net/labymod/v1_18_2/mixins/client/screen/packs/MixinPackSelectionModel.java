package net.labymod.v1_18_2.mixins.client.screen.packs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({egr.class})
public class MixinPackSelectionModel {
    ...
    private List<afl> getAvailablePacks() {
