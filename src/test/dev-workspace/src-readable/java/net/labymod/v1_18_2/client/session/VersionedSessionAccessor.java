package net.labymod.v1_18_2.client.session;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<dzh> {
    ...
    public dzh toGameSession(Session session) {
        return (dzh) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(dzh gameSession) {
        if (gameSession == null) {
            return null;
        }
        return createSession(gameSession.c(), gameSession.g().getId(), gameSession.d());
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public dzh getGameSession() {
        return dyr.D().J();
    }
}
