...
import net.labymod.v1_18_2.client.gfx.pipeline.renderer.text.GlyphInstance;
import net.labymod.v1_18_2.client.gfx.pipeline.renderer.text.GlyphUtil;
import org.joml.Matrix4f;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/gui/font/MixinBakedGlyph_Extension.class */
@Mixin({ebu.class})
public abstract class MixinBakedGlyph_Extension implements BakedGlyphExtension {
    ...
    @Shadow
    public abstract void a(boolean z, float f, float f2, d dVar, dtq dtqVar, float f3, float f4, float f5, float f6, int i);

    @Override // net.labymod.v1_18_2.client.gfx.pipeline.renderer.text.BakedGlyphExtension
    ...
    @Override // net.labymod.v1_18_2.client.gfx.pipeline.renderer.text.BakedGlyphExtension
    public void labyMod$renderGlyph(GlyphInstance instance, Matrix4f pose, dtq consumer, int lightCoords, boolean ignoreDepthOffset) {
