package net.labymod.v1_18_2.client.gfx.pipeline;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gfx/pipeline/VersionedBlaze3DGlStatePipeline.class */
@Singleton
...
public final class VersionedBlaze3DGlStatePipeline extends AbstractBlaze3DGlStatePipeline implements Blaze3DGlStatePipeline {
    private static final k DIFFUSE_LIGHT_0 = (k) ad.a(new k(0.0f, 0.0f, 0.2f), (v0) -> {
        v0.d();
    });
    private static final k DIFFUSE_LIGHT_1 = (k) ad.a(new k(0.2f, 0.0f, 0.0f), (v0) -> {
        v0.d();
    });
