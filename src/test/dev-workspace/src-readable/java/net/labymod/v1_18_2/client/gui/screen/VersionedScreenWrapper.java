...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gui/screen/VersionedScreenWrapper.class */
public class VersionedScreenWrapper implements ScreenWrapper {
    private final edw screen;
    private Metadata metadata;
    private boolean initialized;

    public VersionedScreenWrapper(edw screen) {
        if (screen == null) {
    ...
    public void render(ScreenContext context) {
        ...
        dtm poseStack = (dtm) context.stack().getProvider().getPoseStack();
