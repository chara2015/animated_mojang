...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/MixinCamera.class */
@Mixin({dyb.class})
public abstract class MixinCamera implements ExtendedMinecraftCamera {
    ...
    public Quaternionf cameraRotation() {
        this.labymod$rotation.set(this.l.e(), this.l.f(), this.l.g(), this.l.h());
