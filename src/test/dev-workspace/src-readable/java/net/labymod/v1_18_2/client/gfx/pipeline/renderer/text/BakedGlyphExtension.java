...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gfx/pipeline/renderer/text/BakedGlyphExtension.class */
public interface BakedGlyphExtension {
    ...
    void labyMod$renderGlyph(GlyphInstance glyphInstance, Matrix4f matrix4f, dtq dtqVar, int i, boolean z);
