...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({dpl.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(axk entity, dpo position, InsertInfo info) {
