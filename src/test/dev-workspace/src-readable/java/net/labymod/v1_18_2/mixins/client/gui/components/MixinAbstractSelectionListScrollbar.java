...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/gui/components/MixinAbstractSelectionListScrollbar.class */
@Mixin({eaa.class})
public abstract class MixinAbstractSelectionListScrollbar {
    ...
    private int labyMod$render(eaa instance) {
