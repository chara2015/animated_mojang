...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gfx/pipeline/renderer/text/GlyphUtil.class */
public final class GlyphUtil {

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gfx/pipeline/renderer/text/GlyphUtil$Emitter.class */
    @FunctionalInterface
    public interface Emitter {
        void emit(boolean z, float f, float f2, float f3, d dVar, dtq dtqVar, int i, boolean z2, int i2);
    }

    public static void emitGlyph(GlyphInstance instance, d pose, dtq consumer, int lightCoords, boolean ignoreDepthOffset, Emitter emitter) {
