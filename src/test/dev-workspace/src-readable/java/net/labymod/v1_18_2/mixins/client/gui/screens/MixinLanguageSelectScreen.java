...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/gui/screens/MixinLanguageSelectScreen.class */
@Mixin({edh.class})
public class MixinLanguageSelectScreen {
    ...
    private boolean labyMod$fasterLanguageReload(dyr instance) {
