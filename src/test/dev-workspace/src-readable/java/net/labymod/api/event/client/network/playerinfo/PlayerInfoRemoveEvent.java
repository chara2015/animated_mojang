...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/api/event/client/network/playerinfo/PlayerInfoRemoveEvent.class */
public class PlayerInfoRemoveEvent implements Event {
    private final NetworkPlayerInfo playerInfo;

    public PlayerInfoRemoveEvent(@NotNull NetworkPlayerInfo playerInfo) {
