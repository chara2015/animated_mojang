...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/screen/widget/converter/TabLayoutConverter.class */
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<ghf, AbstractWidget<?>> {
    ...
    public /* bridge */ /* synthetic */ void update(Object obj, AbstractWidget abstractWidget, @NotNull WidgetReplacementStrategy widgetReplacementStrategy) {
        update((ghf) obj, (AbstractWidget<?>) abstractWidget, widgetReplacementStrategy);
    }
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public AbstractWidget<?> createDefault(ghf source) {
        TabNavigationBarAccessor accessor = (TabNavigationBarAccessor) source;
        ghe tabManager = accessor.getTabManager();
        ghd currentTab = tabManager.a();
    ...
    public void update(ghf source, AbstractWidget<?> destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
