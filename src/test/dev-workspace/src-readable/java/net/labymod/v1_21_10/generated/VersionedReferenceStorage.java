package net.labymod.v1_21_10.generated;
...
import net.labymod.v1_21_10.client.chat.VersionedChatExecutor;
import net.labymod.v1_21_10.client.chat.VersionedChatModifier;
import net.labymod.v1_21_10.client.component.VersionedComponentService;
import net.labymod.v1_21_10.client.component.format.numbers.VersionedNumberFormatMapper;
import net.labymod.v1_21_10.client.crash.VersionedGameCrashReportFactory;
import net.labymod.v1_21_10.client.entity.VersionedEntityPoseMapper;
import net.labymod.v1_21_10.client.entity.VersionedEntityVisualizer;
import net.labymod.v1_21_10.client.font.component.VersionedComponentMapper;
import net.labymod.v1_21_10.client.gfx.VersionedGFXBridge;
import net.labymod.v1_21_10.client.gfx.pipeline.VersionedBlaze3DGlStatePipeline;
import net.labymod.v1_21_10.client.gfx.pipeline.renderer.text.VanillaFontRenderer;
import net.labymod.v1_21_10.client.gfx.pipeline.renderer.text.VanillaFormattedTextLayoutFactory;
import net.labymod.v1_21_10.client.gfx.pipeline.renderer.text.VersionedVanillaGlyphStorage;
import net.labymod.v1_21_10.client.gfx.pipeline.texture.atlas.VersionedMinecraftAtlases;
import net.labymod.v1_21_10.client.gui.background.VersionedPanoramaRenderer;
import net.labymod.v1_21_10.client.gui.screen.VersionedScreenWrapperFactory;
import net.labymod.v1_21_10.client.gui.screen.key.mapper.VersionedKeyMapper;
import net.labymod.v1_21_10.client.multiplayer.server.VersionedClientNetworkPacketListener;
import net.labymod.v1_21_10.client.multiplayer.server.VersionedServerController;
import net.labymod.v1_21_10.client.particle.VersionedParticleController;
import net.labymod.v1_21_10.client.render.VersionedItemStackVisualizer;
import net.labymod.v1_21_10.client.render.VersionedRenderConstants;
import net.labymod.v1_21_10.client.render.VersionedRenderPipeline;
import net.labymod.v1_21_10.client.render.item.VersionedAnimationTypeMapper;
import net.labymod.v1_21_10.client.render.matrix.VersionedStackProviderFactory;
import net.labymod.v1_21_10.client.resources.VersionedResourceLocationFactory;
import net.labymod.v1_21_10.client.resources.pack.VersionedResourcePackRepository;
import net.labymod.v1_21_10.client.resources.pack.VersionedResourcePackScanner;
import net.labymod.v1_21_10.client.resources.sound.VersionedMinecraftSounds;
import net.labymod.v1_21_10.client.resources.texture.NativeGameImageProvider;
import net.labymod.v1_21_10.client.resources.texture.VersionedTextureRepository;
import net.labymod.v1_21_10.client.session.VersionedMinecraftAuthenticator;
import net.labymod.v1_21_10.client.session.VersionedSessionAccessor;
import net.labymod.v1_21_10.client.session.user.VersionedUserFactory;
import net.labymod.v1_21_10.client.util.VersionedSystemInfo;
import net.labymod.v1_21_10.client.util.math.VersionedGameMathMapper;
import net.labymod.v1_21_10.client.world.VersionedBossBarRegistry;
import net.labymod.v1_21_10.client.world.VersionedClientWorld;
import net.labymod.v1_21_10.client.world.block.VersionedBlockColorProvider;
import net.labymod.v1_21_10.client.world.block.properties.VersionedBlockProperties;
import net.labymod.v1_21_10.client.world.item.VersionedItemStackFactory;
import net.labymod.v1_21_10.client.world.lighting.VersionedLightingLayerMapper;
import net.labymod.v1_21_10.client.world.phys.hit.VersionedHitResultController;
import net.labymod.v1_21_10.laby3d.VersionedGameTransformations;
import net.labymod.v1_21_10.laby3d.VersionedLaby3D;
import net.labymod.v1_21_10.laby3d.buffer.VersionedGameBufferProvider;
import net.labymod.v1_21_10.laby3d.render.buffer.VersionedRenderBufferSource;
import net.labymod.v1_21_10.mojang.texture.VersionedMojangTextureService;
import net.labymod.v1_21_10.nbt.VersionedNBTFactory;
import net.labymod.v1_21_10.server.VersionedIntegratedServer;
import net.labymod.v1_21_10.server.VersionedServerAddressResolver;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/generated/VersionedReferenceStorage.class */
