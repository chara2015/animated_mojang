...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/screen/widget/converter/ButtonConverter.class */
public class ButtonConverter extends AbstractMinecraftWidgetConverter<gdf, ButtonWidget> {
    ...
    public ButtonWidget createDefault(gdf source) {
        ButtonWidget destination = ButtonWidget.component(source instanceof b ? null : mapComponent(source.A()), null, Pressable.NOOP);
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(gdf source, ButtonWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
        if (replacementStrategy.isSet(WidgetReplacementStrategy.ReplacementBehavior.KEEP_STATES)) {
            destination.setVisible(source.j);
            destination.setEnabled(source.i);
            destination.setFocused(source.aP_());
        }
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public String getWidgetId(gdf source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.A());
    }

    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public List<String> getWidgetIds(gdf source) {
        return this.componentMapper.getTranslationKeysOfComponent(source.A());
    }

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/screen/widget/converter/ButtonConverter$ImageButtonMapper.class */
    class ImageButtonMapper implements Mapper<gdf, ButtonWidget> {
        ImageButtonMapper() {
        }

        @Override // net.labymod.api.util.function.Mapper
        public ButtonWidget map(gdf source) {
            if (!(source instanceof geb)) {
                return null;
            }
            ImageButtonAccessor accessor = (geb) source;
            ResourceLocation location = accessor.getResourceLocation();
            Icon icon = Icon.sprite(location, accessor.getXTexStart(), accessor.getYTexStart(), source.aS_(), source.aR_(), accessor.getTextureWidth(), accessor.getTextureHeight());
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper.class */
    class LockIconButtonMapper implements Mapper<gdf, ButtonWidget> {
        ...
        public ButtonWidget map(gdf source) {
            ...
            if (!(source instanceof geg)) {
                return null;
            }
            geg lockIconButton = (geg) source;
            source.aS_();
        ...
        /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper$LockIconSprite.class */
        enum LockIconSprite {
