package net.labymod.v1_21_10.client.resources.sound;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/resources/sound/VersionedMinecraftSounds.class */
@Singleton
...
public class VersionedMinecraftSounds implements MinecraftSounds {
    ...
    public void playChatFilterSound() {
        fzz.W().aq().a(igf.a(bce.tP, 1.0f));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch) {
        playSound(igf.a(bcd.a((amj) location.getMinecraftLocation(), 16.0f), pitch, volume));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch, FloatVector3 position) {
        playSound(new igf((amj) location.getMinecraftLocation(), bcf.a, volume, pitch, igk.t(), false, 0, a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    ...
    private void playSound(igf sound) {
        sound.a(fzz.W().aq());
        fzz.W().aq().a(sound);
    }
}
