...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/multiplayer/server/VersionedServerData.class */
public class VersionedServerData extends hab {
    ...
    public VersionedServerData(ServerData serverData) {
        ...
        if (serverData instanceof StorageServerData) {
            ...
            this.o = storageServerData.getAcceptedCodeOfConduct();
        }
    }

    public void b(@NotNull String codeOfConduct) {
        super.b(codeOfConduct);
        ServerData serverData = this.serverData;
        if (serverData instanceof StorageServerData) {
            StorageServerData storageServerData = (StorageServerData) serverData;
            storageServerData.setAcceptedCodeOfConduct(this.o);
        }
    }
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_10.client.multiplayer.server.VersionedServerData$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/multiplayer/server/VersionedServerData$1.class */
