package net.labymod.v1_21_10.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({fzz.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(hfk instance, fzp $$0, boolean $$1, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(fzz instance, Operation<Void> original) {
