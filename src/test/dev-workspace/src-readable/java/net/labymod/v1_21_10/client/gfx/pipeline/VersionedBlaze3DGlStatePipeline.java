package net.labymod.v1_21_10.client.gfx.pipeline;
...
import net.labymod.v1_21_10.client.render.matrix.JomlStackProvider;
import net.labymod.v1_21_10.laby3d.pipeline.opengl.Laby3DGlTexture;
import net.labymod.v1_21_10.laby3d.pipeline.opengl.Laby3DGlTextureView;
import org.joml.Vector3f;
import org.lwjgl.opengl.GL11;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gfx/pipeline/VersionedBlaze3DGlStatePipeline.class */
@Singleton
...
public final class VersionedBlaze3DGlStatePipeline extends AbstractBlaze3DGlStatePipeline implements Blaze3DGlStatePipeline {
    ...
    public void bindTexture(DeviceTextureView textureView) {
        int slot = GL11.glGetInteger(GlConst.GL_ACTIVE_TEXTURE) - GlConst.GL_TEXTURE0;
