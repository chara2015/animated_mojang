...
import net.labymod.v1_21_10.client.world.block.properties.VersionedBlockPropertyHolder;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/world/block/MixinBlockState.class */
@Mixin({ejm.class})
...
public abstract class MixinBlockState extends a implements BlockState {
    ...
    @Shadow
    protected abstract ejm B();

    protected MixinBlockState(duv $$0, Reference2ObjectArrayMap<ekp<?>, Comparable<?>> $$1, MapCodec<ejm> $$2) {
        super($$0, $$1, $$2);
    ...
    public int getTopColor() {
        ...
        return blockColors.a(B(), gznVar, this.labyMod$blockPos);
    }
    ...
    public int getLightLevel() {
        ...
        return level.E_().a(this.labyMod$blockPos, 0);
    }
    ...
    public int getLightLevel(LightType lightType) {
        ...
        return level.a((drz) lightType.toMinecraft(), this.labyMod$blockPos);
    }

    /* JADX INFO: renamed from: net.labymod.v1_21_10.mixins.client.world.block.MixinBlockState$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/world/block/MixinBlockState$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$block$RenderShape = new int[ebk.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$block$RenderShape[ebk.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$block$RenderShape[ebk.b.ordinal()] = 2;
    ...
    public boolean isCollisionShapeSolid() {
        return B().m(fzz.W().r, this.labyMod$blockPos);
    }

    @Override // net.labymod.api.client.world.block.BlockState
    @Nullable
    public AxisAlignedBoundingBox bounds() {
        fpc shape = B().f(fzz.W().r, this.labyMod$blockPos);
        if (shape.c()) {
            return null;
        }
        foc bounds = shape.a();
    ...
    public boolean hasCollision() {
        return !B().g(fzz.W().r, this.labyMod$blockPos).c();
    }
    ...
    public boolean isWater() {
        fga fluidState = B().y();
        return fluidState.b(fgb.c) || fluidState.b(fgb.b);
    }

    @Override // net.labymod.api.client.world.block.BlockState
    public boolean isLava() {
        fga fluidState = B().y();
        return fluidState.b(fgb.e) || fluidState.b(fgb.d);
    }

    @Override // net.labymod.api.client.world.block.BlockState
    public float getHardness(Player player) {
        czl mcPlayer = (czl) player;
        return B().a(mcPlayer, mcPlayer.an(), this.labyMod$blockPos);
    }
    ...
    public boolean isValidSpawnBlock(@NotNull ResourceLocation entityType) {
        ...
        return a(gznVar, this.labyMod$blockPos, (cee) ((c) mo.g.c((amj) entityType.getMinecraftLocation()).orElseThrow()).a());
    }
    ...
    public boolean hasInvisibleCollisionHeight() {
        ...
        fpc shape = g(gznVar, this.labyMod$blockPos);
