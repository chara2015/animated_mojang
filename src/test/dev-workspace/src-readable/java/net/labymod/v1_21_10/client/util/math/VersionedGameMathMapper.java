package net.labymod.v1_21_10.client.util.math;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/util/math/VersionedGameMathMapper.class */
@Singleton
...
public class VersionedGameMathMapper implements GameMathMapper {
    ...
    public AxisAlignedBoundingBox fromAABB(Object aabb) {
        if (!(aabb instanceof foc)) {
            return BOX_IDENTITY;
        }
        foc gameAABB = (foc) aabb;
    ...
    public <T> T toAABB(AxisAlignedBoundingBox axisAlignedBoundingBox) {
        return (T) new foc(axisAlignedBoundingBox.getMinX(), axisAlignedBoundingBox.getMinY(), axisAlignedBoundingBox.getMinZ(), axisAlignedBoundingBox.getMaxX(), axisAlignedBoundingBox.getMaxY(), axisAlignedBoundingBox.getMaxZ());
    }
