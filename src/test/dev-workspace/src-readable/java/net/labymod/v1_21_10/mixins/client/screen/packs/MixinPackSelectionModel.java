package net.labymod.v1_21_10.mixins.client.screen.packs;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;
import net.labymod.v1_21_10.client.resources.pack.PackUtil;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({gqt.class})
public class MixinPackSelectionModel {
    ...
    private List<azx> getAvailablePacks() {
        List<azx> list = new ArrayList<>();
        for (azx pack : this.a.d()) {
