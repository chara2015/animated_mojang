...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/renderer/texture/MixinSkinTextureDownloader_TextureFiltering.class */
@Mixin({ich.class})
public class MixinSkinTextureDownloader_TextureFiltering {
    ...
    private static void labyMod$setTextureFiltering(icq instance, amj $$0, iby $$1, Operation<Void> original) {
