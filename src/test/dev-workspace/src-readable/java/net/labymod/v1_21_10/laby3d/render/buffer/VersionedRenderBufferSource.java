package net.labymod.v1_21_10.laby3d.render.buffer;
...
import net.labymod.v1_21_10.laby3d.buffer.VersionedGameVertexConsumer;
import net.labymod.v1_21_10.laby3d.pipeline.RenderTypeResolver;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/laby3d/render/buffer/VersionedRenderBufferSource.class */
@Singleton
...
public class VersionedRenderBufferSource implements RenderBufferSource {
    ...
    public VertexConsumer getBuffer(Material material) {
        return new VersionedGameVertexConsumer(getBufferSource().a(this.resolver.resolve(material)));
    }
