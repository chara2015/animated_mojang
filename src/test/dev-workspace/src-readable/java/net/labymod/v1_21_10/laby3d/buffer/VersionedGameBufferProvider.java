package net.labymod.v1_21_10.laby3d.buffer;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/laby3d/buffer/VersionedGameBufferProvider.class */
@Singleton
...
public class VersionedGameBufferProvider implements GameBufferProvider {
    ...
    public GameVertexConsumer getBuffer(RenderState renderState, TextureBindingSet bindingSet) {
        return new VersionedGameVertexConsumer(this.bufferSource.get().a(LabyRenderType.entityTranslucent(bindingSet)));
    }
