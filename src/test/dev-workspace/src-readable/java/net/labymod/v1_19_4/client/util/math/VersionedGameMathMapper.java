...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/util/math/VersionedGameMathMapper.class */
@Singleton
...
public class VersionedGameMathMapper implements GameMathMapper {
    ...
    public AxisAlignedBoundingBox fromAABB(Object aabb) {
        if (!(aabb instanceof ecz)) {
            return BOX_IDENTITY;
        }
        ecz gameAABB = (ecz) aabb;
    ...
    public <T> T toAABB(AxisAlignedBoundingBox axisAlignedBoundingBox) {
        return (T) new ecz(axisAlignedBoundingBox.getMinX(), axisAlignedBoundingBox.getMinY(), axisAlignedBoundingBox.getMinZ(), axisAlignedBoundingBox.getMaxX(), axisAlignedBoundingBox.getMaxY(), axisAlignedBoundingBox.getMaxZ());
    }
