...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/gui/MixinPlayerTabOverlay.class */
@Mixin({eoz.class})
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(ehe poseStack, int screenWidth, eec scoreboard, edz objective, InsertInfo ci) {
