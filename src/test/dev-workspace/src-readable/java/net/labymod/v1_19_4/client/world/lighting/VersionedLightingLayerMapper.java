...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/world/lighting/VersionedLightingLayerMapper.class */
@Singleton
...
public class VersionedLightingLayerMapper implements LightingLayerMapper {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_19_4.client.world.lighting.VersionedLightingLayerMapper$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/world/lighting/VersionedLightingLayerMapper$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$level$LightLayer = new int[cmr.values().length];
            try {
                $SwitchMap$net$minecraft$world$level$LightLayer[cmr.a.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$LightLayer[cmr.b.ordinal()] = 2;
