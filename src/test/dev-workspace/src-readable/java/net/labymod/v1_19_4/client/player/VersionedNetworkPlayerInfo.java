package net.labymod.v1_19_4.client.player;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/player/VersionedNetworkPlayerInfo.class */
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    private final fdo wrapped;
    private final Component usernameComponent = Component.text(profile().getUsername());
    private Metadata metadata = Metadata.create();

    public VersionedNetworkPlayerInfo(fdo wrapped) {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_19_4.client.player.VersionedNetworkPlayerInfo$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[cmf.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[cmf.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[cmf.b.ordinal()] = 2;
    ...
    private tj decorateComponent(@NotNull fdo info, tw mutableComponent) {
        if (info.e() == cmf.d) {
