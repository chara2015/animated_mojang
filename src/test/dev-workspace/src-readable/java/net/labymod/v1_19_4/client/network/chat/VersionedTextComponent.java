...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/network/chat/VersionedTextComponent.class */
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, tk> implements TextComponent {
    private static final String EMPTY = "";
    private boolean empty;

    public VersionedTextComponent(tw holder, boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public TextComponent text(String text) {
        if (this.empty) {
            this.holder.setContents(new uo(text));
            this.empty = false;
            return this;
        }
    ...
    @Override // net.labymod.v1_19_4.client.network.chat.VersionedBaseComponent
