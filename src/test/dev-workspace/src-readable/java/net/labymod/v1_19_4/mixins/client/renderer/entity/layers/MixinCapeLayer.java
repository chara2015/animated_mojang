package net.labymod.v1_19_4.mixins.client.renderer.entity.layers;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/renderer/entity/layers/MixinCapeLayer.class */
@Mixin({fqn.class})
public class MixinCapeLayer {
    private final CapeParticleController labyMod$capeParticleController = LabyMod.references().capeParticleController();
    private fio labyMod$renderType;
    ...
    private void labyMod$firePreCapeRenderEvent(ehe poseStack, fig param1, int param2, fhh clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(ehe poseStack, fig param1, int param2, fhh clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
        labyMod$fireCapeRenderEvent(poseStack, clientPlayer, Phase.POST);
    }

    @WrapOperation(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = {@At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;")})
    private fio labyMod$attach(add location, Operation<fio> original) {
        fio fioVar = (fio) original.call(new Object[]{location});
        this.labyMod$renderType = fioVar;
        return fioVar;
    }

    @Insert(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(ehe param0, fig param1, int param2, fhh player, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(ehe poseStack, fhh clientPlayer, Phase phase) {
        Player player = (Player) clientPlayer;
        PlayerModel playerModel = ((frn) this).c();
