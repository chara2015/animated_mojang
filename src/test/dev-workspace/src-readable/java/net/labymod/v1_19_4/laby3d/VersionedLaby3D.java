...
import net.labymod.v1_19_4.client.resources.texture.NativeGameImage;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/laby3d/VersionedLaby3D.class */
@Singleton
...
public class VersionedLaby3D extends Laby3D {
    ...
    public void writeToTexture(@NotNull DeviceTexture texture, @NotNull GameImage image) throws MatchException {
        if (image instanceof NativeGameImage) {
            try {
                egf nativeImage = ((NativeGameImage) image).image();
