...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/scoreboard/MixinObjective.class */
@Mixin({edz.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_19_4.mixins.client.scoreboard.MixinObjective$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        return this.a.c(entry, (edz) this);
    }

    @Override // net.labymod.api.client.scoreboard.ScoreboardObjective
    @Nullable
    public ScoreboardScore getScore(@NotNull String entry) {
        Map<edz, eeb> scores = this.a.e(entry);
        if (scores != null) {
            return (ScoreboardScore) scores.get((edz) this);
        }
        return null;
    }
}
