...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/renderer/entity/layers/VersionedShopItemLayer.class */
public class VersionedShopItemLayer extends frn<fhh, fax<fhh>> {
    ...
    public VersionedShopItemLayer(fpa<fhh, fax<fhh>> layerParent) {
        super(layerParent);
    ...
    public void a(@NotNull ehe poseStack, @NotNull fig bufferSource, int lightCoords, @NotNull fhh player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
