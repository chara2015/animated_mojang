...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/gui/screen/widget/converter/TabLayoutConverter.class */
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<ept, AbstractWidget<?>> {
    ...
    public /* bridge */ /* synthetic */ void update(Object obj, AbstractWidget abstractWidget, @NotNull WidgetReplacementStrategy widgetReplacementStrategy) {
        update((ept) obj, (AbstractWidget<?>) abstractWidget, widgetReplacementStrategy);
    }
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public AbstractWidget<?> createDefault(ept source) {
        TabNavigationBarAccessor accessor = (TabNavigationBarAccessor) source;
        eps tabManager = accessor.getTabManager();
        epr currentTab = tabManager.a();
    ...
    public void update(ept source, AbstractWidget<?> destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
