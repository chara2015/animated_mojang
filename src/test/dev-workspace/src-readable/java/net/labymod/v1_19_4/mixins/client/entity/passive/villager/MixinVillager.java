package net.labymod.v1_19_4.mixins.client.entity.passive.villager;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/entity/passive/villager/MixinVillager.class */
@Mixin({bxz.class})
public abstract class MixinVillager implements Villager {
    @Shadow
    public abstract bya gd();
