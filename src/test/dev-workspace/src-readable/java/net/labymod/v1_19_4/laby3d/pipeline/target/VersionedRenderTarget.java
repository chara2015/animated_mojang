package net.labymod.v1_19_4.laby3d.pipeline.target;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    private final efr wrapped;

    public VersionedRenderTarget(efr wrapped) {
        this.wrapped = wrapped;
    }

    public void clear(boolean unbindTarget) {
        this.wrapped.b(emh.a);
        if (!unbindTarget) {
            this.wrapped.a(true);
        }
    }
    ...
    public void resize(int newWidth, int newHeight) {
        this.wrapped.a(newWidth, newHeight, emh.a);
    }
