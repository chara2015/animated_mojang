...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({edb.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(bfh entity, ede position, InsertInfo info) {
