...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({emh.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(fhz instance, float v, long l, boolean b, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(emh instance, Operation<Void> original) {
