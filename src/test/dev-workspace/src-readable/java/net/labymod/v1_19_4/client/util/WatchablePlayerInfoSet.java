...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/util/WatchablePlayerInfoSet.class */
public class WatchablePlayerInfoSet implements WatchableSet<fdo> {
    ...
    public void onAdd(fdo playerInfo) {
    ...
    @Override // net.labymod.core.watcher.collection.WatchableCollection
    public void onRemove(fdo playerInfo) {
        NetworkPlayerInfo networkPlayerInfo = findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(fdo info) {
