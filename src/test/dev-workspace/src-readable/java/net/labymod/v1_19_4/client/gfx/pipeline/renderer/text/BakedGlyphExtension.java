...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/gfx/pipeline/renderer/text/BakedGlyphExtension.class */
public interface BakedGlyphExtension {
    ...
    void labyMod$renderGlyph(GlyphInstance glyphInstance, Matrix4f matrix4f, ehi ehiVar, int i, boolean z);
