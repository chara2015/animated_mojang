...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({fhz.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(etd instance, ehe poseStack, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
