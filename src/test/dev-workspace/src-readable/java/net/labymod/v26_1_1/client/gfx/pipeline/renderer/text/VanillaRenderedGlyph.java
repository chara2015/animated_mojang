package net.labymod.v26_1_1.client.gfx.pipeline.renderer.text;
...
import net.labymod.v26_1_1.client.gfx.pipeline.blaze3d.PositionTextureColorVertexConsumer;
import net.minecraft.client.gui.font.TextRenderable;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1_1/client/gfx/pipeline/renderer/text/VanillaRenderedGlyph.class */
public class VanillaRenderedGlyph implements StyledGlyphRenderable {
    private final TextRenderable renderable;
    private final RenderState renderState;

    public VanillaRenderedGlyph(TextRenderable renderable) {
    ...
    public Style style() {
        TextRenderable.Styled styled = this.renderable;
        if (styled instanceof TextRenderable.Styled) {
            TextRenderable.Styled styled2 = styled;
            return (Style) CastUtil.cast(styled2.style());
        }
        return Style.EMPTY;
    }
}
