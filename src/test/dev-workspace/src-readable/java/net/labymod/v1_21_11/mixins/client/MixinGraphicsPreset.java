...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/MixinGraphicsPreset.class */
@Mixin({GraphicsPreset.class})
public class MixinGraphicsPreset {
    @WrapOperation(method = {"apply"}, at = {@At(value = "FIELD", target = "Lnet/minecraft/client/Minecraft;screen:Lnet/minecraft/client/gui/screens/Screen;")})
    private Screen labyMod$useMostInnerScreen(Minecraft instance, Operation<Screen> original) {
