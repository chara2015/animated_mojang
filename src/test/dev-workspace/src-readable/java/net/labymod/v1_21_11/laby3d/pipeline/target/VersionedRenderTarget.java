...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    ...
    public int getId() {
        GlDevice device = RenderSystem.getDevice();
        ...
        return glTexture.getFbo(device.directStateAccess(), fboDepthTexture);
    }
}
