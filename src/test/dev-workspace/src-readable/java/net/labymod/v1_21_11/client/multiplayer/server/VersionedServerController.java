...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/multiplayer/server/VersionedServerController.class */
@Singleton
...
public class VersionedServerController extends DefaultAbstractServerController {
    ...
    public ServerData createServerData(Object mojangServerData) {
        ...
        if (!(mojangServerData instanceof net.minecraft.client.multiplayer.ServerData)) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "%s net.minecraft.core.BlockPos not an instance of %s!", mojangServerData.getClass().getName(), net.minecraft.client.multiplayer.ServerData.class.getName()));
        }
