...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/laby3d/VersionedGlFunctions.class */
public class VersionedGlFunctions extends GlFunctions {
    ...
    public void bindTexture(int target, int id) {
        int index = activeTexture() - 33984;
        if (index >= GL_STATE_MANAGER_TEXTURE_LIMIT) {
            return;
        }
        if (target == 3553) {
    ...
    public int activeTexture() {
        return GlStateManager.activeTexture + 33984;
    }
