...
public abstract class MixinMobEffectInstance implements PotionEffect {
    ...
    public String getTranslationKey() {
        TranslatableComponent translatableComponentFromMinecraftComponent = Laby.labyAPI().minecraft().componentMapper().fromMinecraftComponent(((MobEffect) this.effect.value()).getDisplayName());
