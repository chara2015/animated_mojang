...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/gui/screens/MixinConnectScreenThread.class */
...
public class MixinConnectScreenThread {
    ...
    private Optional<gnf> labyMod$resolveAddress(gni resolver, gng address) {
    ...
    public xg labyMod$fireServerKickEvent(xg reason) {
        ...
        return (xg) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN))).reason());
    }
}
