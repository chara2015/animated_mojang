...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/chat/contents/MixinKeybindContents.class */
@Mixin({yk.class})
public abstract class MixinKeybindContents implements KeybindContentsAccessor {
    ...
    @Shadow
    protected abstract xg c();

    @Override // net.labymod.v1_21_5.client.network.chat.contents.KeybindContentsAccessor
