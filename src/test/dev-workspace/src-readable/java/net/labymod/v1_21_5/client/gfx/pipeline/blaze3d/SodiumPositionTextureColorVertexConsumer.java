package net.labymod.v1_21_5.client.gfx.pipeline.blaze3d;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gfx/pipeline/blaze3d/SodiumPositionTextureColorVertexConsumer.class */
public class SodiumPositionTextureColorVertexConsumer extends Blaze3DVertexProvider implements flg, VertexBufferWriter {
    ...
    public flg a(float x, float y, float z) {
        this.current = new Blaze3DVertex(x, y, z);
        return this;
    }

    public flg a(int red, int green, int blue, int alpha) {
        this.current.setArgb(red, green, blue, alpha);
        return this;
    }

    public flg a(float u, float v) {
        this.current.setUv(u, v);
        return this;
    }

    public flg a(int var1, int var2) {
        return null;
    }

    public flg b(int var1, int var2) {
        return null;
    }

    public flg b(float var1, float var2, float var3) {
        return null;
    }

    public void push(MemoryStack memoryStack, long ptr, int count, VertexFormat description) {
        for (int index = 0; index < count; index++) {
            long vertexPtr = ptr + (((long) index) * ((long) description.getVertexSize()));
