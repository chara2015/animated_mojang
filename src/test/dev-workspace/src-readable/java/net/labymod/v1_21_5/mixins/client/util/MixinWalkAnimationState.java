...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/util/MixinWalkAnimationState.class */
@Mixin({bze.class})
public class MixinWalkAnimationState implements WalkAnimationStateAccessor {
    ...
    @Override // net.labymod.v1_21_5.client.util.WalkAnimationStateAccessor
