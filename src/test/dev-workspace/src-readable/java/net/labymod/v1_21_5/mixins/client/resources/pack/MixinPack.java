package net.labymod.v1_21_5.mixins.client.resources.pack;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/resources/pack/MixinPack.class */
@Mixin({auv.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    @Shadow
    public abstract aua f();

    @Shadow
    public abstract boolean j();

    @Shadow
    public abstract ava l();
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_5.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[auw.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[auw.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[auw.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[auw.c.ordinal()] = 3;
    ...
    public File labyMod$getFile() {
        atx atxVar = this.c;
        if (atxVar instanceof atx) {
            atx packResources = atxVar;
    ...
    private Icon labymod4$loadPackIcon() {
        ...
        LabyExecutors.executeBackgroundTask(() -> {
            try {
                aua resources = f();
                try {
                    avg<InputStream> rootResource = resources.a(new String[]{"pack.png"});
