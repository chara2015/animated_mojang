...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/gui/components/MixinAbstractScrollArea.class */
@Mixin({ftr.class})
public abstract class MixinAbstractScrollArea extends ftw {
    @Shadow
    ...
    public MixinAbstractScrollArea(int $$0, int $$1, int $$2, int $$3, xg $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(ftr instance, Operation<Boolean> original) {
        ...
        int x = l();
        Bounds scrollBar = new PositionedBounds(x, G(), x + 6, I());
