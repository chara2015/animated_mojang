...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/nbt/VersionedNBTFactory.class */
...
public class VersionedNBTFactory implements NBTFactory {
    ...
    public NBTTagCompound compound() {
        return (NBTTagCompound) CastUtil.cast(new ua());
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public <I, T extends NBTTag<I>> NBTTagList<I, T> list() {
        return (NBTTagList) CastUtil.cast((Collection<?>) new ug());
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagByte create(boolean value) {
        return (NBTTagByte) CastUtil.cast(ty.a(value));
    }
    ...
    public NBTTagShort create(short value) {
        return (NBTTagShort) CastUtil.cast(ut.a(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagInt create(int value) {
        return (NBTTagInt) CastUtil.cast(uf.a(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagLong create(long value) {
        return (NBTTagLong) CastUtil.cast(ui.a(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagDouble create(double value) {
        return (NBTTagDouble) CastUtil.cast(ub.a(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagFloat create(float value) {
        return (NBTTagFloat) CastUtil.cast(ud.a(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagByteArray create(byte[] value) {
        return (NBTTagByteArray) CastUtil.cast(new tx(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagIntArray create(int[] value) {
        return (NBTTagIntArray) CastUtil.cast(new ue(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagLongArray create(long[] value) {
        return (NBTTagLongArray) CastUtil.cast(new uh(value));
    }

    @Override // net.labymod.api.nbt.NBTFactory
    public NBTTagString create(String value) {
        return (NBTTagString) CastUtil.cast(uy.a(value));
    }
    ...
    public NBTTagCompound readCompressed(InputStream inputStream) throws IOException {
        return (NBTTagCompound) CastUtil.cast(un.a(inputStream, uj.a()));
    }
