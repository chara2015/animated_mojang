...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/screen/MixinBookScreenVanillaFont.class */
@Mixin({gan.class, gam.class})
public class MixinBookScreenVanillaFont {
    @Insert(method = {"render"}, at = @At("HEAD"))
    public void labyMod$enableVanillaFont(ftk graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
    ...
    public void labyMod$resetFont(ftk graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        RenderAttributesStack renderAttributesStack = renderAttributesStack();
