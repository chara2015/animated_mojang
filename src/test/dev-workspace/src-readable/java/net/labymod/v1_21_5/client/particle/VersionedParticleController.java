package net.labymod.v1_21_5.client.particle;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/particle/VersionedParticleController.class */
@Singleton
...
public class VersionedParticleController implements ParticleController {
    ...
    public void crackBlock(FloatVector3 blockPosition, Direction direction) {
        iw position = new iw(MathHelper.ceil(blockPosition.getX()), MathHelper.ceil(blockPosition.getY()), MathHelper.ceil(blockPosition.getZ()));
        fqq.Q().g.a(position, getMinecraftDirection(direction));
    }

    public jc getMinecraftDirection(Direction direction) {
        switch (direction) {
            case DOWN:
                return jc.a;
            case UP:
