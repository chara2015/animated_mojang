package net.labymod.v1_21_5.client.world.block.properties;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/world/block/properties/VersionedBlockPropertyHolder.class */
public class VersionedBlockPropertyHolder extends AbstractBlockPropertyHolder {
    private final ebs<?, ?> holder;

    public VersionedBlockPropertyHolder(ebs<?, ?> holder) {
        this.holder = holder;
    }
    ...
    protected <T extends Comparable<T>> T getPropertyValue(BlockProperty blockProperty) {
        ect ectVar = (ect) blockProperty;
        if (!this.holder.b(ectVar)) {
            return null;
        }
        Enum r0 = (T) this.holder.c(ectVar);
    ...
    public boolean hasProperty(BlockProperty property) {
        return this.holder.b((ect) property);
    }
}
