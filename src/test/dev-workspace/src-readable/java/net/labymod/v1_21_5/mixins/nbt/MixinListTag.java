...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/nbt/MixinListTag.class */
@Mixin({ug.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, va vaVar);

    @Shadow
    public abstract boolean a(int i, va vaVar);

    @Shadow
    public abstract void d(int i, va vaVar);

    @Shadow
    public abstract va shadow$d(int i);
    ...
    public void add(NBTTag tag) {
        b(size(), (va) CastUtil.cast(tag));
    }

    @Override // net.labymod.api.nbt.tags.NBTTagList
    public void add(int i, NBTTag tag) {
        d(i, (va) CastUtil.cast(tag));
    }

    @Override // net.labymod.api.nbt.tags.NBTTagList
    public void set(int i, NBTTag tag) {
        a(i, (va) CastUtil.cast(tag));
    }
