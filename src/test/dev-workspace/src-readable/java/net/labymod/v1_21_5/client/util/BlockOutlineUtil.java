...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/util/BlockOutlineUtil.class */
public class BlockOutlineUtil {
    public static void renderBlockOutline(dkj level, grn bufferSource, flg lineConsumer, fld poseStack, bxe entity, double x, double y, double z, iw blockPos, ebq blockState, int color) {
        ...
        fgw shape = blockState.a(level, blockPos, fgh.a(entity));
        ...
        if (overlayColor != null) {
            flg overlayConsumer = bufferSource.getBuffer(gry.A());
    ...
    private static a drawLines(flg vertexConsumer, a pose, double x, double y, double z, Color color) {
        ...
        return (minX, minY, minZ, maxX, maxY, maxZ) -> {
            ...
            float offset = azz.c((blockX * blockX) + (blockY * blockY) + (blockZ * blockZ));
    ...
    private static a drawBoxes(flg vertexConsumer, a pose, double x, double y, double z, Color color) {
        float red = color.getRed() / 255.0f;
        float green = color.getGreen() / 255.0f;
        float blue = color.getBlue() / 255.0f;
        float alpha = color.getAlpha() / 255.0f;
    ...
    private static flg addVertex(flg vertexConsumer, Matrix4f matrix, double x, double y, double z) {
