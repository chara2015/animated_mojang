...
import net.labymod.v1_21_5.client.render.matrix.JomlStackProvider;
import net.labymod.v1_21_5.laby3d.pipeline.opengl.Laby3DGlTexture;
import org.joml.Vector3f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gfx/pipeline/VersionedBlaze3DGlStatePipeline.class */
@Singleton
...
public final class VersionedBlaze3DGlStatePipeline extends AbstractBlaze3DGlStatePipeline implements Blaze3DGlStatePipeline {
    ...
    public void bindTexture(DeviceTextureView textureView) {
        ...
        GlResource glDeviceTexture = (GlResource) CastUtil.requireInstanceOf(textureView.texture(), GlResource.class);
        GlStateManager._bindTexture(glDeviceTexture.getId());
        ForeignDeviceTexture foreignDeviceTexture = Laby.references().laby3D().foreignDeviceTextureRegistry().get(Integer.valueOf(glDeviceTexture.getId()));
