...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/world/level/block/entity/MixinSignBlockEntity.class */
@Mixin({eac.class})
public abstract class MixinSignBlockEntity implements SignBlockEntity {
    ...
    private void labyMod$fireTileEntityPreLoadEvent(ua tag, a provider, InsertInfo ci) {
    ...
    public float getRotationYaw() throws MatchException {
        ...
        if ((block instanceof dvt) || (block instanceof dop)) {
            ...
            Integer rotation = (Integer) state.c(ecqVar);
            return 180.0f - ((rotation.intValue() * 360) / 16.0f);
        }
        return 0.0f;
    }

    /* JADX INFO: renamed from: net.labymod.v1_21_5.mixins.world.level.block.entity.MixinSignBlockEntity$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/world/level/block/entity/MixinSignBlockEntity$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$core$Direction = new int[jc.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$core$Direction[jc.c.ordinal()] = 1;
            ...
            try {
                $SwitchMap$net$minecraft$core$Direction[jc.a.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[jc.f.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[jc.d.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[jc.e.ordinal()] = 6;
    ...
    public Component[] getLines(@NotNull SignBlockEntity.SignSide side) {
        ...
        xg[] messages = (side == SignBlockEntity.SignSide.FRONT ? this.f : this.g).b(false);
