package net.labymod.v1_21_5.mixins.client.world.chunk;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/world/chunk/MixinChunkAccess.class */
@Mixin({edn.class})
public abstract class MixinChunkAccess implements Chunk {
    ...
    @Shadow
    @Final
    protected Map<iw, dyo> k;

    @Shadow
    public abstract ehp a(a aVar);

    @Shadow
    public abstract edy b(int i);
    ...
    public boolean isLoaded() {
        return !(this instanceof edt);
    }

    @Override // net.labymod.api.client.world.chunk.Chunk
    public BlockState getBlockState(int x, int y, int z) {
        int index = ((edn) this).f(y);
        if (index < 0 || index >= this.m.length) {
            return dnq.a.m();
        }
        edy section = this.m[index];
        if (section == null) {
            return dnq.a.m();
        }
        int yPos = y & 15;
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (Map.Entry<iw, dyo> entry : this.k.entrySet()) {
            int i = index;
            index++;
