package net.labymod.v1_21_5.client.util.math;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/util/math/VersionedGameMathMapper.class */
@Singleton
...
public class VersionedGameMathMapper implements GameMathMapper {
    ...
    public AxisAlignedBoundingBox fromAABB(Object aabb) {
        if (!(aabb instanceof ffx)) {
            return BOX_IDENTITY;
        }
        ffx gameAABB = (ffx) aabb;
    ...
    public <T> T toAABB(AxisAlignedBoundingBox axisAlignedBoundingBox) {
        return (T) new ffx(axisAlignedBoundingBox.getMinX(), axisAlignedBoundingBox.getMinY(), axisAlignedBoundingBox.getMinZ(), axisAlignedBoundingBox.getMaxX(), axisAlignedBoundingBox.getMaxY(), axisAlignedBoundingBox.getMaxZ());
    }
