package net.labymod.v1_21_5.mixins.client.entity.passive.villager;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/entity/passive/villager/MixinVillager.class */
@Mixin({cru.class})
public abstract class MixinVillager implements Villager {
    @Shadow
    public abstract crv gF();

    @Override // net.labymod.api.client.entity.passive.villager.Villager
    public VillagerJob job() {
        crv villagerData = gF();
        jg<crx> profession = villagerData.b();
