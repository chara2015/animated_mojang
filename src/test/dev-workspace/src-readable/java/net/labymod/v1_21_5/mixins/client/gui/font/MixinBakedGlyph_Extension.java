...
import net.labymod.v1_21_5.client.gfx.pipeline.renderer.text.GlyphUtil;
import org.joml.Matrix4f;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/gui/font/MixinBakedGlyph_Extension.class */
@Mixin({fwu.class})
public abstract class MixinBakedGlyph_Extension implements BakedGlyphExtension {
    ...
    @Shadow
    protected abstract void a(boolean z, float f, float f2, float f3, Matrix4f matrix4f, flg flgVar, int i, boolean z2, int i2);

    @Override // net.labymod.v1_21_5.client.gfx.pipeline.renderer.text.BakedGlyphExtension
    ...
    @Override // net.labymod.v1_21_5.client.gfx.pipeline.renderer.text.BakedGlyphExtension
    public void labyMod$renderGlyph(b instance, Matrix4f pose, flg consumer, int lightCoords, boolean ignoreDepthOffset) {
