...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        cng cngVar = (bxe) entity;
        if (cngVar instanceof cnd) {
            cnd part = (cnd) cngVar;
            cngVar = part.a;
        }
        ...
        dispatcher.a(cngVar, 0.0d, 0.0d, 0.0d, context.getTickDelta(), (fld) context.stack().getProvider().getPoseStack(), fqq.Q().aR().c(), RenderEnvironmentContext.FULL_BRIGHT);
        fkb.d();
