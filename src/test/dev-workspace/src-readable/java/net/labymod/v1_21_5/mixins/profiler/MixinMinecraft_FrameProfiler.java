package net.labymod.v1_21_5.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({fqq.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(grd instance, fqg $$0, boolean $$1, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(fqq instance, Operation<Void> original) {
