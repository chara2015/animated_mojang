...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/resources/pack/rich/VersionedPackDetails.class */
public class VersionedPackDetails implements ResourcePackDetails {
    ...
    @Nullable
    public File getFile() {
        ced cedVarC = this.entry.c();
        if (cedVarC instanceof ced) {
            ced ar = cedVarC;
            return ar.a;
        }
        return null;
    ...
    private boolean isDefaultPack() {
        return this.entry.c() instanceof ceg;
    }
