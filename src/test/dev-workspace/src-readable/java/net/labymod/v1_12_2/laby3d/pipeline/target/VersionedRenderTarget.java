package net.labymod.v1_12_2.laby3d.pipeline.target;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    private final bvd wrapped;

    public VersionedRenderTarget(bvd wrapped) {
