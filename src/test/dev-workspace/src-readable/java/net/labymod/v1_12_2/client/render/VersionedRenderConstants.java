...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/render/VersionedRenderConstants.class */
@Singleton
...
public class VersionedRenderConstants implements RenderConstants {
    ...
    private static final float CAMERA_MOVEMENT_SCALE = 1.0f;
