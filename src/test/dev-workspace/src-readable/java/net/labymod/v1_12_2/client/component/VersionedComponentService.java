...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/component/VersionedComponentService.class */
@Singleton
...
public class VersionedComponentService extends ComponentService {
    ...
    public ClickEvent createClickEvent(ClickEvent.Action action, @NotNull String value) {
        ...
        ClickEvent clickEvent = new hg(vanillaAction, value);
    ...
    public Style getEmptyStyle() {
        return (Style) CastUtil.cast(new hn());
    }
    ...
    public Style createStyleFromBuilder(TextColor color, Integer shadowColor, Boolean bold, Boolean italic, Boolean underlined, Boolean strikethrough, Boolean obfuscated, ClickEvent clickEvent, HoverEvent<?> hoverEvent, String insertion, GlyphSourceDescription glyphSourceDescription) {
        VersionedStyle hnVar = new hn();
        hnVar.a(bold);
        hnVar.b(italic);
        hnVar.d(underlined);
        hnVar.c(strikethrough);
        hnVar.e(obfuscated);
        hnVar.a((hj) hoverEvent);
        hnVar.a((hg) clickEvent);
        hnVar.a(insertion);
        return hnVar.setLabyColor((VersionedTextColor) color);
    }
    ...
    public void applyGsonTypeAdapters(GsonBuilder builder) {
        builder.registerTypeAdapterFactory(new rj());
    }

    private Component applyStyleAndSiblings(he component, Style style, List<Component> children) {
        if (style != null) {
