...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends blk implements LabyScreenRendererAccessor, LabyScreenAccessor {
    ...
    public void c() {
        ...
        VanillaLabyScreen vanillaLabyScreen = this.screen;
        Objects.requireNonNull(vanillaLabyScreen);
        if (screenContext.runInContextWithState(stack, mouse, tickDelta, vanillaLabyScreen::renderBackground)) {
            return;
        }
        super.c();
    }
    ...
    @Override // net.labymod.v1_12_2.client.gui.screen.LabyScreenRendererAccessor, net.labymod.core.client.gui.screen.accessor.FileDropHandler
    ...
    public void a(bib lvt_1_1_, int lvt_2_1_, int lvt_3_1_) {
        super.a(lvt_1_1_, lvt_2_1_, lvt_3_1_);
        Object versionedScreen = screen().mostInnerScreen();
        if (versionedScreen instanceof blk) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/gui/screen/LabyScreenRenderer$LegacyMouseDraggedHandler.class */
