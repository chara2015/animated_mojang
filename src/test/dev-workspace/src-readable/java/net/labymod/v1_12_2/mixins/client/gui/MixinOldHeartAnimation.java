...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/mixins/client/gui/MixinOldHeartAnimation.class */
@Mixin({biq.class})
public class MixinOldHeartAnimation {
    ...
    private void labyMod$oldHeartBackground(biq instance, int x, int y, int u, int v, int uWidth, int vHeight, Operation<Void> original) {
    ...
    private void labyMod$oldFullHeartFlash(biq instance, int x, int y, int u, int v, int uWidth, int vHeight, Operation<Void> original) {
        labyMod$applyOldHeartAnimation(instance, x, y, u, v, uWidth, vHeight, original);
    }
    ...
    private void labyMod$oldHalfHeartFlash(biq instance, int x, int y, int u, int v, int uWidth, int vHeight, Operation<Void> original) {
        labyMod$applyOldHeartAnimation(instance, x, y, u, v, uWidth, vHeight, original);
    }

    private void labyMod$applyOldHeartAnimation(biq instance, int x, int y, int u, int v, int uWidth, int vHeight, Operation<Void> original) {
