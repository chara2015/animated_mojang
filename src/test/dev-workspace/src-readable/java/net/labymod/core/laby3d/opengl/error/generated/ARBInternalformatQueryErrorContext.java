...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/core/laby3d/opengl/error/generated/ARBInternalformatQueryErrorContext.class */
public final class ARBInternalformatQueryErrorContext {
    public static void nglGetInternalformativ(int p0, int p1, int p2, int p3, long p4) {
        ARBInternalformatQuery.nglGetInternalformativ(p0, p1, p2, p3, p4);
    ...
    public static void glGetInternalformativ(int p0, int p1, int p2, IntBuffer p3) {
        ARBInternalformatQuery.glGetInternalformativ(p0, p1, p2, p3);
    ...
    public static int glGetInternalformati(int p0, int p1, int p2) {
        int returnType = ARBInternalformatQuery.glGetInternalformati(p0, p1, p2);
