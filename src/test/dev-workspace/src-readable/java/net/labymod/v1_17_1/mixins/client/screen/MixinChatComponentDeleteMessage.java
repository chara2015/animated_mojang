...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/screen/MixinChatComponentDeleteMessage.class */
@Mixin({dxb.class})
public class MixinChatComponentDeleteMessage {
    ...
    private void labyMod$deleteChatMessage(int index, InsertInfo callback) {
        for (dvk<os> message : this.e) {
            if (message.c() == index) {
                VersionedChatMessageComponent versionedChatMessageComponent = (os) message.a();
