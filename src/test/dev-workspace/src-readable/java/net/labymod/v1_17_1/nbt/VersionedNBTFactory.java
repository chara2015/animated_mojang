package net.labymod.v1_17_1.nbt;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/nbt/VersionedNBTFactory.class */
...
public class VersionedNBTFactory implements NBTFactory {
    ...
    public boolean deepEquals(NBTTag<?> a, NBTTag<?> b, boolean compareLists) {
        ...
        return nm.a((ns) a, (ns) b, compareLists);
    }
}
