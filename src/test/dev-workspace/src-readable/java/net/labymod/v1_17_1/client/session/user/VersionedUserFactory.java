package net.labymod.v1_17_1.client.session.user;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/session/user/VersionedUserFactory.class */
@Singleton
...
public class VersionedUserFactory implements UserFactory {
    ...
    public Object createUser(Session session) {
        ...
        return new dwd(session.getUsername(), session.getUniqueId().toString(), session.getAccessToken(), type.toString());
    }
}
