...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/gui/components/MixinAbstractSelectionListScrollbar.class */
@Mixin({dww.class})
public abstract class MixinAbstractSelectionListScrollbar {
    ...
    private int labyMod$render(dww instance) {
