...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/world/phys/MixinHitResult.class */
@Mixin({dmy.class})
    ...
    public FloatVector3 location() {
        if (this.labyMod$hitLocation == null) {
            if (this.a == null) {
                ...
                this.labyMod$hitLocation = new FloatVector3((float) this.a.b, (float) this.a.c, (float) this.a.d);
            }
        }
        return this.labyMod$hitLocation;
    }

    /* JADX INFO: renamed from: net.labymod.v1_17_1.mixins.client.world.phys.MixinHitResult$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/world/phys/MixinHitResult$1.class */
