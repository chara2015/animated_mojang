...
import net.labymod.v1_17_1.client.resources.texture.VersionedLabyTexture;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/util/MinecraftUtil.class */
public final class MinecraftUtil {
    ...
    private static final Function<Object, exa> TEXTURES = MEMOIZE.memoize(texture -> {
        if (texture instanceof LabyTexture) {
            LabyTexture labyTexture = (LabyTexture) texture;
            return new VersionedLabyTexture(labyTexture);
        }
        if (texture instanceof exa) {
            exa textureObject = (exa) texture;
    ...
    public static Stack obtainStackFromGraphics(dql graphics) {
        return ((VanillaStackAccessor) graphics).stack();
    }

    public static void obtainScreenContextFromPoseStack(dql graphics, Consumer<ScreenContext> callback) {
    ...
    public static void obtainScreenContextFromPoseStack(dql graphics, int mouseX, int mouseY, float tickDelta, Consumer<ScreenContext> callback) {
    ...
    public static ItemStack fromMinecraftSlot(atu entity, LivingEntity.EquipmentSpot spot) {
        return fromMinecraft(entity.b(toMinecraft(spot)));
    }

    public static ItemStack fromMinecraft(bqq itemStack) {
        return (ItemStack) itemStack;
    }

    public static bqq toMinecraft(ItemStack itemStack) {
        return (bqq) itemStack;
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static Direction fromMinecraft(gl direction) throws MatchException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static gl toMinecraft(@NotNull Direction direction) throws MatchException {
        switch (direction) {
            case DOWN:
                return gl.a;
            case UP:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static atl toMinecraft(LivingEntity.EquipmentSpot spot) throws MatchException {
        switch (spot) {
            case HEAD:
                return atl.f;
            case CHEST:
    ...
    public static void exportScreenshotToFile(dpm image, File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(Player player) {
        erw dispatcher = dvp.C().ac();
        ewt ewtVarA = dispatcher.a((atg) player);
    ...
    /* JADX INFO: renamed from: net.labymod.v1_17_1.client.util.MinecraftUtil$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/util/MinecraftUtil$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$core$Direction = new int[gl.values().length];
            try {
    ...
    public static ags fromText(String text, Style style) {
        mv language = mv.a();
        return language.a(ov.a(text, (pc) style));
    }

    public static exa toMinecraft(Object texture) {
        return TEXTURES.apply(texture);
    }

    public static atg unwrapEntity(atg entity) {
