...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/server/packs/resources/MixinSimpleResource.class */
@Mixin({aea.class})
public class MixinSimpleResource {
    ...
    private void labyMod$transformResourceInputStream(aea resource, InputStream stream) {
