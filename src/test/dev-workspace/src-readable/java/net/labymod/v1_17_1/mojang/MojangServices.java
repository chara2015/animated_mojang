...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mojang/MojangServices.class */
public final class MojangServices {
    ...
    public static SocialInteractionsService createSocialInteractions(MinecraftSessionService service, dwd user) {
    ...
    public static SocialInteractionsService createSocialInteractions(YggdrasilAuthenticationService service, dwd user) {
        try {
