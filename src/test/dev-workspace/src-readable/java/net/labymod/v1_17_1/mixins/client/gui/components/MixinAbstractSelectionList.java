...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/gui/components/MixinAbstractSelectionList.class */
@Mixin({dww.class})
public abstract class MixinAbstractSelectionList {
    ...
    public void labyMod$renderBackground(dql stack, int param1, int param2, float param3, InsertInfo ci) {
    ...
    public void labyMod$renderTopAndBottom(dql stack, int param1, int param2, float param3, InsertInfo ci) {
        Theme theme = Laby.labyAPI().themeService().currentTheme();
        if (!theme.metadata().getBoolean(DefaultThemeVariables.HIDE_DEFAULT_BACKGROUND)) {
    ...
    public void labyMod$renderList(dww instance, dql stack, int left, int top, int mouseX, int mouseY, float partialTicks, Operation<Void> original) {
