...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/screen/MixinBookScreenVanillaFont.class */
@Mixin({ebt.class, ebs.class})
public class MixinBookScreenVanillaFont {
    @Insert(method = {"render"}, at = @At("HEAD"))
    public void labyMod$enableVanillaFont(dql stack, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
    ...
    public void labyMod$resetFont(dql stack, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        RenderAttributesStack renderAttributesStack = renderAttributesStack();
