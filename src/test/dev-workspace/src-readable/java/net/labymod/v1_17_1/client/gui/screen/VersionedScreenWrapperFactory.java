...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/gui/screen/VersionedScreenWrapperFactory.class */
@Singleton
...
public class VersionedScreenWrapperFactory implements ScreenWrapper.Factory {
    ...
    public ScreenWrapper create(Object vanillaScreen) {
        if (!(vanillaScreen instanceof eaq)) {
            throw new IllegalArgumentException(vanillaScreen.getClass().getName() + " is not an instance of " + eaq.class.getName());
        }
        eaq screen = (eaq) vanillaScreen;
