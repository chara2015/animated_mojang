...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/world/LabyBiomeBlender.class */
public class LabyBiomeBlender implements bvs {
    ...
    public LabyBiomeBlender setLevel(bwq level) {
        this.level = level;
        return this;
    }
    ...
    public float a(@NotNull gl direction, boolean shade) {
    ...
    @Nullable
    public ciq c_(@NotNull gg blockPos) {
        return this.level.c_(blockPos);
    }

    @NotNull
    public ckt a_(@NotNull gg blockPos) {
        return this.level.a_(blockPos);
    }

    @NotNull
    public des b_(@NotNull gg blockPos) {
    ...
    public int a(@NotNull gg blockPos, @NotNull ColorResolver resolver) {
        int x = blockPos.u();
        int y = blockPos.v();
        int z = blockPos.w();
        int[] rgb = new int[3];
    ...
    private int blendColors(a currentPos, ColorResolver resolver, int total, int[] rgb) {
        bxp biome = this.level.w(currentPos);
        if (biome != null) {
