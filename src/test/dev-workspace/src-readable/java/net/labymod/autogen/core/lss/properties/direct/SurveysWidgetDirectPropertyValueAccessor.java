...
import net.labymod.autogen.core.lss.properties.resetters.SurveysWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/SurveysWidgetDirectPropertyValueAccessor.class */
public class SurveysWidgetDirectPropertyValueAccessor extends VerticalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter SurveysWidgetResetter = new SurveysWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.SurveysWidgetResetter;
    }
}
