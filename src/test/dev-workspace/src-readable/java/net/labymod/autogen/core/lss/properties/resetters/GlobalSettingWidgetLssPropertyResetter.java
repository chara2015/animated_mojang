...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/GlobalSettingWidgetLssPropertyResetter.class */
public class GlobalSettingWidgetLssPropertyResetter extends HorizontalListWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof GlobalSettingWidget) {
        }
        super.reset(widget);
    }
}
