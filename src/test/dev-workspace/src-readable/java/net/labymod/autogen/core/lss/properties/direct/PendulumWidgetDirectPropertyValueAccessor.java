...
import net.labymod.autogen.core.lss.properties.resetters.PendulumWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/PendulumWidgetDirectPropertyValueAccessor.class */
public class PendulumWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter PendulumWidgetResetter = new PendulumWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.PendulumWidgetResetter;
    }
}
