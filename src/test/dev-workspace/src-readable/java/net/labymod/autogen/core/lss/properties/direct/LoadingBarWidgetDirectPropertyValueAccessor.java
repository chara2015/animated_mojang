...
import net.labymod.autogen.core.lss.properties.resetters.LoadingBarWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/LoadingBarWidgetDirectPropertyValueAccessor.class */
public class LoadingBarWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter LoadingBarWidgetResetter = new LoadingBarWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.LoadingBarWidgetResetter;
    }
}
