...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/LabyConnectFriendProfileWidgetLssPropertyResetter.class */
public class LabyConnectFriendProfileWidgetLssPropertyResetter extends SimpleWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof LabyConnectFriendProfileWidget) {
        }
        super.reset(widget);
    }
}
