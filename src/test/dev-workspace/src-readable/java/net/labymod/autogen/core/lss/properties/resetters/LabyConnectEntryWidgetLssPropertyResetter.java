...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/LabyConnectEntryWidgetLssPropertyResetter.class */
public class LabyConnectEntryWidgetLssPropertyResetter extends SimpleWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof LabyConnectEntryWidget) {
        }
        super.reset(widget);
    }
}
