...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/DNAHelixWidgetLssPropertyResetter.class */
public class DNAHelixWidgetLssPropertyResetter extends SimpleWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof DNAHelixWidget) {
        }
        super.reset(widget);
    }
}
