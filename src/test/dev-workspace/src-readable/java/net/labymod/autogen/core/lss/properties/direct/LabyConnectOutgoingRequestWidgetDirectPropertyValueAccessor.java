...
import net.labymod.autogen.core.lss.properties.resetters.LabyConnectOutgoingRequestWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/LabyConnectOutgoingRequestWidgetDirectPropertyValueAccessor.class */
public class LabyConnectOutgoingRequestWidgetDirectPropertyValueAccessor extends LabyConnectRequestWidgetDirectPropertyValueAccessor {
    LssPropertyResetter LabyConnectOutgoingRequestWidgetResetter = new LabyConnectOutgoingRequestWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.LabyConnectOutgoingRequestWidgetResetter;
    }
}
