...
import net.labymod.autogen.core.lss.properties.resetters.LabyConnectChatMessageContentWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/LabyConnectChatMessageContentWidgetDirectPropertyValueAccessor.class */
public class LabyConnectChatMessageContentWidgetDirectPropertyValueAccessor extends VerticalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter LabyConnectChatMessageContentWidgetResetter = new LabyConnectChatMessageContentWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.LabyConnectChatMessageContentWidgetResetter;
    }
}
