...
import net.labymod.autogen.core.lss.properties.resetters.DNAHelixWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/DNAHelixWidgetDirectPropertyValueAccessor.class */
public class DNAHelixWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter DNAHelixWidgetResetter = new DNAHelixWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.DNAHelixWidgetResetter;
    }
}
