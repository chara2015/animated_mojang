...
import net.labymod.autogen.core.lss.properties.resetters.SideAnnouncementWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/SideAnnouncementWidgetDirectPropertyValueAccessor.class */
public class SideAnnouncementWidgetDirectPropertyValueAccessor extends HorizontalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter SideAnnouncementWidgetResetter = new SideAnnouncementWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.SideAnnouncementWidgetResetter;
    }
}
