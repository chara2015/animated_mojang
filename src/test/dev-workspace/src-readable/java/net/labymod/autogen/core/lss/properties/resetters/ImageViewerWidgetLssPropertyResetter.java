...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/ImageViewerWidgetLssPropertyResetter.class */
public class ImageViewerWidgetLssPropertyResetter extends SimpleWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof ImageViewerWidget) {
        }
        super.reset(widget);
    }
}
