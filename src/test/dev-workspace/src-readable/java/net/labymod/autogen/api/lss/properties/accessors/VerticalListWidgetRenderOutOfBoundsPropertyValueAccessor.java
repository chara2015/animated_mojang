...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/VerticalListWidgetRenderOutOfBoundsPropertyValueAccessor.class */
public final class VerticalListWidgetRenderOutOfBoundsPropertyValueAccessor implements PropertyValueAccessor<VerticalListWidget, Boolean, Boolean> {
    ...
    public LssProperty getProperty(VerticalListWidget widget) {
        return widget.renderOutOfBounds();
    }
