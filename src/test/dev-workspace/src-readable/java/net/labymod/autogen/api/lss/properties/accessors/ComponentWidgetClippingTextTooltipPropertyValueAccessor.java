...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/ComponentWidgetClippingTextTooltipPropertyValueAccessor.class */
public final class ComponentWidgetClippingTextTooltipPropertyValueAccessor implements PropertyValueAccessor<ComponentWidget, Boolean, Boolean> {
    ...
    public LssProperty getProperty(ComponentWidget widget) {
        return widget.clippingTextTooltip();
    }
