...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/TileComponentWidgetLssPropertyResetter.class */
public class TileComponentWidgetLssPropertyResetter extends AbstractWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof ChatSymbolActivity.TileComponentWidget) {
        }
        super.reset(widget);
    }
}
