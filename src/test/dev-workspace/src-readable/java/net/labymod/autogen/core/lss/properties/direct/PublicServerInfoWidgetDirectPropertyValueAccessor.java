...
import net.labymod.autogen.core.lss.properties.resetters.PublicServerInfoWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/PublicServerInfoWidgetDirectPropertyValueAccessor.class */
public class PublicServerInfoWidgetDirectPropertyValueAccessor extends LabyNetServerInfoWidgetDirectPropertyValueAccessor {
    LssPropertyResetter PublicServerInfoWidgetResetter = new PublicServerInfoWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.PublicServerInfoWidgetResetter;
    }
}
