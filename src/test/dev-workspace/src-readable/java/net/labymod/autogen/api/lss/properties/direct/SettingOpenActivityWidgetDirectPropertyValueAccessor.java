...
import net.labymod.autogen.api.lss.properties.resetters.SettingOpenActivityWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/SettingOpenActivityWidgetDirectPropertyValueAccessor.class */
public class SettingOpenActivityWidgetDirectPropertyValueAccessor extends HorizontalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter SettingOpenActivityWidgetResetter = new SettingOpenActivityWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.SettingOpenActivityWidgetResetter;
    }
}
