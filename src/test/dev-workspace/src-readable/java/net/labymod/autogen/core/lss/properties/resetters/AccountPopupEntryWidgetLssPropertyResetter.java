...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/AccountPopupEntryWidgetLssPropertyResetter.class */
public class AccountPopupEntryWidgetLssPropertyResetter extends AbstractWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof AccountPopupEntryWidget) {
        }
        super.reset(widget);
    }
}
