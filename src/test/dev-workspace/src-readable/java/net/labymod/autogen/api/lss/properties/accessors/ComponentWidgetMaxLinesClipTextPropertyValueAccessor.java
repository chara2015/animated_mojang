...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/ComponentWidgetMaxLinesClipTextPropertyValueAccessor.class */
public final class ComponentWidgetMaxLinesClipTextPropertyValueAccessor implements PropertyValueAccessor<ComponentWidget, Boolean, Boolean> {
    ...
    public LssProperty getProperty(ComponentWidget widget) {
        return widget.maxLinesClipText();
    }
