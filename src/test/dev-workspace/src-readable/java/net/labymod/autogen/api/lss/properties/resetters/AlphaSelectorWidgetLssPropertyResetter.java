...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/resetters/AlphaSelectorWidgetLssPropertyResetter.class */
public class AlphaSelectorWidgetLssPropertyResetter extends SelectorWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof AlphaSelectorWidget) {
        }
        super.reset(widget);
    }
}
