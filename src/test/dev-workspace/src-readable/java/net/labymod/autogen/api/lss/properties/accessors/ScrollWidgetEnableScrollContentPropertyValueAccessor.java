...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/ScrollWidgetEnableScrollContentPropertyValueAccessor.class */
public final class ScrollWidgetEnableScrollContentPropertyValueAccessor implements PropertyValueAccessor<ScrollWidget, Boolean, Boolean> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(ScrollWidget widget) {
        return widget.enableScrollContent();
    }
