...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/RevisionPopupWidgetLssPropertyResetter.class */
public class RevisionPopupWidgetLssPropertyResetter extends SimpleWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof RevisionPopupWidget) {
        }
        super.reset(widget);
    }
}
