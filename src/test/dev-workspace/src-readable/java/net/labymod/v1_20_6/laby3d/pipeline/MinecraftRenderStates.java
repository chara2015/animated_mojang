...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/laby3d/pipeline/MinecraftRenderStates.class */
public final class MinecraftRenderStates {
    private static String versionId;
    public static final MinecraftRenderState TEXT = new MinecraftRenderState(FontRenderStates.VANILLA_TEXT, ezy.t, b.h, createMinecraftConfigId("rendertype_text"));
    public static final MinecraftRenderState TEXT_SEE_THROUGH = new MinecraftRenderState(FontRenderStates.VANILLA_SEE_THROUGH_TEXT, ezy.t, b.h, createMinecraftConfigId("rendertype_text_see_through"));
    public static final MinecraftRenderState TEXT_INTENSITY = new MinecraftRenderState(FontRenderStates.VANILLA_INTENSITY_TEXT, ezy.t, b.h, createMinecraftConfigId("rendertype_text_intensity"));
    public static final MinecraftRenderState TEXT_INTENSITY_SEE_THROUGH = new MinecraftRenderState(FontRenderStates.VANILLA_INTENSITY_SEE_THROUGH_TEXT, ezy.t, b.h, createMinecraftConfigId("rendertype_text_see_through"));
