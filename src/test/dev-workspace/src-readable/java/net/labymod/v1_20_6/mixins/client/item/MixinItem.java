...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/item/MixinItem.class */
@Mixin({cum.class})
public abstract class MixinItem implements Item {
    ...
    public ResourceLocation getIdentifier() {
        if (this.labyMod$identifier == null) {
            this.labyMod$identifier = lp.h.b((cum) this);
        }
    ...
    public int getMaximumDamage() {
        return ((Integer) p().a(km.d, 0)).intValue();
    }
