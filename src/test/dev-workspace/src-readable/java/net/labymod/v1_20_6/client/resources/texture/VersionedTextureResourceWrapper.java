...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/resources/texture/VersionedTextureResourceWrapper.class */
public class VersionedTextureResourceWrapper extends TextureResourceWrapper<gom> {
    public VersionedTextureResourceWrapper(gom minecraftTexture) {
        super(minecraftTexture);
    }

    @Override // net.labymod.api.client.resources.texture.TextureResourceWrapper
    public GameImage getImage() {
        goo gooVar = (gom) getDelegate();
        GameImage image = null;
        if (gooVar instanceof goo) {
            goo dynamicTexture = gooVar;
            ezb pixels = dynamicTexture.e();
