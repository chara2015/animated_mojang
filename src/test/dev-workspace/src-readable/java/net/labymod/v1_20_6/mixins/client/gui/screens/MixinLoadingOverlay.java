...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({fmr.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(fnf screen, fgt graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
