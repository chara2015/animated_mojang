...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/chat/contents/MixinScoreContents.class */
@Mixin({yx.class})
public class MixinScoreContents implements ScoreContentsAccessor {
    ...
    @Override // net.labymod.v1_20_6.client.network.chat.contents.ScoreContentsAccessor
