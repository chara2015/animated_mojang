...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        cid cidVar = (bsw) entity;
        if (cidVar instanceof cib) {
            cib part = (cib) cidVar;
            cidVar = part.b;
        }
        ...
        dispatcher.a(cidVar, 0.0d, 0.0d, 0.0d, 0.0f, context.getTickDelta(), (faa) context.stack().getProvider().getPoseStack(), ffh.Q().aQ().c(), RenderEnvironmentContext.FULL_BRIGHT);
        eyw.d();
