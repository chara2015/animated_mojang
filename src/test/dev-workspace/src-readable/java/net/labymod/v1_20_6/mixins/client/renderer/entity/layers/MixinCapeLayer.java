...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/renderer/entity/layers/MixinCapeLayer.class */
@Mixin({gml.class})
public class MixinCapeLayer {
    ...
    private void labyMod$firePreCapeRenderEvent(faa poseStack, gdq param1, int param2, gcp clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(faa poseStack, gdq param1, int param2, gcp clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
        labyMod$fireCapeRenderEvent(poseStack, clientPlayer, Phase.POST);
    }

    @WrapOperation(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = {@At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;")})
    private gdy labyMod$attach(alf location, Operation<gdy> original) {
        gdy gdyVar = (gdy) original.call(new Object[]{location});
        this.labyMod$renderType = gdyVar;
        return gdyVar;
    }

    @Insert(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(faa param0, gdq param1, int param2, gcp player, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(faa poseStack, gcp clientPlayer, Phase phase) {
        Player player = (Player) clientPlayer;
        PlayerModel playerModel = ((gnl) this).c();
