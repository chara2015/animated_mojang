package net.labymod.v1_20_6.mojang.texture;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mojang/texture/VersionedMojangTextureService.class */
@Singleton
...
public class VersionedMojangTextureService extends DefaultMojangTextureService {
    ...
    public ResourceLocation getDefaultTexture(UUID profileId, MojangTextureType type) throws MatchException {
        gqb playerSkin = gpt.a(profileId);
        switch (type) {
            case SKIN:
                return playerSkin.a();
            case CAPE:
