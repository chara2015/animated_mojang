package net.labymod.v1_20_6.mixins.client.gui.components.tabs;
...
import net.labymod.v1_20_6.client.gui.TabNavigationBarAccessor;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({fjk.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fja implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    private final WidgetWatcher<T> watcher = new WidgetWatcher<>();
    private final Map<fji, TabNavigationBarAccessor.VersionedTab> versionedTabs = new HashMap();

    @Shadow
    @Final
    private ImmutableList<fji> i;

    @Shadow
    @Final
    private fjj h;
    private fji labyMod$currentTab;

    @Override // net.labymod.v1_20_6.client.gui.TabNavigationBarAccessor
    public ImmutableList<fji> getTabs() {
        return this.i;
    }

    @Override // net.labymod.v1_20_6.client.gui.TabNavigationBarAccessor
    public fjj getTabManager() {
        return this.h;
    }
    ...
    @Override // net.labymod.v1_20_6.client.gui.TabNavigationBarAccessor
    public TabNavigationBarAccessor.VersionedTab versionedTabOf(fji tab) {
