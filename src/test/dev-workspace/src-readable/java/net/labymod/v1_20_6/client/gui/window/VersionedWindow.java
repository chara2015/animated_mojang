package net.labymod.v1_20_6.client.gui.window;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/gui/window/VersionedWindow.class */
public class VersionedWindow extends DefaultAbstractWindow {
    ...
    public ScreenWrapper currentScreen() {
        ...
        if (screen != this.currentScreen) {
            ...
            boolean previousScreen = !(screen instanceof flx);
    ...
    public Object mostInnerScreen() throws TooManyIterationsException {
        return getMostInnerScreen(ffh.Q().y);
    }
