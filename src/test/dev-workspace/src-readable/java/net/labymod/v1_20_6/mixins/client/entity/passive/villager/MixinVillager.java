package net.labymod.v1_20_6.mixins.client.entity.passive.villager;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/entity/passive/villager/MixinVillager.class */
@Mixin({cmm.class})
public abstract class MixinVillager implements Villager {
    @Shadow
    public abstract cmn gB();
