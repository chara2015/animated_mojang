...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/gui/screen/widget/converter/TabLayoutConverter.class */
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<fjk, AbstractWidget<?>> {
    ...
    public /* bridge */ /* synthetic */ void update(Object obj, AbstractWidget abstractWidget, @NotNull WidgetReplacementStrategy widgetReplacementStrategy) {
        update((fjk) obj, (AbstractWidget<?>) abstractWidget, widgetReplacementStrategy);
    }
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public AbstractWidget<?> createDefault(fjk source) {
        TabNavigationBarAccessor accessor = (TabNavigationBarAccessor) source;
        fjj tabManager = accessor.getTabManager();
        fji currentTab = tabManager.a();
    ...
    public void update(fjk source, AbstractWidget<?> destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
