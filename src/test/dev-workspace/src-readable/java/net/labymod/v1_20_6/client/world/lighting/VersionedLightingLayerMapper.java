package net.labymod.v1_20_6.client.world.lighting;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/world/lighting/VersionedLightingLayerMapper.class */
@Singleton
...
public class VersionedLightingLayerMapper implements LightingLayerMapper {
    ...
    public LightType fromMinecraft(Object value) throws MatchException {
        if (!(value instanceof dcj)) {
            throw new IllegalArgumentException(value.getClass().getName() + " is not an instance of " + dcj.class.getName());
        }
        dcj lightLayer = (dcj) value;
    ...
    /* JADX INFO: renamed from: net.labymod.v1_20_6.client.world.lighting.VersionedLightingLayerMapper$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/world/lighting/VersionedLightingLayerMapper$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$level$LightLayer = new int[dcj.values().length];
            try {
                $SwitchMap$net$minecraft$world$level$LightLayer[dcj.a.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$LightLayer[dcj.b.ordinal()] = 2;
