package net.labymod.v1_20_6.laby3d;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/laby3d/VersionedGlRenderDevice.class */
public class VersionedGlRenderDevice extends GlRenderDevice {
    ...
    public CommandBuffer createCommandBuffer(int flags) {
        return new ContextAwareCommandBuffer(this, super.createCommandBuffer(flags), ezw::a, flags);
    }

    @NotNull
    public DeviceBuffer createBuffer(@NotNull String label, @NotNull BufferDescription description) {
        fad.b();
        return super.createBuffer(label, description);
    }
