...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/chat/VersionedChatExecutor.class */
@Singleton
@Implements(ChatExecutor.class)
public class VersionedChatExecutor extends DefaultChatExecutor {
    private final ComponentMapper componentMapper;
    private final flv dummyChatScreen = new flv("");
    ...
    public void chat(String message, boolean addToHistory) {
        this.dummyChatScreen.b(ffh.Q(), 0, 0);
    ...
    public void displayActionBar(Component message, boolean animate) {
        fgs chatGui = ffh.Q().l;
        xp component = (xp) this.componentMapper.toMinecraftComponent(message);
    ...
    public void showTitle(@NotNull Title title) {
        ...
        if (title.getTitle() != null) {
            ffh.Q().l.c((xp) Laby.references().componentMapper().toMinecraftComponent(title.getTitle()));
        } else {
            ffh.Q().l.c(xp.i());
        }
        if (title.getSubTitle() != null) {
            ffh.Q().l.b((xp) Laby.references().componentMapper().toMinecraftComponent(title.getSubTitle()));
        }
        ffh.Q().l.a(title.getFadeInTicks(), title.getStayTicks(), title.getFadeOutTicks());
    }
