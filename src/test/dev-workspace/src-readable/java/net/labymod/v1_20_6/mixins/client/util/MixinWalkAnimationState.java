...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/util/MixinWalkAnimationState.class */
@Mixin({bus.class})
public class MixinWalkAnimationState implements WalkAnimationStateAccessor {
    ...
    @Override // net.labymod.v1_20_6.client.util.WalkAnimationStateAccessor
