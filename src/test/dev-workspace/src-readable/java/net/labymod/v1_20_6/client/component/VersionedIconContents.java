...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/component/VersionedIconContents.class */
public class VersionedIconContents implements xq {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull ym style) {
