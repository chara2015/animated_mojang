package net.labymod.v1_20_6.client.player;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/player/VersionedNetworkPlayerInfo.class */
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    private final fyi wrapped;
    private final Component usernameComponent = Component.text(profile().getUsername());
    private Metadata metadata = Metadata.create();

    public VersionedNetworkPlayerInfo(fyi wrapped) {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_20_6.client.player.VersionedNetworkPlayerInfo$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[dbx.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dbx.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dbx.b.ordinal()] = 2;
    ...
    public fyi getWrapped() {
        return this.wrapped;
    }

    private xp decorateComponent(@NotNull fyi info, yd mutableComponent) {
        if (info.e() == dbx.d) {
