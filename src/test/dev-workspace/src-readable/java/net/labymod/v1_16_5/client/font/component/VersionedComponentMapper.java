...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/font/component/VersionedComponentMapper.class */
@Singleton
...
public class VersionedComponentMapper implements ComponentMapper {
    ...
    public String getTranslationKeyOfComponent(Object minecraftComponent) {
        if (minecraftComponent instanceof of) {
            return ((of) minecraftComponent).i();
        }
        return null;
    }
}
