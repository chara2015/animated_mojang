package net.labymod.v1_16_5.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({djz.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(dzz instance, float v, long l, boolean b, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(djz instance, Operation<Void> original) {
