...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/laby3d/VersionedGlRenderDevice.class */
public class VersionedGlRenderDevice extends GlRenderDevice {
    ...
    public CommandBuffer createCommandBuffer(int flags) {
        return new ContextAwareCommandBuffer(this, super.createCommandBuffer(flags), Runnables.doNothing(), flags);
    }
