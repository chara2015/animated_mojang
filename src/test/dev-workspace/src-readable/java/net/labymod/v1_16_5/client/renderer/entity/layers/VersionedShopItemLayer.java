...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/renderer/entity/layers/VersionedShopItemLayer.class */
public class VersionedShopItemLayer extends eit<dzj, dvd<dzj>> {
    ...
    public VersionedShopItemLayer(egk<dzj, dvd<dzj>> layerParent) {
        super(layerParent);
    ...
    public void a(@NotNull dfm poseStack, @NotNull eag bufferSource, int lightCoords, @NotNull dzj player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
