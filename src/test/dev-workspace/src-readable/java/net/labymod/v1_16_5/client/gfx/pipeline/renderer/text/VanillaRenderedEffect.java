...
import net.labymod.v1_16_5.client.gfx.pipeline.blaze3d.PositionTextureColorVertexConsumer;
import net.labymod.v1_16_5.client.util.MinecraftUtil;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/gfx/pipeline/renderer/text/VanillaRenderedEffect.class */
public class VanillaRenderedEffect implements GlyphRenderable {
    ...
    public VanillaRenderedEffect(dmz bakedGlyph, a effect) {
        ...
        this.effect = effect;
        this.renderState = MinecraftUtil.resolveTextState(TextDrawMode.NORMAL, this.extension.labyMod$isColored());
    }
