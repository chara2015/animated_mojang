...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/client/gui/MixinOldHeartAnimation.class */
@Mixin({dkv.class})
public class MixinOldHeartAnimation {
    ...
    private void labyMod$applyOldHeartAnimation(dkv instance, dfm poseStack, int i0, int i1, int i2, int i3, int i4, int i5, Operation<Void> original) {
