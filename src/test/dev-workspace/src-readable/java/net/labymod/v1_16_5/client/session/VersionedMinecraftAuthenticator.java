...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/session/VersionedMinecraftAuthenticator.class */
@Singleton
...
public class VersionedMinecraftAuthenticator extends DefaultsAbstractMinecraftAuthenticator {
    ...
    public VersionedMinecraftAuthenticator() {
        ...
        YggdrasilAuthenticationService yggdrasilAuthenticationServiceY = djz.C().Y();
        if (yggdrasilAuthenticationServiceY instanceof YggdrasilAuthenticationService) {
            yggdrasilAuthenticationService = yggdrasilAuthenticationServiceY;
        } else {
