package net.labymod.v1_16_5.client.resources.sound;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/resources/sound/VersionedMinecraftSounds.class */
@Singleton
...
public class VersionedMinecraftSounds implements MinecraftSounds {
    ...
    public void playChatFilterSound() {
        djz.C().W().a(emp.a(adq.jv, 1.0f));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch) {
        playSound(emp.a(new adp((vk) location.getMinecraftLocation()), pitch, volume));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch, FloatVector3 position) {
        playSound(new emp((vk) location.getMinecraftLocation(), adr.a, volume, pitch, false, 0, a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    ...
    private void playSound(emp sound) {
        sound.a(djz.C().W());
        djz.C().W().a(sound);
    }
}
