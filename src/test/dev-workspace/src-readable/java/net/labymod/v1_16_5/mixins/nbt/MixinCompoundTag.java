...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/nbt/MixinCompoundTag.class */
@Mixin({md.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, mt> i;

    @Shadow
    public abstract mt a(String str, mt mtVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract mt shadow$c(String str);

    @Shadow
    public abstract boolean e(String str);

    @Shadow
    public abstract boolean c(String str, int i);
    ...
    @Shadow
    public abstract md shadow$p(String str);

    @Shadow
    public abstract mj d(String str, int i);
    ...
    public <I, T extends NBTTag<I>> NBTTagList<I, T> getList(@NotNull String key, @NotNull NBTTagType contentType) {
        return d(key, contentType.getId());
    }
