...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/multiplayer/server/VersionedServerData.class */
public class VersionedServerData extends dwz {
    ...
    public void a(@NotNull a packStatus) {
        ...
        if (this.serverData instanceof StorageServerData) {
            ((StorageServerData) this.serverData).setResourcePackStatus(of(packStatus));
        }
    }
    ...
    /* JADX INFO: renamed from: net.labymod.v1_16_5.client.multiplayer.server.VersionedServerData$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/multiplayer/server/VersionedServerData$1.class */
