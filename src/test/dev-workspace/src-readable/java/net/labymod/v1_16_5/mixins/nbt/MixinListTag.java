...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/nbt/MixinListTag.class */
@Mixin({mj.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, mt mtVar);

    @Shadow
    public abstract boolean a(int i, mt mtVar);

    @Shadow
    public abstract void c(int i, mt mtVar);

    @Shadow
    public abstract mt shadow$c(int i);
    ...
    public NBTTagType contentType() {
        if (this.h != 0 || isEmpty()) {
            return NBTTagType.getById(this.h);
        }
        return null;
    }
}
