...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/render/matrix/VersionedStackProvider.class */
public final class VersionedStackProvider extends AbstractStackProvider<dfm, Matrix3f, Matrix4f> {
    private static final GameMathMapper MAPPER = MathHelper.mapper();

    public VersionedStackProvider(dfm poseStack) {
        super(poseStack, () -> {
    ...
    public void rotate(float angle, float x, float y, float z) {
        ...
        ((dfm) this.stack).a((d) MAPPER.toQuaternion(ROTATION_VECTOR.rotationDegrees(angle)));
    }

    @Override // net.labymod.api.client.render.matrix.StackProvider
    public void rotateRadians(float radians, float x, float y, float z) {
        ROTATION_VECTOR.set(x, y, z);
        ((dfm) this.stack).a((d) MAPPER.toQuaternion(ROTATION_VECTOR.rotation(radians)));
    }
    ...
    public void mul(Matrix4f matrix) {
        ((dfm) this.stack).c().a().a((b) MAPPER.toMatrix4f(MAPPER.fromMatrix4f(matrix)));
    }
