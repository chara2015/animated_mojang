...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1_2/mixins/client/chat/MixinHoverEvent.class */
...
public interface MixinHoverEvent extends net.labymod.api.client.component.event.HoverEvent {
    @Shadow
    HoverEvent.Action shadow$action();
    ...
    default HoverEvent.Action<?> action() {
        if (shadow$action() == HoverEvent.Action.SHOW_TEXT) {
