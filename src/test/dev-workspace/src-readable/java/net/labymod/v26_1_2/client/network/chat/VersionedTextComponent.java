package net.labymod.v26_1_2.client.network.chat;

import java.util.Objects;
import net.labymod.api.client.component.ComponentService;
import net.labymod.api.client.component.TextComponent;
import net.labymod.api.util.CastUtil;
import net.labymod.v26_1_2.client.network.chat.contents.LiteralContentsAccessor;
import net.minecraft.network.chat.ComponentContents;
import net.minecraft.network.chat.MutableComponent;
import net.minecraft.network.chat.contents.PlainTextContents;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1_2/client/network/chat/VersionedTextComponent.class */
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, ComponentContents> implements TextComponent {
    ...
    @Override // net.labymod.v26_1_2.client.network.chat.VersionedBaseComponent
