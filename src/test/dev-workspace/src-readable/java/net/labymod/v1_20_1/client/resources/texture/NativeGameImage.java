...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/resources/texture/NativeGameImage.class */
public final class NativeGameImage extends Record implements GameImage {
    private final ehk image;

    public NativeGameImage(ehk image) {
        this.image = image;
    }

    @Override // java.lang.Record
    public final String toString() {
        return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, NativeGameImage.class), NativeGameImage.class, "image", "FIELD:Lnet/labymod/v1_20_1/client/resources/texture/NativeGameImage;->image:Lehk;").dynamicInvoker().invoke(this) /* invoke-custom */;
    }

    @Override // java.lang.Record
    public final int hashCode() {
        return (int) ObjectMethods.bootstrap(MethodHandles.lookup(), "hashCode", MethodType.methodType(Integer.TYPE, NativeGameImage.class), NativeGameImage.class, "image", "FIELD:Lnet/labymod/v1_20_1/client/resources/texture/NativeGameImage;->image:Lehk;").dynamicInvoker().invoke(this) /* invoke-custom */;
    }

    @Override // java.lang.Record
    public final boolean equals(Object o) {
        return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, NativeGameImage.class, Object.class), NativeGameImage.class, "image", "FIELD:Lnet/labymod/v1_20_1/client/resources/texture/NativeGameImage;->image:Lehk;").dynamicInvoker().invoke(this, o) /* invoke-custom */;
    }
    ...
    public GameImage getSubImage(int x, int y, int width, int height) {
        ehk destination = new ehk(width, height, true);
