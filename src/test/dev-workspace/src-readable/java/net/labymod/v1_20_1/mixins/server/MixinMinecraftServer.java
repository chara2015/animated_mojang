...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/server/MixinMinecraftServer.class */
...
public class MixinMinecraftServer implements MinecraftServerAccessor {
    ...
    @Override // net.labymod.v1_20_1.server.MinecraftServerAccessor
