...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/chat/contents/MixinKeybindContents.class */
@Mixin({tz.class})
public abstract class MixinKeybindContents implements KeybindContentsAccessor {
    ...
    @Shadow
    protected abstract sw b();

    @Override // net.labymod.v1_20_1.client.network.chat.contents.KeybindContentsAccessor
