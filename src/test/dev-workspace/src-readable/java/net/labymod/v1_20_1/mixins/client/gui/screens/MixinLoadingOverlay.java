...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({eud.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(euq screen, eox graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
