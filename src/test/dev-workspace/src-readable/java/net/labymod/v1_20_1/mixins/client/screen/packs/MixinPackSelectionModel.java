package net.labymod.v1_20_1.mixins.client.screen.packs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({exu.class})
public class MixinPackSelectionModel {
    ...
    private List<akg> getAvailablePacks() {
        List<akg> list = new ArrayList<>();
        for (akg pack : this.a.c()) {
