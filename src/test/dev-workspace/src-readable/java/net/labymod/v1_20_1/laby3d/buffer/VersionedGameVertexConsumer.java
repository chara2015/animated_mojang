package net.labymod.v1_20_1.laby3d.buffer;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/laby3d/buffer/VersionedGameVertexConsumer.class */
public class VersionedGameVertexConsumer implements GameVertexConsumer {
    private static final int MASK = 255;
    private static final int SHIFT = 16;
    private final ein delegate;
    private boolean vertexOpen;

    public VersionedGameVertexConsumer(ein delegate) {
