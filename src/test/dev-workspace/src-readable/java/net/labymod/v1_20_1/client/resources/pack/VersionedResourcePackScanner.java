...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/resources/pack/VersionedResourcePackScanner.class */
@Singleton
...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner {
    ...
    private void scanPack(ajl pack, String baseDirectory, a output) {
        pack.a(ajm.a, Namespaces.MINECRAFT, baseDirectory, output);
    }

    private Collection<String> collectIgnoredFiles(ajl pack) {
        Set<String> ignoredFiles = new HashSet<>();
        for (String namespace : pack.a(ajm.a)) {
            akp<InputStream> resource = pack.a(ajm.a, new acq(namespace, "labymod/ignored_files.json"));
            if (resource != null) {
                try {
