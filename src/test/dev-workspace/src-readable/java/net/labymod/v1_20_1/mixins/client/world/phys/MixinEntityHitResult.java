...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({eef.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(bfj entity, eei position, InsertInfo info) {
