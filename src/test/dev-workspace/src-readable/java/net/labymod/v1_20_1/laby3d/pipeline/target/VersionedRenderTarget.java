package net.labymod.v1_20_1.laby3d.pipeline.target;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    private final egv wrapped;

    public VersionedRenderTarget(egv wrapped) {
        this.wrapped = wrapped;
    }

    public void clear(boolean unbindTarget) {
        this.wrapped.b(enn.a);
        if (!unbindTarget) {
            this.wrapped.a(true);
        }
    }
    ...
    public void resize(int newWidth, int newHeight) {
        this.wrapped.a(newWidth, newHeight, enn.a);
    }
