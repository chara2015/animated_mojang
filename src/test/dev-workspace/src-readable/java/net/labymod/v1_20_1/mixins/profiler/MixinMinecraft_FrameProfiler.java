package net.labymod.v1_20_1.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({enn.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(fjq instance, float v, long l, boolean b, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(enn instance, Operation<Void> original) {
