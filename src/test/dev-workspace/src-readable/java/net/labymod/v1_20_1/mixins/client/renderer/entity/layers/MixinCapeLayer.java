package net.labymod.v1_20_1.mixins.client.renderer.entity.layers;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/renderer/entity/layers/MixinCapeLayer.class */
@Mixin({fsg.class})
public class MixinCapeLayer {
    private final CapeParticleController labyMod$capeParticleController = LabyMod.references().capeParticleController();
    private fkf labyMod$renderType;
    ...
    private void labyMod$firePreCapeRenderEvent(eij poseStack, fjx param1, int param2, fiv clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(eij poseStack, fjx param1, int param2, fiv clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
        labyMod$fireCapeRenderEvent(poseStack, clientPlayer, Phase.POST);
    }

    @WrapOperation(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = {@At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;")})
    private fkf labyMod$attach(acq location, Operation<fkf> original) {
        fkf fkfVar = (fkf) original.call(new Object[]{location});
        this.labyMod$renderType = fkfVar;
        return fkfVar;
    }

    @Insert(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(eij param0, fjx param1, int param2, fiv player, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(eij poseStack, fiv clientPlayer, Phase phase) {
        Player player = (Player) clientPlayer;
        PlayerModel playerModel = ((ftg) this).c();
