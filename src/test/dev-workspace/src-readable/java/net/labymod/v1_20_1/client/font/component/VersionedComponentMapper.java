package net.labymod.v1_20_1.client.font.component;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/font/component/VersionedComponentMapper.class */
...
public class VersionedComponentMapper implements ComponentMapper {
    ...
    public String getTranslationKeyOfComponent(Object minecraftComponent) {
        if (minecraftComponent instanceof sw) {
            sw component = (sw) minecraftComponent;
            ug ugVarB = component.b();
            if (ugVarB instanceof ug) {
                return ugVarB.a();
            }
            return null;
        }
