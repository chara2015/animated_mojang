...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends euq implements FileDropHandler, LabyScreenAccessor {
    ...
    public void a(@NotNull eox graphics, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
        a(graphics);
    ...
    public void a(@NotNull enn mc, int width, int height) {
        this.screen.pushCustomFontStack();
