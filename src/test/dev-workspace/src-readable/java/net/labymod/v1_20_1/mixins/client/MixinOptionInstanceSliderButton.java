...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/MixinOptionInstanceSliderButton.class */
@Mixin({i.class})
public class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton {
    ...
    @Override // net.labymod.v1_20_1.mixins.client.gui.components.MixinAbstractSliderButton, net.labymod.core.client.accessor.gui.SliderButtonAccessor
    ...
    private g labyMod$createWrappedIntRangeBase() {
        ...
        if (g.class.isAssignableFrom(cls)) {
            return new WrappedIntRangeBase(this.i);
        }
        return null;
    }
}
