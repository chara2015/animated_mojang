...
import net.labymod.v1_20_1.client.gfx.pipeline.renderer.text.BakedGlyphExtension;
import net.labymod.v1_20_1.client.gfx.pipeline.renderer.text.GlyphInstance;
import net.labymod.v1_20_1.client.gfx.pipeline.renderer.text.GlyphUtil;
import org.joml.Matrix4f;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/gui/font/MixinBakedGlyph_Extension.class */
@Mixin({err.class})
public abstract class MixinBakedGlyph_Extension implements BakedGlyphExtension {
    ...
    @Shadow
    public abstract void a(boolean z, float f, float f2, Matrix4f matrix4f, ein einVar, float f3, float f4, float f5, float f6, int i);

    @Override // net.labymod.v1_20_1.client.gfx.pipeline.renderer.text.BakedGlyphExtension
    ...
    @Override // net.labymod.v1_20_1.client.gfx.pipeline.renderer.text.BakedGlyphExtension
    public void labyMod$renderGlyph(GlyphInstance instance, Matrix4f pose, ein consumer, int lightCoords, boolean ignoreDepthOffset) {
