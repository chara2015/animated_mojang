package net.labymod.v1_20_1.client.overlay;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/overlay/CustomLoadingOverlay.class */
public class CustomLoadingOverlay extends eud {
    private final enn minecraft;
    private final akt reload;
    private final Consumer<Optional<Throwable>> onFinish;
    private final AbstractBootLogoRenderer loadingRenderer;
    private final DynamicBackgroundController caveRenderer;

    public CustomLoadingOverlay(enn minecraft, akt reload, Consumer<Optional<Throwable>> onFinish, boolean fadeIn) {
    ...
    public void a(eox gui, int mouseX, int mouseY, float partialTicks) {
        ehn window = this.minecraft.aM();
        int width = window.o();
        int height = window.p();
