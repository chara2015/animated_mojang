package net.labymod.v1_20_1.mixins.client.resources.pack;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/resources/pack/MixinPack.class */
@Mixin({akg.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    @Shadow
    public abstract ajl e();

    @Shadow
    public abstract boolean h();

    @Shadow
    public abstract akj j();
    ...
    /* JADX INFO: renamed from: net.labymod.v1_20_1.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[akh.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[akh.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[akh.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[akh.c.ordinal()] = 3;
    ...
    public File labyMod$getFile() {
        ajl resources = e();
        try {
            ajk ajkVarUnwrap = PackUtil.unwrap(resources);
            if (ajkVarUnwrap instanceof ajk) {
                ajk filePackResources = ajkVarUnwrap;
            ...
            if (ajkVarUnwrap instanceof akf) {
                akf source = (akf) ajkVarUnwrap;
            ...
            if (!(ajkVarUnwrap instanceof ajn)) {
                if (resources != null) {
                    resources.close();
                }
                return null;
            }
            ajn pathResources = (ajn) ajkVarUnwrap;
    ...
    private Icon labymod4$loadPackIcon() {
        ...
        LabyExecutors.executeBackgroundTask(() -> {
            try {
                ajl resources = e();
                try {
                    akp<InputStream> rootResource = resources.a(new String[]{"pack.png"});
