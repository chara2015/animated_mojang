...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends fod implements FileDropHandler, LabyScreenAccessor {
    ...
    public void a(@NotNull fhz graphics, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(fhz graphics, int mouseX, int mouseY, float tickDelta) {
        Stack stack = graphics.c().stack();
    ...
    public void a(@NotNull fgo mc, int width, int height) {
        this.screen.pushCustomFontStack();
