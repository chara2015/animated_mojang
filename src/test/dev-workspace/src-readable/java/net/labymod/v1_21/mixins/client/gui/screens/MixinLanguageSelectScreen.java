...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/gui/screens/MixinLanguageSelectScreen.class */
@Mixin({frd.class})
public class MixinLanguageSelectScreen {
    ...
    private boolean labyMod$fasterLanguageReload(fgo instance) {
