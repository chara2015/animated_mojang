...
import net.labymod.v1_21.client.gfx.pipeline.renderer.text.BakedGlyphExtension;
import net.labymod.v1_21.client.gfx.pipeline.renderer.text.GlyphInstance;
import net.labymod.v1_21.client.gfx.pipeline.renderer.text.GlyphUtil;
import org.joml.Matrix4f;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/gui/font/MixinBakedGlyph_Extension.class */
@Mixin({flh.class})
public abstract class MixinBakedGlyph_Extension implements BakedGlyphExtension {
    ...
    @Override // net.labymod.v1_21.client.gfx.pipeline.renderer.text.BakedGlyphExtension
