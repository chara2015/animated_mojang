...
import net.labymod.v1_21.client.network.chat.contents.LiteralContentsAccessor;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/network/chat/VersionedTextComponent.class */
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, xa> implements TextComponent {
    ...
    @Override // net.labymod.v1_21.client.network.chat.VersionedBaseComponent
