package net.labymod.v1_21.mixins.client.gui.components.tabs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({fkq.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fkg implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    ...
    @Override // net.labymod.v1_21.client.gui.TabNavigationBarAccessor
