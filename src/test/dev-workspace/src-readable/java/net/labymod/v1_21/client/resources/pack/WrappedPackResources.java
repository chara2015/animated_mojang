...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/resources/pack/WrappedPackResources.class */
public final class WrappedPackResources extends Record implements asq {
    ...
    public final String toString() {
        return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, WrappedPackResources.class), WrappedPackResources.class, "delegate", "FIELD:Lnet/labymod/v1_21/client/resources/pack/WrappedPackResources;->delegate:Lasq;").dynamicInvoker().invoke(this) /* invoke-custom */;
    }

    @Override // java.lang.Record
    public final int hashCode() {
        return (int) ObjectMethods.bootstrap(MethodHandles.lookup(), "hashCode", MethodType.methodType(Integer.TYPE, WrappedPackResources.class), WrappedPackResources.class, "delegate", "FIELD:Lnet/labymod/v1_21/client/resources/pack/WrappedPackResources;->delegate:Lasq;").dynamicInvoker().invoke(this) /* invoke-custom */;
    }

    @Override // java.lang.Record
    public final boolean equals(Object o) {
        return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, WrappedPackResources.class, Object.class), WrappedPackResources.class, "delegate", "FIELD:Lnet/labymod/v1_21/client/resources/pack/WrappedPackResources;->delegate:Lasq;").dynamicInvoker().invoke(this, o) /* invoke-custom */;
    }
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/resources/pack/WrappedPackResources$WrappedResourceOutput.class */
    public static final class WrappedResourceOutput extends Record implements a {
        ...
        @Override // java.lang.Record
        public final boolean equals(Object o) {
            return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, WrappedResourceOutput.class, Object.class), WrappedResourceOutput.class, "delegate", "FIELD:Lnet/labymod/v1_21/client/resources/pack/WrappedPackResources$WrappedResourceOutput;->delegate:Lasq$a;").dynamicInvoker().invoke(this, o) /* invoke-custom */;
        }
