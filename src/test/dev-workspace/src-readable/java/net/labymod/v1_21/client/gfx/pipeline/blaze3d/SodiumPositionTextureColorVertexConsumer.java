package net.labymod.v1_21.client.gfx.pipeline.blaze3d;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/gfx/pipeline/blaze3d/SodiumPositionTextureColorVertexConsumer.class */
public class SodiumPositionTextureColorVertexConsumer extends Blaze3DVertexProvider implements fbm, VertexBufferWriter {
    ...
    public void push(MemoryStack memoryStack, long ptr, int count, fbn description) {
