package net.labymod.v1_21.laby3d.buffer;
...
import net.labymod.v1_21.client.gfx.pipeline.blaze3d.program.LabyRenderType;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/laby3d/buffer/VersionedGameBufferProvider.class */
@Singleton
