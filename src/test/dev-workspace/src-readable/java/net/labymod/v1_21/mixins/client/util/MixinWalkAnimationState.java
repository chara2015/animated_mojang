...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/util/MixinWalkAnimationState.class */
@Mixin({bup.class})
public class MixinWalkAnimationState implements WalkAnimationStateAccessor {
    ...
    @Override // net.labymod.v1_21.client.util.WalkAnimationStateAccessor
