...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/chat/VersionedChatModifier.class */
@Singleton
...
public class VersionedChatModifier implements InternalChatModifier {
    ...
    public void fireChatClear(boolean clearHistory) {
        fgo.Q().l.d().a(clearHistory);
    }

    @Override // net.labymod.core.client.chat.InternalChatModifier
    public void deleteMessage(ChatMessage message) {
        VersionedChatComponent accessor = fgo.Q().l.d();
    ...
    public void editMessage(ChatMessage message, Component component) {
        ...
        fgi prevMessage = accessor.getMessages().get(index);
        VersionedChatMessageComponent versionedChatMessageComponent = new VersionedChatMessageComponent(message, (wz) this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new fgi(prevMessage.b(), versionedChatMessageComponent, prevMessage.d(), prevMessage.e()));
    ...
    private Predicate<fgi> messageFilter(ChatMessage message) {
        return m -> {
