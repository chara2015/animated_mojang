...
import net.labymod.v1_21.client.renderer.GameRendererAccessor;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/renderer/MixinGameRendererAccessor.class */
@Mixin({ges.class})
public class MixinGameRendererAccessor implements GameRendererAccessor {
    ...
    @Override // net.labymod.v1_21.client.renderer.GameRendererAccessor
