...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({fql.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fqb implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    ...
    private final Map<fqj, TabNavigationBarAccessor.VersionedTab> versionedTabs = new HashMap();
    ...
    @Override // net.labymod.v1_21_3.client.gui.TabNavigationBarAccessor
    ...
    @Override // net.labymod.v1_21_3.client.gui.TabNavigationBarAccessor
    public TabNavigationBarAccessor.VersionedTab versionedTabOf(fqj tab) {
    ...
    public void render(fns graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        fqj tab = this.h.a();
