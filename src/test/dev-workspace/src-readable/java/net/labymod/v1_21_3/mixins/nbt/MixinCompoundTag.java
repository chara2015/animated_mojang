...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/nbt/MixinCompoundTag.class */
@Mixin({ux.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, vu> x;

    @Shadow
    public abstract vu a(String str, vu vuVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract vu shadow$c(String str);
    ...
    @Shadow
    public abstract ux shadow$p(String str);

    @Shadow
    public abstract vd c(String str, int i);
