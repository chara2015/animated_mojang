...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/player/MixinInput.class */
@Mixin({gkf.class})
public class MixinInput {
    ...
    private void labyMod$oldSlowdown(InsertInfoReturnable<Boolean> returnable) {
        ...
        if (animation != null && animation.isEnabled()) {
            returnable.setReturnValue(Boolean.valueOf(animation.isEnabled(this.c)));
        }
    }
}
