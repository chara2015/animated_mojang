...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/resources/texture/VersionedTextureResourceWrapper.class */
public class VersionedTextureResourceWrapper extends TextureResourceWrapper<haw> {
    public VersionedTextureResourceWrapper(haw minecraftTexture) {
        super(minecraftTexture);
    }

    @Override // net.labymod.api.client.resources.texture.TextureResourceWrapper
    public GameImage getImage() {
        hay hayVar = (haw) getDelegate();
        GameImage image = null;
        if (hayVar instanceof hay) {
            hay dynamicTexture = hayVar;
            ffs pixels = dynamicTexture.f();
