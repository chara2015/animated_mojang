...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/util/MixinWalkAnimationState.class */
@Mixin({bxh.class})
public class MixinWalkAnimationState implements WalkAnimationStateAccessor {
    ...
    @Override // net.labymod.v1_21_3.client.util.WalkAnimationStateAccessor
