package net.labymod.v1_21_3.client.font.component;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/font/component/VersionedComponentMapper.class */
...
public class VersionedComponentMapper implements ComponentMapper {
    ...
    public String getTranslationKeyOfComponent(Object minecraftComponent) {
        if (minecraftComponent instanceof xv) {
            xv component = (xv) minecraftComponent;
