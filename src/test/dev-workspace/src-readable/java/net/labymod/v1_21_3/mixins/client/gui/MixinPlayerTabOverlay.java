...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/gui/MixinPlayerTabOverlay.class */
@Mixin({fph.class})
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(fns graphics, int screenWidth, fdd scoreboard, fcv objective, InsertInfo ci) {
