...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends fty implements FileDropHandler, LabyScreenAccessor {
    private final VanillaLabyScreen screen;

    public LabyScreenRenderer(LabyScreen screen) {
        super((xv) Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull fns graphics, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(fns graphics, int mouseX, int mouseY, float tickDelta) {
        Stack stack = graphics.c().stack();
    ...
    public void a(@NotNull fmg mc, int width, int height) {
        this.screen.pushCustomFontStack();
