package net.labymod.v1_21_3.client.player;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/player/VersionedNetworkPlayerInfo.class */
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    private final gfw wrapped;
    private final Component usernameComponent = Component.text(profile().getUsername());
    private Metadata metadata = Metadata.create();

    public VersionedNetworkPlayerInfo(gfw wrapped) {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_3.client.player.VersionedNetworkPlayerInfo$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[dhf.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dhf.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dhf.b.ordinal()] = 2;
    ...
    public gfw getWrapped() {
        return this.wrapped;
    }

    private xv decorateComponent(@NotNull gfw info, yj mutableComponent) {
        if (info.e() == dhf.d) {
