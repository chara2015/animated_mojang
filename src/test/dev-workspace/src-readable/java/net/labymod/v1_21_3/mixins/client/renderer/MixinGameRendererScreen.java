...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({glb.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(fty instance, fns graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
