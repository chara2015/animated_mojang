...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/screen/MixinBookScreenVanillaFont.class */
@Mixin({fuv.class, fuu.class})
public class MixinBookScreenVanillaFont {
    @Insert(method = {"render"}, at = @At("HEAD"))
    public void labyMod$enableVanillaFont(fns graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
    ...
    public void labyMod$resetFont(fns graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        RenderAttributesStack renderAttributesStack = renderAttributesStack();
