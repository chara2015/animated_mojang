...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/network/chat/VersionedTextComponent.class */
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, xw> implements TextComponent {
    private static final String EMPTY = "";
    private boolean empty;

    public VersionedTextComponent(yj holder, boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    @Override // net.labymod.v1_21_3.client.network.chat.VersionedBaseComponent
