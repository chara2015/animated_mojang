...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/network/chat/VersionedTranslatableComponent.class */
public class VersionedTranslatableComponent extends VersionedBaseComponent<TranslatableComponent, TranslatableContentsAccessor> implements TranslatableComponent {
    public VersionedTranslatableComponent(yj holder) {
        super(holder);
    }
    ...
    public TranslatableComponent plainCopy() {
        return (TranslatableComponent) xv.b(getKey()).getLabyComponent();
    }
