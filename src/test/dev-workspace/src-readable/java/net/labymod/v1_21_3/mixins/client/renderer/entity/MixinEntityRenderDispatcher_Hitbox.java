...
import net.labymod.v1_21_3.client.gfx.pipeline.blaze3d.program.LabyRenderType;
import org.joml.Vector3f;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/renderer/entity/MixinEntityRenderDispatcher_Hitbox.class */
@Mixin({gro.class})
public class MixinEntityRenderDispatcher_Hitbox {
    ...
    private glv labyMod$getRenderType(Operation<glv> original) {
        ...
        return (glv) original.call(new Object[0]);
    }
    ...
    private static void labyMod$renderHitbox(fgs $$0, fgw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7, float red, float green, float blue, float alpha, Operation<Void> original) {
    ...
    private static void labyMod$renderHitbox(fgs $$0, fgw $$1, fbt $$2, float red, float green, float blue, float alpha, Operation<Void> original) {
        LabyConfig config = Laby.labyAPI().config();
        HitboxConfig hitbox = config.ingame().hitbox();
    ...
    private static void labyMod$renderHitboxViewVector(fgs $$0, fgw $$1, Vector3f $$2, fby $$3, int $$4, Operation<Void> original) {
        LabyConfig config = Laby.labyAPI().config();
