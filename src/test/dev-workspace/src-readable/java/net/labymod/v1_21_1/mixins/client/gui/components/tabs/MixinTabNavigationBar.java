package net.labymod.v1_21_1.mixins.client.gui.components.tabs;
...
import net.labymod.v1_21_1.client.gui.TabNavigationBarAccessor;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({fkq.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fkg implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    private final WidgetWatcher<T> watcher = new WidgetWatcher<>();
    private final Map<fko, TabNavigationBarAccessor.VersionedTab> versionedTabs = new HashMap();

    @Shadow
    @Final
    private ImmutableList<fko> i;

    @Shadow
    @Final
    private fkp h;
    private fko labyMod$currentTab;

    @Override // net.labymod.v1_21_1.client.gui.TabNavigationBarAccessor
    public ImmutableList<fko> getTabs() {
        return this.i;
    }

    @Override // net.labymod.v1_21_1.client.gui.TabNavigationBarAccessor
    public fkp getTabManager() {
        return this.h;
    }
    ...
    @Override // net.labymod.v1_21_1.client.gui.TabNavigationBarAccessor
    public TabNavigationBarAccessor.VersionedTab versionedTabOf(fko tab) {
