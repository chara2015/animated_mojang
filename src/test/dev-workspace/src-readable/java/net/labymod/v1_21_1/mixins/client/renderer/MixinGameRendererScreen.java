...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({ges.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(fod instance, fhz graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
