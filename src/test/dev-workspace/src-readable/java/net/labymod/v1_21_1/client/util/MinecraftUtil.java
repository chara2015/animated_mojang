...
import net.labymod.v1_21_1.client.multiplayer.server.VersionedCookieStorage;
import net.labymod.v1_21_1.client.resources.texture.VersionedLabyTexture;
import org.jetbrains.annotations.NotNull;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/util/MinecraftUtil.class */
public final class MinecraftUtil {
    ...
    private static final fbi VIEW_MATRIX_STACK = new fbi();
    ...
    public static Stack obtainStackFromGraphics(fhz graphics) {
        return graphics.c().stack();
    }

    public static void obtainScreenContextFromGraphics(fhz graphics, Consumer<ScreenContext> callback) {
    ...
    public static void obtainScreenContextFromGraphics(fhz graphics, int mouseX, int mouseY, float tickDelta, Consumer<ScreenContext> callback) {
    ...
    public static ItemStack fromMinecraftSlot(btn entity, LivingEntity.EquipmentSpot spot) {
        return fromMinecraft(entity.a(toMinecraft(spot)));
    }

    public static ItemStack fromMinecraft(cuq itemStack) {
        return (ItemStack) itemStack;
    }

    public static cuq toMinecraft(ItemStack itemStack) {
        return (cuq) itemStack;
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static Direction fromMinecraft(ji direction) throws MatchException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static ji toMinecraft(@NotNull Direction direction) throws MatchException {
        switch (direction) {
            case DOWN:
                return ji.a;
            case UP:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static bsy toMinecraft(LivingEntity.EquipmentSpot spot) throws MatchException {
        switch (spot) {
            case HEAD:
                return bsy.f;
            case CHEST:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static ModelTransformType fromMinecraft(cun context) throws MatchException {
    ...
    public static ServerType fromMinecraft(fzt data) {
        if (data.e()) {
    ...
    public static void exportScreenshotToFile(faj image, File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(Player player) {
        gkh dispatcher = fgo.Q().ap();
        gpo gpoVarA = dispatcher.a((bsr) player);
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_1.client.util.MinecraftUtil$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/util/MinecraftUtil$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$item$ItemDisplayContext = new int[cun.values().length];
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.a.ordinal()] = 1;
            } catch (NoSuchFieldError e13) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.b.ordinal()] = 2;
            } catch (NoSuchFieldError e14) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.c.ordinal()] = 3;
            } catch (NoSuchFieldError e15) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.d.ordinal()] = 4;
            } catch (NoSuchFieldError e16) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.e.ordinal()] = 5;
            } catch (NoSuchFieldError e17) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.f.ordinal()] = 6;
            } catch (NoSuchFieldError e18) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.g.ordinal()] = 7;
            } catch (NoSuchFieldError e19) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.h.ordinal()] = 8;
            } catch (NoSuchFieldError e20) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cun.i.ordinal()] = 9;
            ...
            $SwitchMap$net$minecraft$core$Direction = new int[ji.values().length];
            try {
                $SwitchMap$net$minecraft$core$Direction[ji.a.ordinal()] = 1;
            ...
            try {
                $SwitchMap$net$minecraft$core$Direction[ji.c.ordinal()] = 3;
            } catch (NoSuchFieldError e34) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[ji.d.ordinal()] = 4;
            } catch (NoSuchFieldError e35) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[ji.e.ordinal()] = 5;
            } catch (NoSuchFieldError e36) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[ji.f.ordinal()] = 6;
    ...
    public static CookieStorage fromMinecraft(fzy state) {
        if (state == null) {
            return null;
        }
    ...
    public static fzy toMinecraft(CookieStorage storage) {
        Map<ResourceLocation, byte[]> apiCookies = storage.cookies();
        Map<akr, byte[]> cookies = new HashMap<>(apiCookies.size());
        for (Map.Entry<ResourceLocation, byte[]> entry : apiCookies.entrySet()) {
            cookies.put((akr) entry.getKey().getMinecraftLocation(), entry.getValue());
        }
        return new fzy(cookies);
    }

    public static aya fromText(String text, Style style) {
        tw language = tw.a();
        return language.a(xe.a(text, (xw) style));
    }
    ...
    public static gpw toMinecraft(Object texture) {
        return TEXTURES.apply(texture);
    }

    public static fhz getCurrentGuiGraphics() {
        return currentGuiGraphics;
    }

    public static void setCurrentGuiGraphics(fhz currentGuiGraphics2) {
        currentGuiGraphics = currentGuiGraphics2;
    }

    public static bsr unwrapEntity(bsr entity) {
        if (entity instanceof chy) {
            chy part = (chy) entity;
            return part.b;
        }
        return entity;
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/util/MinecraftUtil$LevelRenderContext.class */
    public static class LevelRenderContext {
        private fbi poseStack;

        public fbi getPoseStack() {
            return this.poseStack;
        }

        public void setPoseStack(fbi poseStack) {
