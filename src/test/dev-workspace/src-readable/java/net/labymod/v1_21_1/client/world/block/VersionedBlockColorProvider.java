package net.labymod.v1_21_1.client.world.block;
...
import net.labymod.v1_21_1.client.world.LabyBiomeBlender;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/world/block/VersionedBlockColorProvider.class */
@Singleton
...
public class VersionedBlockColorProvider implements BlockColorProvider {
    ...
    public int getColor(BlockState state) {
        akr blockId = lt.e.b(state.block());
    ...
    public int getColorMultiplier(BlockState state, int minX, int minZ, int maxX, int maxZ) {
        ...
        return blockColors.a((dtc) state, this.biomeBlender.setLevel(dcwVar).setArea(minX, minZ, maxX, maxZ), toBlockPos(state.position()), 0);
    }

    private jd toBlockPos(IntVector3 vec) {
        return new jd(vec.getX(), vec.getY(), vec.getZ());
    }
}
