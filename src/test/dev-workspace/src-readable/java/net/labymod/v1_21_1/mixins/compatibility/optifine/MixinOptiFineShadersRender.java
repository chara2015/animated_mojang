...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/compatibility/optifine/MixinOptiFineShadersRender.class */
@Pseudo
...
public class MixinOptiFineShadersRender {
    ...
    private static fbi labyMod$store(Operation<fbi> original) {
        fbi pose = (fbi) original.call(new Object[0]);
