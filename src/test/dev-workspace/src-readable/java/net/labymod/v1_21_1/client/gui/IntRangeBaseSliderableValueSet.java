package net.labymod.v1_21_1.client.gui;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet.class */
public final class IntRangeBaseSliderableValueSet<R> extends Record implements k<R> {
    ...
    public final String toString() {
        return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, IntRangeBaseSliderableValueSet.class), IntRangeBaseSliderableValueSet.class, "base;intFunction;mapperFunction", "FIELD:Lnet/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet;->base:Lfgr$g;", "FIELD:Lnet/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet;->intFunction:Ljava/util/function/IntFunction;", "FIELD:Lnet/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet;->mapperFunction:Ljava/util/function/ToIntFunction;").dynamicInvoker().invoke(this) /* invoke-custom */;
    }
    ...
    public final boolean equals(Object o) {
        return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, IntRangeBaseSliderableValueSet.class, Object.class), IntRangeBaseSliderableValueSet.class, "base;intFunction;mapperFunction", "FIELD:Lnet/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet;->base:Lfgr$g;", "FIELD:Lnet/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet;->intFunction:Ljava/util/function/IntFunction;", "FIELD:Lnet/labymod/v1_21_1/client/gui/IntRangeBaseSliderableValueSet;->mapperFunction:Ljava/util/function/ToIntFunction;").dynamicInvoker().invoke(this, o) /* invoke-custom */;
    }
