...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({fnt.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(fod screen, fhz graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
