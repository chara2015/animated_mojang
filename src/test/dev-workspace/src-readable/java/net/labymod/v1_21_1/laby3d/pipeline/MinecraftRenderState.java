...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/laby3d/pipeline/MinecraftRenderState.class */
public final class MinecraftRenderState {
    private final RenderState renderState;
    private final fbn vertexFormat;
    private final c drawMode;
    private final ResourceLocation configId;
    private final boolean affectsCrumbling;
    private final boolean sortOnUpload;
    private final Lazy<gfn> shaderInstance;

    public MinecraftRenderState(RenderState renderState, fbn vertexFormat, c drawMode, ResourceLocation configId) {
        this(renderState, vertexFormat, drawMode, configId, false);
    }

    public MinecraftRenderState(RenderState renderState, fbn vertexFormat, c drawMode, ResourceLocation configId, boolean affectsCrumbling) {
    ...
    public b create(LevelMaterial material, boolean outline) {
        ...
        Lazy<gfn> lazy = this.shaderInstance;
        Objects.requireNonNull(lazy);
        a aVarA3 = aVarA2.a(new m(lazy::get)).a(new n((akr) ((TextureBinding) material.getTextures().get(0)).location().getMinecraftLocation(), false, false));
    ...
    private gfn createShaderProgram() {
        try {
            return new LabyShaderInstance(fgo.Q().ab(), this.configId, getVertexFormat());
        } catch (IOException exception) {
            throw new RuntimeException(exception);
        }
    }

    /* JADX INFO: renamed from: net.labymod.v1_21_1.laby3d.pipeline.MinecraftRenderState$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/laby3d/pipeline/MinecraftRenderState$1.class */
