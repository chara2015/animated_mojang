package net.labymod.v1_21_1.client.session;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<fhb> {
    ...
    public fhb toGameSession(Session session) {
        return (fhb) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(fhb gameSession) {
        if (gameSession == null) {
            return null;
        }
