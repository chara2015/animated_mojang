...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        ...
        dispatcher.a(ciaVar, 0.0d, 0.0d, 0.0d, 0.0f, context.getTickDelta(), (fbi) context.stack().getProvider().getPoseStack(), fgo.Q().aO().c(), RenderEnvironmentContext.FULL_BRIGHT);
        faf.d();
