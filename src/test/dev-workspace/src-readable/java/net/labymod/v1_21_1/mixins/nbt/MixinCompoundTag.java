...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/nbt/MixinCompoundTag.class */
@Mixin({ub.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, uy> x;

    @Shadow
    public abstract uy a(String str, uy uyVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract uy shadow$c(String str);
    ...
    @Shadow
    public abstract ub shadow$p(String str);

    @Shadow
    public abstract uh c(String str, int i);
