...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/MixinOptionInstanceSliderButton.class */
@Mixin({i.class})
public abstract class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton {
    ...
    @Override // net.labymod.v1_21_1.mixins.client.gui.components.MixinAbstractSliderButton, net.labymod.core.client.accessor.gui.SliderButtonAccessor
