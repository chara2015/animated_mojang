package net.labymod.v1_21_1.client.network.chat.serializer;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/network/chat/serializer/VersionedComponentSerializerWrapper.class */
public class VersionedComponentSerializerWrapper implements Serializer, JsonDeserializer<VersionedBaseComponent<?, ?>>, JsonSerializer<Component> {
    private final b serializerAdapter = new b(ka.b);

    /* JADX INFO: renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public VersionedBaseComponent<?, ?> m1718deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    ...
    public JsonElement serialize(Component src, Type typeOfSrc, JsonSerializationContext context) {
        xn holder = ((VersionedBaseComponent) src).getHolder();
