...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/gui/screens/MixinConnectScreenThread.class */
...
public class MixinConnectScreenThread {
    ...
    private Optional<gaw> labyMod$resolveAddress(gaz resolver, gax address) {
        InetSocketAddress resolved = ConnectAddressResolver.resolve(address.a(), address.b(), this.e);
        return resolved == null ? Optional.empty() : Optional.of(gaw.a(resolved));
    }
    ...
    public wz labyMod$fireServerKickEvent(wz reason) {
        ...
        return (wz) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN))).reason());
    }
}
