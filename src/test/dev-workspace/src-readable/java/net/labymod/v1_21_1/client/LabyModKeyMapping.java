package net.labymod.v1_21_1.client;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends fgm {
    private static final Function<Hotkey, fgm> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        fgm labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static fgm create(Hotkey hotkey) {
