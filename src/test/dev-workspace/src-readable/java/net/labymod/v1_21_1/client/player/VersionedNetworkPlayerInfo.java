package net.labymod.v1_21_1.client.player;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/player/VersionedNetworkPlayerInfo.class */
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    private final fzq wrapped;
    private final Component usernameComponent = Component.text(profile().getUsername());
    private Metadata metadata = Metadata.create();

    public VersionedNetworkPlayerInfo(fzq wrapped) {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_1.client.player.VersionedNetworkPlayerInfo$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[dct.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dct.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dct.b.ordinal()] = 2;
    ...
    public fzq getWrapped() {
        return this.wrapped;
    }

    private wz decorateComponent(@NotNull fzq info, xn mutableComponent) {
        if (info.e() == dct.d) {
