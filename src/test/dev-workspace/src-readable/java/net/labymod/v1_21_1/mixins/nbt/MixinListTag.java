...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/nbt/MixinListTag.class */
@Mixin({uh.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, uy uyVar);

    @Shadow
    public abstract boolean a(int i, uy uyVar);

    @Shadow
    public abstract void c(int i, uy uyVar);

    @Shadow
    public abstract uy shadow$c(int i);
