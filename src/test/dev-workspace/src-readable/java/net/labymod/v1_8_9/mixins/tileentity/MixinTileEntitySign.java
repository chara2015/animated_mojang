...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/tileentity/MixinTileEntitySign.class */
@Mixin({aln.class})
public abstract class MixinTileEntitySign implements SignBlockEntity {
    ...
    private void labyMod$fireTileEntityPostLoadEvent(dn tag, InsertInfo ci) {
    ...
    public float getRotationYaw() {
        ...
        akw entity = (akw) this;
        afh block = entity.w();
        alz state = entity.z().p(entity.v());
        if (block == afi.ax) {
            cq facing = state.b(akm.a);
        ...
        if (block == afi.an && (rotation = (Integer) state.b(ajv.a)) != null) {
            return 180.0f - ((rotation.intValue() * 360) / 16.0f);
        }
        return 0.0f;
    }

    /* JADX INFO: renamed from: net.labymod.v1_8_9.mixins.tileentity.MixinTileEntitySign$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/tileentity/MixinTileEntitySign$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$util$EnumFacing = new int[cq.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$util$EnumFacing[cq.c.ordinal()] = 1;
            ...
            try {
                $SwitchMap$net$minecraft$util$EnumFacing[cq.a.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$util$EnumFacing[cq.f.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$net$minecraft$util$EnumFacing[cq.d.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$net$minecraft$util$EnumFacing[cq.e.ordinal()] = 6;
