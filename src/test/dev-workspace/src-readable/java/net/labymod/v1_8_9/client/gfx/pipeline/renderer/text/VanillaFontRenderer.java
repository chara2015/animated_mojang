...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VanillaFontRenderer.class */
@Singleton
...
public class VanillaFontRenderer implements MinecraftFontRenderer {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VanillaFontRenderer$TextWidthProvider.class */
    @FunctionalInterface
    private interface TextWidthProvider<T> {
        int getWidth(avn avnVar, T t);
    }
    ...
    public void render(Matrix4f pose, Component text, float x, float y, int argb, int packedLightCoords, int backgroundArgb, int flags) {
        avn font = getFont();
        eu component = (eu) this.componentMapper.toMinecraftComponent(text);
    ...
    private <T> void drawTextWithBackground(GlRenderDevice renderDevice, avn font, T t, float x, float y, int backgroundArgb, int flags, TextWidthProvider<T> provider) {
        renderDevice.storeState();
        bfl.l();
        bfl.a(GlConst.GL_SRC_ALPHA, GlConst.GL_ONE_MINUS_SRC_ALPHA, 1, GlConst.GL_ONE_MINUS_SRC_ALPHA);
        bfl.o();
        bfl.j();
        bfl.c(GlConst.GL_LEQUAL);
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VanillaFontRenderer$StyledTextProcessor.class */
