...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/world/lighting/VersionedLightingLayerMapper.class */
@Singleton
...
public class VersionedLightingLayerMapper implements LightingLayerMapper {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_8_9.client.world.lighting.VersionedLightingLayerMapper$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/world/lighting/VersionedLightingLayerMapper$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$EnumSkyBlock = new int[ads.values().length];
            try {
                $SwitchMap$net$minecraft$world$EnumSkyBlock[ads.a.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$world$EnumSkyBlock[ads.b.ordinal()] = 2;
