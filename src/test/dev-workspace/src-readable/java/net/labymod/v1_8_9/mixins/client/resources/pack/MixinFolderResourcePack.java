...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/client/resources/pack/MixinFolderResourcePack.class */
@Mixin({bnd.class})
        ...
        try {
            ...
            try {
                files.forEach(resource -> {
                    ...
                    locationConsumer.accept(new jy(namespace, path2));
                });
                if (files != null) {
                    files.close();
                }
