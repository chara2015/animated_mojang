package net.labymod.v1_8_9.mixinplugin.optifine;

import java.util.ArrayList;
import java.util.List;
import net.labymod.api.mixin.dynamic.DynamicMixinApplier;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixinplugin/optifine/OptiFineDynamicMixinApplier.class */
