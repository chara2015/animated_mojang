...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/client/world/item/MixinItem.class */
@Mixin({zw.class})
public abstract class MixinItem implements Item {
    ...
    public ResourceLocation getIdentifier() {
        if (this.labyMod$identifier == null) {
            this.labyMod$identifier = (jy) e.c((zw) this);
        }
