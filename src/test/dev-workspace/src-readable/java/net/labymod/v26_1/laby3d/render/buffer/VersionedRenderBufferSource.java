package net.labymod.v26_1.laby3d.render.buffer;
...
import net.labymod.v26_1.laby3d.buffer.VersionedGameVertexConsumer;
import net.labymod.v26_1.laby3d.pipeline.RenderTypeResolver;
import net.minecraft.client.Minecraft;
import net.minecraft.client.renderer.MultiBufferSource;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/laby3d/render/buffer/VersionedRenderBufferSource.class */
@Singleton
