package net.labymod.v26_1.mixinplugin.optifine;

import java.util.ArrayList;
import java.util.List;
import net.labymod.api.mixin.dynamic.DynamicMixinApplier;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/mixinplugin/optifine/OptiFineDynamicMixinApplier.class */
public class OptiFineDynamicMixinApplier implements DynamicMixinApplier {
    ...
    private void addMixin(String path) {
        this.mixins.add("net.labymod.v26_1.mixins." + path);
    }
}
