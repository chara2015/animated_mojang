package net.labymod.v26_1.client.chat;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/client/chat/VersionedChatExecutor.class */
@Singleton
...
public class VersionedChatExecutor extends DefaultChatExecutor {
    ...
    private void _displayClientMessage(Component message, boolean actionBar) {
        ...
        if (actionBar) {
            ...
            chatGui.getChat().addClientSystemMessage(component);
        }
    }
}
