package net.labymod.v26_1.client.render.item;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/client/render/item/VersionedAnimationTypeMapper.class */
@Singleton
...
public class VersionedAnimationTypeMapper implements RenderFirstPersonItemInHandEvent.AnimationTypeMapper {
    ...
    /* JADX INFO: renamed from: net.labymod.v26_1.client.render.item.VersionedAnimationTypeMapper$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/client/render/item/VersionedAnimationTypeMapper$1.class */
