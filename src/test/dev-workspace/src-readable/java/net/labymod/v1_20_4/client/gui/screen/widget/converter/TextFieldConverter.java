...
import net.labymod.v1_20_4.client.gui.EditBoxAccessor;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gui/screen/widget/converter/TextFieldConverter.class */
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<exp, TextFieldWidget> {
    ...
    public TextFieldWidget createDefault(exp source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(exp source, TextFieldWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
