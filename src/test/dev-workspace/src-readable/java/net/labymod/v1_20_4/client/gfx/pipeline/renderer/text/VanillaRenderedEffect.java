...
import net.labymod.v1_20_4.client.gfx.pipeline.blaze3d.PositionTextureColorVertexConsumerProvider;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gfx/pipeline/renderer/text/VanillaRenderedEffect.class */
public class VanillaRenderedEffect implements GlyphRenderable {
    ...
    public void buildVertices(Matrix4f pose, VertexConsumer consumer, int lightCoords, boolean ignoreDepthOffset, GlyphProperties properties) {
        eqf vertexConsumer = PositionTextureColorVertexConsumerProvider.create();
