package net.labymod.v1_20_4.mixins.client.resources.pack;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/resources/pack/MixinPack.class */
@Mixin({apq.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    public Component labyMod$getDescription() {
        return COMPONENT_MAPPER.fromMinecraftComponent(this.e.a());
    }
    ...
    public ResourcePackDetails.DefaultPosition labyMod$getDefaultPosition() {
        return this.f == b.a ? ResourcePackDetails.DefaultPosition.TOP : ResourcePackDetails.DefaultPosition.BOTTOM;
    }

    /* JADX INFO: renamed from: net.labymod.v1_20_4.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[apr.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[apr.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[apr.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[apr.c.ordinal()] = 3;
    ...
    public ResourcePackDetails.Compatibility labyMod$getCompatibility() throws MatchException {
        switch (AnonymousClass1.$SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[this.e.b().ordinal()]) {
            case 1:
    ...
    private Icon labymod4$loadPackIcon() {
        ...
        LabyExecutors.executeBackgroundTask(() -> {
            try {
                aow resources = e();
                try {
                    aqa<InputStream> rootResource = resources.a(new String[]{"pack.png"});
