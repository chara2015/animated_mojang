package net.labymod.v1_20_4.mixins.client.screen.packs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({fgh.class})
public class MixinPackSelectionModel {
    ...
    private List<apq> getAvailablePacks() {
        List<apq> list = new ArrayList<>();
        for (apq pack : this.a.c()) {
