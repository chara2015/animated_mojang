...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/network/chat/VersionedTranslatableComponent.class */
public class VersionedTranslatableComponent extends VersionedBaseComponent<TranslatableComponent, TranslatableContentsAccessor> implements TranslatableComponent {
    public VersionedTranslatableComponent(vt holder) {
        super(holder);
    }
    ...
    public TranslatableComponent plainCopy() {
        return (TranslatableComponent) vf.b(getKey()).getLabyComponent();
    }
