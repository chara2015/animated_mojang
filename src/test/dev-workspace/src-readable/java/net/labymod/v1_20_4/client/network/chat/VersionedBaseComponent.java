...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/network/chat/VersionedBaseComponent.class */
public abstract class VersionedBaseComponent<T extends Component, C> implements BaseComponent<T> {
    public final vt holder;

    public VersionedBaseComponent(vt holder) {
        this.holder = holder;
    }
