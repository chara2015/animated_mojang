...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/gui/screens/MixinLanguageSelectScreen.class */
@Mixin({fck.class})
public class MixinLanguageSelectScreen {
    ...
    private boolean labyMod$fasterLanguageReload(evi instance) {
