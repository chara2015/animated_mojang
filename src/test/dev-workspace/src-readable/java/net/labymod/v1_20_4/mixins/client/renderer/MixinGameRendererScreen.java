...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({fta.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(fdb instance, ewu graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
