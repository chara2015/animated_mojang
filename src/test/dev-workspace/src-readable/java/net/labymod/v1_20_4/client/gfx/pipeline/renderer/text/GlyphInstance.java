...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance.class */
public final class GlyphInstance extends Record {
    ...
    public GlyphInstance(float x, float y, int argb, int shadowArgb, ezz glyph, Style style, float boldOffset, float shadowOffset) {
        this.x = x;
        this.y = y;
        this.argb = argb;
    ...
    public final String toString() {
        return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, GlyphInstance.class), GlyphInstance.class, "x;y;argb;shadowArgb;glyph;style;boldOffset;shadowOffset", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->x:F", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->y:F", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->argb:I", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->shadowArgb:I", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->glyph:Lezz;", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->style:Lnet/labymod/api/client/component/format/Style;", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->boldOffset:F", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->shadowOffset:F").dynamicInvoker().invoke(this) /* invoke-custom */;
    }
    ...
    public final boolean equals(Object o) {
        return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, GlyphInstance.class, Object.class), GlyphInstance.class, "x;y;argb;shadowArgb;glyph;style;boldOffset;shadowOffset", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->x:F", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->y:F", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->argb:I", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->shadowArgb:I", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->glyph:Lezz;", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->style:Lnet/labymod/api/client/component/format/Style;", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->boldOffset:F", "FIELD:Lnet/labymod/v1_20_4/client/gfx/pipeline/renderer/text/GlyphInstance;->shadowOffset:F").dynamicInvoker().invoke(this, o) /* invoke-custom */;
    }
    ...
    public GlyphInstance(float x, float y, int argb, int shadowArgb, ezz glyph, Style style, float boldOffset) {
        this(x, y, argb, shadowArgb, glyph, style, boldOffset, SHADOW_OFFSET);
    }

    void render(eqf consumer, Matrix4f pose) {
    ...
    private void renderGlyph(eqf consumer, Matrix4f pose, float offset, boolean italic, boolean bold, float red, float green, float blue, float alpha) {
