...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gfx/pipeline/renderer/text/BakedGlyphExtension.class */
public interface BakedGlyphExtension {
    ...
    void labyMod$renderGlyph(GlyphInstance glyphInstance, Matrix4f matrix4f, eqf eqfVar, int i, boolean z);
