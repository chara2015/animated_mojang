...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends fdb implements FileDropHandler, LabyScreenAccessor {
    private final VanillaLabyScreen screen;

    public LabyScreenRenderer(LabyScreen screen) {
        super((vf) Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull ewu graphics, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(ewu graphics, int mouseX, int mouseY, float tickDelta) {
        Stack stack = graphics.c().stack();
    ...
    public void a(@NotNull evi mc, int width, int height) {
        this.screen.pushCustomFontStack();
