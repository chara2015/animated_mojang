...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/renderer/renderer/atlas/MixinTextureAtlas.class */
@Mixin({gem.class})
public abstract class MixinTextureAtlas implements TextureAtlas {
    ...
    @Shadow
    public abstract gen a(ahg ahgVar);
    ...
    public TextureSprite findSprite(ResourceLocation location) {
        TextureSprite textureSpriteA = a((ahg) location.getMinecraftLocation());
