...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/gui/MixinPlayerTabOverlay.class */
@Mixin({eyh.class})
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(ewu graphics, int screenWidth, emx scoreboard, emp objective, InsertInfo ci) {
