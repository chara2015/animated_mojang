...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/renderer/entity/MixinItemRenderer.class */
@Mixin({fzl.class})
...
public abstract class MixinItemRenderer implements ItemStackRenderer {
    ...
    @Shadow
    public abstract void a(cmy cmyVar, cmv cmvVar, boolean z, eqb eqbVar, fth fthVar, int i, int i2, ggn ggnVar);
    ...
    public void renderItemStack(Stack stack, ItemStack itemStack, int x, int y, boolean decorate, float alpha) {
        if (this.labyMod$graphics == null) {
            this.labyMod$graphics = new ewu(evi.O(), evi.O().aO().c());
        }
        cmy minecraftItemStack = MinecraftUtil.toMinecraft(itemStack);
        this.labyMod$graphics.setPose((eqb) stack.getProvider().getPoseStack());
        ...
        if (decorate) {
            this.labyMod$graphics.a(evi.O().h, minecraftItemStack, x, y);
        }
    }
}
