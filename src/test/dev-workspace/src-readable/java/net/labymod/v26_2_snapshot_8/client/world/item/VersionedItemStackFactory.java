package net.labymod.v26_2_snapshot_8.client.world.item;
...
import net.labymod.v26_2_snapshot_8.client.world.item.VersionedDeferredItemStack;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/world/item/VersionedItemStackFactory.class */
@Singleton
...
public class VersionedItemStackFactory implements ItemStackFactory {
    ...
    public ItemStack create(final ResourceLocation location, final int count) {
        return new VersionedDeferredItemStack(new VersionedDeferredItemStack.ItemStackProvider(this) { // from class: net.labymod.v26_2_snapshot_8.client.world.item.VersionedItemStackFactory.1
            {
                Objects.requireNonNull(this);
            }

            @Override // net.labymod.v26_2_snapshot_8.client.world.item.VersionedDeferredItemStack.ItemStackProvider
            public Item getItem() {
    ...
    public ItemStack create(final BlockState state) {
        return new VersionedDeferredItemStack(new VersionedDeferredItemStack.ItemStackProvider(this) { // from class: net.labymod.v26_2_snapshot_8.client.world.item.VersionedItemStackFactory.2
