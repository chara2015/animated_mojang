...
import net.labymod.v26_2_snapshot_8.client.resources.texture.NativeGameImage;
import net.minecraft.client.Minecraft;
import net.minecraft.client.renderer.GameRenderer;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/laby3d/VersionedLaby3D.class */
@Singleton
...
public class VersionedLaby3D extends Laby3D {
    ...
    public RenderDevice createRenderDevice(@NotNull ShaderConfiguration shaderConfiguration) {
        ...
        if (gpuDevice.getDeviceInfo().backendName().equalsIgnoreCase("vulkan")) {
            throw new IllegalStateException("Vulkan backend is not supported");
        }
