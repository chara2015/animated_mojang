...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/MixinGraphicsPreset.class */
@Mixin({GraphicsPreset.class})
public class MixinGraphicsPreset {
    @WrapOperation(method = {"apply"}, at = {@At(value = "INVOKE", target = "Lnet/minecraft/client/gui/Gui;screen()Lnet/minecraft/client/gui/screens/Screen;")})
    private Screen labyMod$useMostInnerScreen(Gui instance, Operation<Screen> original) {
