...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/util/BlockOutlineUtil.class */
public class BlockOutlineUtil {
    public static void renderBlockOutline(VertexConsumer lineConsumer, PoseStack poseStack, double x, double y, double z, BlockOutlineRenderState renderState, int color, float lineWidth) {
        ...
        if (overlayColor != null) {
            VertexConsumer overlayConsumer = null;
