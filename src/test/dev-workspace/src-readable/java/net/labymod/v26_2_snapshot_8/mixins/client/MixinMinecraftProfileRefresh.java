...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/MixinMinecraftProfileRefresh.class */
...
public class MixinMinecraftProfileRefresh implements SessionRefresher {
    ...
    public void refresh() {
        ...
        FriendsService friendsService = this.labyMod$authenticationService.createFriendsService(this.user.getAccessToken());
        this.remoteFriendListUpdateHandler = new RemoteFriendListUpdateHandler(friendsService, (Minecraft) CastUtil.cast(this));
        this.playerSocialManager = new PlayerSocialManager((Minecraft) CastUtil.cast(this), this.userApiService, friendsService, this.remoteFriendListUpdateHandler);
    ...
    private UserApiService labyMod$createUserApiService(YggdrasilAuthenticationService yggdrasilAuthenticationService, GameConfig gameConfig, Operation<UserApiService> original) {
        this.labyMod$authenticationService = yggdrasilAuthenticationService;
        return (UserApiService) original.call(new Object[]{yggdrasilAuthenticationService, gameConfig});
    }
