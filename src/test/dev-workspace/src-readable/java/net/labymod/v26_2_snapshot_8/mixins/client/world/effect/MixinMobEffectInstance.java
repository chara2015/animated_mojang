package net.labymod.v26_2_snapshot_8.mixins.client.world.effect;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/world/effect/MixinMobEffectInstance.class */
...
public abstract class MixinMobEffectInstance implements PotionEffect {
    ...
    private Identifier labyMod$cacheIcon() {
        ...
        this.labyMod$iconSprite = Hud.getMobEffectSprite(this.effect);
        return this.labyMod$iconSprite;
    }
}
