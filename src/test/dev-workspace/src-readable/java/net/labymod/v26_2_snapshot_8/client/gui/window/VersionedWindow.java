package net.labymod.v26_2_snapshot_8.client.gui.window;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/gui/window/VersionedWindow.class */
public class VersionedWindow extends DefaultAbstractWindow {
    ...
    public void displayScreenRaw(Object screenObject) {
        ...
        try {
            Minecraft.getInstance().gui.setScreen((Screen) screenObject);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public Object mostInnerScreen() throws TooManyIterationsException {
        return getMostInnerScreen(Minecraft.getInstance().gui.screen());
    }
