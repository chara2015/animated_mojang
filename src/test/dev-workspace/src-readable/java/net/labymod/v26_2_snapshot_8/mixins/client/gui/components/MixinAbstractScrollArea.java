...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/gui/components/MixinAbstractScrollArea.class */
...
public abstract class MixinAbstractScrollArea extends AbstractWidget {
    ...
    @WrapOperation(method = {"extractScrollbar"}, at = {@At(value = "INVOKE", target = "Lnet/minecraft/client/gui/components/AbstractScrollArea;scrollable()Z")})
    private boolean labyMod$render(AbstractScrollArea instance, Operation<Boolean> original) {
        ...
        int x = scrollBarX();
        Bounds scrollBar = new PositionedBounds(x, getY(), x + 6, getBottom());
