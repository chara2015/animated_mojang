package net.labymod.v26_2_snapshot_8.mixins.client.world.phys;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/world/phys/MixinHitResult.class */
    ...
    public FloatVector3 location() {
        if (this.labyMod$hitLocation == null) {
            if (this.location == null) {
                ...
                this.labyMod$hitLocation = new FloatVector3((float) this.location.x, (float) this.location.y, (float) this.location.z);
            }
        }
        return this.labyMod$hitLocation;
    }

    /* JADX INFO: renamed from: net.labymod.v26_2_snapshot_8.mixins.client.world.phys.MixinHitResult$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/world/phys/MixinHitResult$1.class */
