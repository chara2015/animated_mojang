...
import net.labymod.v26_2_snapshot_8.laby3d.pipeline.opengl.Laby3DGlTexture;
import net.labymod.v26_2_snapshot_8.laby3d.pipeline.opengl.Laby3DGlTextureView;
import net.minecraft.client.renderer.texture.AbstractTexture;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/resources/texture/VersionedLabyTexture.class */
public class VersionedLabyTexture extends AbstractTexture implements Texture {
    ...
    private Laby3DGlTexture getGameGlTexture() {
        if (this.gameGlTexture == null) {
            GpuDeviceAccessor device = GpuDeviceAccessor.self(RenderSystem.getDevice());
            GlDevice glDeviceLabyMod$getBackend = device.labyMod$getBackend();
            if (glDeviceLabyMod$getBackend instanceof GlDevice) {
                GlDevice glDevice = glDeviceLabyMod$getBackend;
                this.gameGlTexture = new Laby3DGlTexture(this.delegate.deviceTexture(), glDevice.frameBufferCache());
            }
        }
    ...
    private Laby3DGlTextureView getGameGlTextureView() {
        if (this.gameGlTextureView == null) {
            ...
            if (glDeviceLabyMod$getBackend instanceof GlDevice) {
                GlDevice glDevice = glDeviceLabyMod$getBackend;
                this.gameGlTextureView = new Laby3DGlTextureView(getGameGlTexture(), glDevice.frameBufferCache());
            }
        }
    ...
    /* JADX INFO: renamed from: net.labymod.v26_2_snapshot_8.client.resources.texture.VersionedLabyTexture$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/resources/texture/VersionedLabyTexture$1.class */
