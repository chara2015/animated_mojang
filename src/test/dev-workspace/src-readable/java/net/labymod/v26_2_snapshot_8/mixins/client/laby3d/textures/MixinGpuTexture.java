...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/laby3d/textures/MixinGpuTexture.class */
...
public abstract class MixinGpuTexture implements DeviceTexture {
    ...
    @Shadow
    public abstract GpuFormat getFormat();
    ...
    /* JADX INFO: renamed from: net.labymod.v26_2_snapshot_8.mixins.client.laby3d.textures.MixinGpuTexture$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/laby3d/textures/MixinGpuTexture$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$mojang$blaze3d$GpuFormat = new int[GpuFormat.values().length];

        static {
            try {
                $SwitchMap$com$mojang$blaze3d$GpuFormat[GpuFormat.RGB8_UNORM.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$mojang$blaze3d$GpuFormat[GpuFormat.R8_UNORM.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$mojang$blaze3d$GpuFormat[GpuFormat.S8_UINT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$mojang$blaze3d$GpuFormat[GpuFormat.D32_FLOAT.ordinal()] = 4;
    ...
    public DeviceTexture.Format format() {
        switch (AnonymousClass1.$SwitchMap$com$mojang$blaze3d$GpuFormat[getFormat().ordinal()]) {
            case 1:
            ...
            default:
                throw new IllegalStateException("Unexpected value: " + String.valueOf(getFormat()));
        }
    }
