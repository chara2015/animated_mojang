...
import net.labymod.v1_21_8.client.gfx.pipeline.renderer.text.FontAccessor;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gfx/pipeline/renderer/text/VersionedVanillaGlyph.class */
public class VersionedVanillaGlyph extends VanillaGlyph {
    private final gas bakedGlyph;
    ...
    public StyledGlyphRenderable createGlyph(float x, float y, int color, int shadowColor, Style style, float boldOffset, float shadowOffset) {
        return new VanillaRenderedGlyph(new b(x, y, color, shadowColor, this.bakedGlyph, (yl) CastUtil.cast(style), boldOffset, shadowOffset));
    }
}
