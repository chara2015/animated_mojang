package net.labymod.v1_21_8.mixins.client.gui;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/gui/MixinGuiGraphics.class */
@Mixin({fxb.class})
public class MixinGuiGraphics implements GuiGraphicsAccessor {
    ...
    @Override // net.labymod.v1_21_8.client.gui.GuiGraphicsAccessor
