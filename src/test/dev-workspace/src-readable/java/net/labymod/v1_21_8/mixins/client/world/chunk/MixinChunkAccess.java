package net.labymod.v1_21_8.mixins.client.world.chunk;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/world/chunk/MixinChunkAccess.class */
@Mixin({efy.class})
public abstract class MixinChunkAccess implements Chunk {
    ...
    @Shadow
    @Final
    protected Map<jb, eaz> k;

    @Shadow
    public abstract eka a(a aVar);

    @Shadow
    public abstract egj b(int i);

    @Shadow
    public abstract egj[] d();
    ...
    public boolean isLoaded() {
        return !(this instanceof ege);
    }

    @Override // net.labymod.api.client.world.chunk.Chunk
    public BlockState getBlockState(int x, int y, int z) {
        int index = ((efy) this).f(y);
        if (index < 0 || index >= this.m.length) {
            return dqb.a.m();
        }
        egj section = this.m[index];
        if (section == null) {
            return dqb.a.m();
        }
        int yPos = y & 15;
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (Map.Entry<jb, eaz> entry : this.k.entrySet()) {
            int i = index;
            index++;
