...
import net.labymod.v1_21_8.client.gui.EditBoxAccessor;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/screen/widget/converter/TextFieldConverter.class */
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<fxx, TextFieldWidget> {
    ...
    public TextFieldWidget createDefault(fxx source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(fxx source, TextFieldWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
