...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/multiplayer/server/VersionedClientNetworkPacketListener.class */
@Singleton
...
public class VersionedClientNetworkPacketListener extends ClientNetworkPacketListener {
    ...
    public void onEntityRotate(Entity entity, float yaw, int lerpSteps) {
        if (!(entity instanceof bzm)) {
            return;
        }
        bzm mcEntity = (bzm) entity;
