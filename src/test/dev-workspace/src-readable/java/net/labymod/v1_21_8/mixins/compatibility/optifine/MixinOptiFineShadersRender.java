...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/compatibility/optifine/MixinOptiFineShadersRender.class */
@Pseudo
...
public class MixinOptiFineShadersRender {
    ...
    private static fod labyMod$store(Operation<fod> original) {
        fod pose = (fod) original.call(new Object[0]);
