package net.labymod.v1_21_8.client.player;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/player/VersionedNetworkPlayerInfo.class */
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    private final grw wrapped;
    private final Component usernameComponent = Component.text(profile().getUsername());
    private Metadata metadata = Metadata.create();

    public VersionedNetworkPlayerInfo(grw wrapped) {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_8.client.player.VersionedNetworkPlayerInfo$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[dmr.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dmr.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dmr.b.ordinal()] = 2;
    ...
    public grw getWrapped() {
        return this.wrapped;
    }

    private xo decorateComponent(@NotNull grw info, yc mutableComponent) {
        if (info.e() == dmr.d) {
            return mutableComponent.a(o.u);
        }
