...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/component/VersionedIconContents.class */
public class VersionedIconContents implements xp {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull yl style) {
