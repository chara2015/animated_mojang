...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<fzu> getTabs();

    fzv getTabManager();

    VersionedTab versionedTabOf(fzu fzuVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/TabNavigationBarAccessor$VersionedTab.class */
    public static class VersionedTab extends ComponentTab {
        ...
        private final fzu tab;

        public VersionedTab(fzu tab) {
            this.tab = tab;
        }
