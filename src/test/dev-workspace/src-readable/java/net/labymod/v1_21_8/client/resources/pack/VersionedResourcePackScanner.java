...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/resources/pack/VersionedResourcePackScanner.class */
@Singleton
...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner {
    ...
    private void scanPack(awb pack, String baseDirectory, a output) {
        pack.a(awd.a, Namespaces.MINECRAFT, baseDirectory, output);
    }

    private Collection<String> collectIgnoredFiles(awb pack) {
        Set<String> ignoredFiles = new HashSet<>();
        for (String namespace : pack.a(awd.a)) {
            axg<InputStream> resource = pack.a(awd.a, ame.a(namespace, "labymod/ignored_files.json"));
            if (resource != null) {
                try {
