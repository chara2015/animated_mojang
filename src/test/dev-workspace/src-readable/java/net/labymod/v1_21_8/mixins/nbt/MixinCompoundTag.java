...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/nbt/MixinCompoundTag.class */
@Mixin({ui.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, vi> x;

    @Shadow
    public abstract vi a(String str, vi viVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract vi shadow$a(String str);
    ...
    @Shadow
    public abstract ui n(String str);

    @Shadow
    public abstract uo p(String str);

    @Shadow
    public abstract Set<String> shadow$e();

    @Shadow
    public abstract vk<ui> c();
