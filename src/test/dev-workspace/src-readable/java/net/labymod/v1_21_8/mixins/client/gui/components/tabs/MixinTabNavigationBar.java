package net.labymod.v1_21_8.mixins.client.gui.components.tabs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({fzw.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fzl implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    private final WidgetWatcher<T> watcher = new WidgetWatcher<>();
    private final Map<fzu, TabNavigationBarAccessor.VersionedTab> versionedTabs = new HashMap();

    @Shadow
    @Final
    private ImmutableList<fzu> i;

    @Shadow
    @Final
    private fzv h;
    private fzu labyMod$currentTab;

    @Override // net.labymod.v1_21_8.client.gui.TabNavigationBarAccessor
    public ImmutableList<fzu> getTabs() {
        return this.i;
    }

    @Override // net.labymod.v1_21_8.client.gui.TabNavigationBarAccessor
    public fzv getTabManager() {
        return this.h;
    }
    ...
    @Override // net.labymod.v1_21_8.client.gui.TabNavigationBarAccessor
    public TabNavigationBarAccessor.VersionedTab versionedTabOf(fzu tab) {
