...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/resources/pack/PackUtil.class */
public final class PackUtil {
    public static boolean isModifiedPackResources(awb resources) {
        ...
        if (resources instanceof WrappedPackResources) {
            ...
            awb delegate = wrappedPackResources.delegate();
            return isModifiedPackResources(delegate);
        }
        return false;
    }

    public static awb unwrap(awb resources) {
        if (!(resources instanceof WrappedPackResources)) {
            return resources;
        }
