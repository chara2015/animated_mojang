package net.labymod.v1_21_8.client.particle;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/particle/VersionedParticleController.class */
@Singleton
...
public class VersionedParticleController implements ParticleController {
    ...
    public void crackBlock(FloatVector3 blockPosition, Direction direction) {
        jb position = new jb(MathHelper.ceil(blockPosition.getX()), MathHelper.ceil(blockPosition.getY()), MathHelper.ceil(blockPosition.getZ()));
        fue.R().g.a(position, getMinecraftDirection(direction));
    }

    public jh getMinecraftDirection(Direction direction) {
        switch (direction) {
            case DOWN:
                return jh.a;
            case UP:
