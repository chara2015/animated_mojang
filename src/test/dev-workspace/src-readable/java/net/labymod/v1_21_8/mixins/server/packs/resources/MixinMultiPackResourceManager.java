...
import net.labymod.v1_21_8.client.resources.pack.ModifiedPackResources;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/server/packs/resources/MixinMultiPackResourceManager.class */
@Mixin({axh.class})
public class MixinMultiPackResourceManager implements SilentReloadableResourceManager {

    @Shadow
    @Final
    private Map<String, axf> c;
