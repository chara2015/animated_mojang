...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/gui/components/MixinAbstractScrollArea.class */
@Mixin({fxh.class})
public abstract class MixinAbstractScrollArea extends fxm {
    @Shadow
    ...
    public MixinAbstractScrollArea(int $$0, int $$1, int $$2, int $$3, xo $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(fxh instance, Operation<Boolean> original) {
        int maxScroll = instance.i();
        if (maxScroll <= 0) {
            return false;
        }
        ...
        int x = l();
        Bounds scrollBar = new PositionedBounds(x, F(), x + 6, H());
        ...
        int scrolled = (((int) g()) * (((int) scrollBarHeight) - scrollButtonHeight)) / maxScroll;
        if (scrolled < 0) {
            scrolled = 0;
        }
