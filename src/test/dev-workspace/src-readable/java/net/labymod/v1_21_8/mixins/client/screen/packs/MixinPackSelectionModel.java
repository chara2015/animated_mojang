package net.labymod.v1_21_8.mixins.client.screen.packs;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;
import net.labymod.v1_21_8.client.resources.pack.PackUtil;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({gjb.class})
public class MixinPackSelectionModel {
    ...
    private List<aww> getAvailablePacks() {
        List<aww> list = new ArrayList<>();
        for (aww pack : this.a.d()) {
