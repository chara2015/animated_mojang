...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/nbt/MixinListTag.class */
@Mixin({uo.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, vi viVar);

    @Shadow
    public abstract boolean a(int i, vi viVar);

    @Shadow
    public abstract void d(int i, vi viVar);

    @Shadow
    public abstract vi shadow$d(int i);
    ...
    public void add(NBTTag tag) {
        b(size(), (vi) CastUtil.cast(tag));
    }

    @Override // net.labymod.api.nbt.tags.NBTTagList
    public void add(int i, NBTTag tag) {
        d(i, (vi) CastUtil.cast(tag));
    }

    @Override // net.labymod.api.nbt.tags.NBTTagList
    public void set(int i, NBTTag tag) {
        a(i, (vi) CastUtil.cast(tag));
    }
