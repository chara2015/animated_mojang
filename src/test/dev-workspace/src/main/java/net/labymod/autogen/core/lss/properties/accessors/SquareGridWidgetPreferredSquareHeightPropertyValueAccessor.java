...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/SquareGridWidgetPreferredSquareHeightPropertyValueAccessor.class */
public final class SquareGridWidgetPreferredSquareHeightPropertyValueAccessor implements PropertyValueAccessor<SquareGridWidget, Integer, Integer> {
    ...
    public LssProperty getProperty(SquareGridWidget widget) {
        return widget.preferredSquareHeight();
    }
