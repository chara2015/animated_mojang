...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/scoreboard/MixinObjective.class */
@Mixin({fcv.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_3.mixins.client.scoreboard.MixinObjective$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        fdb scoreAccess = this.a.c(fdc.c(entry), (fcv) this);
    ...
    public ScoreboardScore getScore(@NotNull String entry) {
        fcz scoreInfo = this.a.d(fdc.c(entry), (fcv) this);
        if (scoreInfo == null) {
            return null;
        }
