...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/nbt/MixinCompoundTag.class */
@Mixin({us.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    public abstract vp shadow$c(String str);
    ...
    @Shadow
    public abstract us shadow$p(String str);

    @Shadow
    public abstract uy c(String str, int i);
