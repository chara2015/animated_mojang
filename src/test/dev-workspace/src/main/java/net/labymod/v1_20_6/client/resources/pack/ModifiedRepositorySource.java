...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/resources/pack/ModifiedRepositorySource.class */
public class ModifiedRepositorySource implements auc {
    ...
    public void loadPacks(Consumer<atx> packConsumer) {
        for (ResourcePack registeredPack : this.labyAPI.renderPipeline().resourcePackRepository().getRegisteredPacks()) {
            ...
            atx pack = atx.a(new ata(name, xp.b(name), aub.c, Optional.empty()), new FixedResourcesSupplier(new ModifiedPackResources(registeredPack)), atd.a, new atc(true, b.a, true));
            if (pack != null) {
