package net.labymod.v1_21_5.client.overlay;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/overlay/CustomLoadingOverlay.class */
public class CustomLoadingOverlay extends fzg {
    private final fqq minecraft;
    private final avk reload;
    private final Consumer<Optional<Throwable>> onFinish;
    private final AbstractBootLogoRenderer loadingRenderer;
    private final DynamicBackgroundController caveRenderer;

    public CustomLoadingOverlay(fqq minecraft, avk reload, Consumer<Optional<Throwable>> onFinish, boolean fadeIn) {
    ...
    public void a(ftk gui, int mouseX, int mouseY, float partialTicks) {
        fki window = this.minecraft.aO();
        int width = window.o();
        int height = window.p();
