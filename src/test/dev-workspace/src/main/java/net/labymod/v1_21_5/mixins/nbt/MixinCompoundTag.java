...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/nbt/MixinCompoundTag.class */
@Mixin({ua.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    public abstract va a(String str, va vaVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract va shadow$a(String str);
    ...
    @Shadow
    public abstract ua n(String str);

    @Shadow
    public abstract ug p(String str);
