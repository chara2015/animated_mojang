...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/world/block/MixinBlockState.class */
@Mixin({eoh.class})
...
public abstract class MixinBlockState extends a implements BlockState {
    ...
    protected MixinBlockState(dzq $$0, Reference2ObjectArrayMap<epk<?>, Comparable<?>> $$1, MapCodec<eoh> $$2) {
        super($$0, $$1, $$2);
    ...
    public int getTopColor() {
        ...
        ggr blockColors = gfj.V().aE();
        return blockColors.a(B(), hifVar, this.labyMod$blockPos);
    }
    ...
    public int getLightLevel(LightType lightType) {
        ...
        return level.a((dww) lightType.toMinecraft(), this.labyMod$blockPos);
    }

    /* JADX INFO: renamed from: net.labymod.v1_21_11.mixins.client.world.block.MixinBlockState$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/world/block/MixinBlockState$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$block$RenderShape = new int[egf.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$block$RenderShape[egf.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$block$RenderShape[egf.b.ordinal()] = 2;
    ...
    public boolean isCollisionShapeSolid() {
        return B().m(gfj.V().r, this.labyMod$blockPos);
    }

    @Override // net.labymod.api.client.world.block.BlockState
    @Nullable
    public AxisAlignedBoundingBox bounds() {
        fug shape = B().f(gfj.V().r, this.labyMod$blockPos);
        if (shape.c()) {
            return null;
        }
        fth bounds = shape.a();
    ...
    public boolean hasCollision() {
        return !B().g(gfj.V().r, this.labyMod$blockPos).c();
    }
    ...
    public boolean isWater() {
        flb fluidState = B().y();
        return fluidState.b(flc.c) || fluidState.b(flc.b);
    }

    @Override // net.labymod.api.client.world.block.BlockState
    public boolean isLava() {
        flb fluidState = B().y();
        return fluidState.b(flc.e) || fluidState.b(flc.d);
    }

    @Override // net.labymod.api.client.world.block.BlockState
    public float getHardness(Player player) {
        ddm mcPlayer = (ddm) player;
        return B().a(mcPlayer, mcPlayer.ao(), this.labyMod$blockPos);
    }
    ...
    public boolean isValidSpawnBlock(@NotNull ResourceLocation entityType) {
        ...
        return a(hifVar, this.labyMod$blockPos, (cgu) ((c) mi.g.c((amo) entityType.getMinecraftLocation()).orElseThrow()).a());
    }
    ...
    public boolean hasInvisibleCollisionHeight() {
        ...
        fug shape = g(hifVar, this.labyMod$blockPos);
