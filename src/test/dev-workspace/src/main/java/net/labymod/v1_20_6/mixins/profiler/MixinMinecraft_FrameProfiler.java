package net.labymod.v1_20_6.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({ffh.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(gdj instance, float v, long l, boolean b, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(ffh instance, Operation<Void> original) {
