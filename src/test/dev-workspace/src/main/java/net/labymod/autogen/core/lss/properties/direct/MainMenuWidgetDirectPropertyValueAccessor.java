...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/MainMenuWidgetDirectPropertyValueAccessor.class */
public class MainMenuWidgetDirectPropertyValueAccessor extends AbstractWidgetDirectPropertyValueAccessor {
    LssPropertyResetter MainMenuWidgetResetter = new MainMenuWidgetLssPropertyResetter();
