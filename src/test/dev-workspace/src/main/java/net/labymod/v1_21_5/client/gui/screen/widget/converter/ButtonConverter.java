...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/screen/widget/converter/ButtonConverter.class */
public class ButtonConverter extends AbstractMinecraftWidgetConverter<fto, ButtonWidget> {
    ...
    public ButtonWidget createDefault(fto source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(fto source, ButtonWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public String getWidgetId(fto source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.B());
    }

    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public List<String> getWidgetIds(fto source) {
        return this.componentMapper.getTranslationKeysOfComponent(source.B());
    }

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/screen/widget/converter/ButtonConverter$ImageButtonMapper.class */
    class ImageButtonMapper implements Mapper<fto, ButtonWidget> {
        ImageButtonMapper() {
        }

        @Override // net.labymod.api.util.function.Mapper
        public ButtonWidget map(fto source) {
            if (!(source instanceof fuk)) {
                return null;
            }
            ImageButtonAccessor accessor = (fuk) source;
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper.class */
    class LockIconButtonMapper implements Mapper<fto, ButtonWidget> {
        ...
        public ButtonWidget map(fto source) {
            ...
            if (!(source instanceof fuo)) {
                return null;
            }
            fuo lockIconButton = (fuo) source;
            source.A();
        ...
        /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper$LockIconSprite.class */
        enum LockIconSprite {
