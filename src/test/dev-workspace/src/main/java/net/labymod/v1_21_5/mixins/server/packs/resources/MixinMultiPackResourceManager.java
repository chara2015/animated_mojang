...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/server/packs/resources/MixinMultiPackResourceManager.class */
@Mixin({avh.class})
public class MixinMultiPackResourceManager implements SilentReloadableResourceManager {
    ...
    @Override // net.labymod.v1_21_5.client.resources.pack.SilentReloadableResourceManager
