...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/nbt/MixinCompoundTag.class */
@Mixin({sn.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, tk> x;

    @Shadow
    public abstract tk a(String str, tk tkVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract tk shadow$c(String str);
    ...
    @Shadow
    public abstract sn shadow$p(String str);

    @Shadow
    public abstract st c(String str, int i);
