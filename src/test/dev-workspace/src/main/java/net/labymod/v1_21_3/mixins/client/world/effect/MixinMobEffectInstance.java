...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/world/effect/MixinMobEffectInstance.class */
@Mixin({bup.class})
...
public abstract class MixinMobEffectInstance implements PotionEffect {
    ...
    public String getTranslationKey() {
        Component component = Laby.labyAPI().minecraft().componentMapper().fromMinecraftComponent(((bun) this.g.a()).e());
    ...
    public void renderIcon(ScreenContext context, int x, int y, int width, int height) {
        ...
        this.labyMod$graphics.setPose((fgs) poseStackObject);
        this.labyMod$graphics.a(glv::C, sprite, x, y, width, height, -1);
    ...
    private hbl labyMod$cacheIcon() {
        ...
        alz resourceLocation = ma.d.b((bun) this.g.a());
        if (resourceLocation == null) {
            return null;
        }
        this.labyMod$iconSprite = fmg.Q().aG().a(this.g);
        return this.labyMod$iconSprite;
    }
}
