...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({glq.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(fum instance, fof graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
