...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/client/gui/components/MixinImageButton.class */
@Mixin({dlr.class})
public abstract class MixinImageButton extends MixinAbstractWidget implements ImageButtonAccessor {
    ...
    public void render(dfm stack, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
