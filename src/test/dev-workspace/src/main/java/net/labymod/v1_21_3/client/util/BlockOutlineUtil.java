...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/util/BlockOutlineUtil.class */
public class BlockOutlineUtil {
    public static void renderBlockOutline(dhi level, gll bufferSource, fgw lineConsumer, fgs poseStack, bvk entity, double x, double y, double z, jh blockPos, dxv blockState, int color) {
        ...
        fcs shape = blockState.a(level, blockPos, fcd.a(entity));
        ...
        if (overlayColor != null) {
            fgw overlayConsumer = bufferSource.getBuffer(OverlayRenderType.INSTANCE);
    ...
    private static a drawLines(fgw vertexConsumer, a pose, double x, double y, double z, Color color) {
        ...
        return (minX, minY, minZ, maxX, maxY, maxZ) -> {
            ...
            float offset = bae.c((blockX * blockX) + (blockY * blockY) + (blockZ * blockZ));
    ...
    private static a drawBoxes(fgw vertexConsumer, a pose, double x, double y, double z, Color color) {
        float red = color.getRed() / 255.0f;
        float green = color.getGreen() / 255.0f;
        float blue = color.getBlue() / 255.0f;
        float alpha = color.getAlpha() / 255.0f;
    ...
    private static fgw addVertex(fgw vertexConsumer, Matrix4f matrix, double x, double y, double z) {
