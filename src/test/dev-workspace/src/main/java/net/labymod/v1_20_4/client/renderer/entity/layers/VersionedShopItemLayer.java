package net.labymod.v1_20_4.client.renderer.entity.layers;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/renderer/entity/layers/VersionedShopItemLayer.class */
public class VersionedShopItemLayer extends gcy<fsg, flc<fsg>> {
    private final flc<fsg> playerModel;
    private final ShopLayerVisualizer visualizer;

    public VersionedShopItemLayer(gai<fsg, flc<fsg>> layerParent) {
        super(layerParent);
    ...
    public void a(@NotNull eqb poseStack, @NotNull fth bufferSource, int lightCoords, @NotNull fsg player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
