...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/entity/item/MixinPrimedTnt.class */
@Mixin({czm.class})
...
public abstract class MixinPrimedTnt extends MixinEntity implements PrimedTnt {
    ...
    public LivingEntity primedTnt$getOwner() {
        LivingEntity livingEntityShadow$e = shadow$e();
