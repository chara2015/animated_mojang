...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/compatibility/optifine/MixinOptiFineLevelRendererLevelRenderContext.class */
@DynamicMixin(value = OptiFine.NAMESPACE, applier = OptiFineDynamicMixinApplier.class)
@Mixin(value = {hoh.class}, priority = 900)
public class MixinOptiFineLevelRendererLevelRenderContext {
    ...
    private fzm labyMod$storePoseStack(Operation<fzm> original) {
        fzm poseStack = (fzm) original.call(new Object[0]);
