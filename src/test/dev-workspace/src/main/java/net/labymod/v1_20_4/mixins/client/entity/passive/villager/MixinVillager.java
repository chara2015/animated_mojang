package net.labymod.v1_20_4.mixins.client.entity.passive.villager;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/entity/passive/villager/MixinVillager.class */
@Mixin({cev.class})
public abstract class MixinVillager implements Villager {
    @Shadow
    public abstract cew gp();
