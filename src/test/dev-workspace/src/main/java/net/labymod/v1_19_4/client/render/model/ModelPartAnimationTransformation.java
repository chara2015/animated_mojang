package net.labymod.v1_19_4.client.render.model;

import net.labymod.api.util.math.Transformation;
import net.labymod.api.util.math.vector.FloatVector3;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/render/model/ModelPartAnimationTransformation.class */
public class ModelPartAnimationTransformation extends Transformation {
    public ModelPartAnimationTransformation(fcr modelPart, Transformation modelPartTransform) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/render/model/ModelPartAnimationTransformation$ModelPartPositionVector.class */
    private static class ModelPartPositionVector extends FloatVector3 {
        private final fcr modelPart;
        private final FloatVector3 modelPartTranslation;

        public ModelPartPositionVector(fcr modelPart, FloatVector3 modelPartTranslation) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/render/model/ModelPartAnimationTransformation$ModelPartRotationVector.class */
    private static class ModelPartRotationVector extends FloatVector3 {
        private final fcr modelPart;

        public ModelPartRotationVector(fcr modelPart) {
            this.modelPart = modelPart;
        }
