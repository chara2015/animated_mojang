...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/gui/screens/MixinLanguageSelectScreen.class */
@Mixin({eua.class})
public class MixinLanguageSelectScreen {
    ...
    private boolean labyMod$fasterLanguageReload(enn instance) {
