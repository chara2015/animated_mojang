...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/network/chat/VersionedKeybindComponent.class */
public class VersionedKeybindComponent extends VersionedBaseComponent<KeybindComponent, wq> implements KeybindComponent {
    public VersionedKeybindComponent(xd holder) {
        super(holder);
    }

    @Override // net.labymod.api.client.component.KeybindComponent
    public String getKeybind() {
        xt xtVar = (wq) getContents();
        if (xtVar instanceof xt) {
            xt keybind = xtVar;
            return keybind.b();
        }
