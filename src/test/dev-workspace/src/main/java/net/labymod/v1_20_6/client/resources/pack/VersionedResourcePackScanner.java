...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/resources/pack/VersionedResourcePackScanner.class */
@Singleton
...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner {
    ...
    private boolean isExternalPack(atb pack) {
    ...
    private IncompatibleResourcePack scanPack(atb pack) {
    ...
    private void scanPack(atb pack, String baseDirectory, a output) {
        pack.a(atd.a, Namespaces.MINECRAFT, baseDirectory, output);
    }

    private Collection<String> collectIgnoredFiles(atb pack) {
        Set<String> ignoredFiles = new HashSet<>();
        for (String namespace : pack.a(atd.a)) {
            auh<InputStream> resource = pack.a(atd.a, new alf(namespace, "labymod/ignored_files.json"));
            if (resource != null) {
                try {
