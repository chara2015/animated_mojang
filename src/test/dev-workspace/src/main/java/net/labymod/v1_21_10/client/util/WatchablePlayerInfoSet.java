...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/util/WatchablePlayerInfoSet.class */
public class WatchablePlayerInfoSet implements WatchableSet<gzy> {
    ...
    public void onAdd(gzy playerInfo) {
    ...
    @Override // net.labymod.core.watcher.collection.WatchableCollection
    public void onRemove(gzy playerInfo) {
        NetworkPlayerInfo networkPlayerInfo = findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(gzy info) {
