...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({fcn.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(fdb screen, ewu graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
