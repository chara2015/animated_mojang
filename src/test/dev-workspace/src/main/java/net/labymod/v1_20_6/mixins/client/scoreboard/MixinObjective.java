...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/scoreboard/MixinObjective.class */
@Mixin({ewp.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_20_6.mixins.client.scoreboard.MixinObjective$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        ewv scoreAccess = this.a.c(eww.c(entry), (ewp) this);
    ...
    public ScoreboardScore getScore(@NotNull String entry) {
        ewt scoreInfo = this.a.d(eww.c(entry), (ewp) this);
        if (scoreInfo == null) {
            return null;
        }
