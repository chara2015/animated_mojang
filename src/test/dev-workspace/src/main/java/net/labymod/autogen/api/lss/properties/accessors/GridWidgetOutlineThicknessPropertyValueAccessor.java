...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/GridWidgetOutlineThicknessPropertyValueAccessor.class */
public final class GridWidgetOutlineThicknessPropertyValueAccessor implements PropertyValueAccessor<GridWidget, Integer, Integer> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(GridWidget widget) {
        return widget.outlineThickness();
    }
