...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<fko> getTabs();

    fkp getTabManager();

    VersionedTab versionedTabOf(fko fkoVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/gui/TabNavigationBarAccessor$VersionedTab.class */
    public static class VersionedTab extends ComponentTab {
        ...
        private final fko tab;

        public VersionedTab(fko tab) {
            this.tab = tab;
        }
