...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/session/LabyMinecraftSessionService.class */
public class LabyMinecraftSessionService extends YggdrasilMinecraftSessionService {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/session/LabyMinecraftSessionService$GameProfileSerializer.class */
    private static class GameProfileSerializer implements JsonSerializer<GameProfile>, JsonDeserializer<GameProfile> {
        private GameProfileSerializer() {
        }

        /* JADX INFO: renamed from: deserialize, reason: merged with bridge method [inline-methods] */
        public GameProfile m1450deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
