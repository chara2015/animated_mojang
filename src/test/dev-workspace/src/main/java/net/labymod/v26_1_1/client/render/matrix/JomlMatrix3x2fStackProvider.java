package net.labymod.v26_1_1.client.render.matrix;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1_1/client/render/matrix/JomlMatrix3x2fStackProvider.class */
public class JomlMatrix3x2fStackProvider implements StackProvider {
    ...
    public static JomlMatrix3x2fStackProvider fromGuiGraphics(GuiGraphicsExtractor graphics) {
