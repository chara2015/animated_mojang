...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/laby3d/VersionedGlRenderDevice.class */
public class VersionedGlRenderDevice extends GlRenderDevice {
    ...
    public CommandBuffer createCommandBuffer(int flags) {
        return new ContextAwareCommandBuffer(this, super.createCommandBuffer(flags), eha::a, flags);
    }
