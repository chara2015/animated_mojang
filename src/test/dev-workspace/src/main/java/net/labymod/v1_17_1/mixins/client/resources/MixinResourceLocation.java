...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/resources/MixinResourceLocation.class */
@Mixin({ww.class})
...
public abstract class MixinResourceLocation implements ResourceLocation {
    ...
    public InputStream openStream() throws IOException {
        ...
        return dvp.C().N().a((ww) getMinecraftLocation()).b();
    }

    @Override // net.labymod.api.client.resources.ResourceLocation
    public boolean exists() {
        return ResourcesUtil.hasResource((ResourceLocation) getMinecraftLocation()) || dvp.C().N().b((ww) getMinecraftLocation());
    }
