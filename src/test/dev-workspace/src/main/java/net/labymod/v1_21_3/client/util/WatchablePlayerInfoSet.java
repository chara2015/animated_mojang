...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/util/WatchablePlayerInfoSet.class */
public class WatchablePlayerInfoSet implements WatchableSet<gfw> {
    ...
    public void onAdd(gfw playerInfo) {
    ...
    @Override // net.labymod.core.watcher.collection.WatchableCollection
    public void onRemove(gfw playerInfo) {
        NetworkPlayerInfo networkPlayerInfo = findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(gfw info) {
