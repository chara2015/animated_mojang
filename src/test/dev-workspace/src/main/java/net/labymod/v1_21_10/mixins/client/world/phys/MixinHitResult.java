package net.labymod.v1_21_10.mixins.client.world.phys;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/world/phys/MixinHitResult.class */
@Mixin({fof.class})
    ...
    public FloatVector3 location() {
        if (this.labyMod$hitLocation == null) {
            if (this.a == null) {
                ...
                this.labyMod$hitLocation = new FloatVector3((float) this.a.g, (float) this.a.h, (float) this.a.i);
            }
        }
        return this.labyMod$hitLocation;
    }

    /* JADX INFO: renamed from: net.labymod.v1_21_10.mixins.client.world.phys.MixinHitResult$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/world/phys/MixinHitResult$1.class */
