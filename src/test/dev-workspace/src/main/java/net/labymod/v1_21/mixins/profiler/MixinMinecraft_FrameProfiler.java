package net.labymod.v1_21.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({fgo.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(ges instance, fgf $$0, boolean $$1, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(fgo instance, Operation<Void> original) {
