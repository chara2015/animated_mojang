...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gfx/pipeline/renderer/text/VanillaFormattedTextLayout.class */
public class VanillaFormattedTextLayout extends FormattedTextLayout {
    private final vk text;
    private aua sequence;

    public VanillaFormattedTextLayout(String text, wc style) {
        this(vk.a(text, style));
    }

    public VanillaFormattedTextLayout(vk component) {
        this.text = component;
    }

    public VanillaFormattedTextLayout(aua sequence) {
        this.text = null;
    ...
    public aua getSequence() {
        if (this.sequence != null) {
            return this.sequence;
        }
        this.sequence = si.a().a(this.text);
        return this.sequence;
    }
}
