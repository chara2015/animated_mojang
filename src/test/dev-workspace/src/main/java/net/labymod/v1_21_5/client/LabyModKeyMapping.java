package net.labymod.v1_21_5.client;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends fqo {
    private static final Function<Hotkey, fqo> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        fqo labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static fqo create(Hotkey hotkey) {
