...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/component/VersionedIconContents.class */
public class VersionedIconContents implements xa {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull xw style) {
