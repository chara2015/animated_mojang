...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/entity/snapshot/MixinAbstractClientPlayer_SnapshotAPI.class */
@Mixin({fhh.class})
public class MixinAbstractClientPlayer_SnapshotAPI extends MixinLivingEntity_SnapshotAPI<Player> {
    @Override // net.labymod.v1_19_4.mixins.client.entity.snapshot.MixinLivingEntity_SnapshotAPI, net.labymod.v1_19_4.mixins.client.entity.snapshot.MixinEntity_SnapshotAPI, net.labymod.core.client.render.state.entity.EntitySnapshotCreator
