...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/screen/MixinJoinMultiplayerScreen.class */
@Mixin({gpv.class})
public class MixinJoinMultiplayerScreen {
    ...
    public void clearTitle(gjc instance, xx component, gda font, Operation<Void> original) {
    }

    @Insert(method = {"join(Lnet/minecraft/client/multiplayer/ServerData;)V"}, at = @At("TAIL"))
    private void getServerData(hab serverData, InsertInfo ci) {
