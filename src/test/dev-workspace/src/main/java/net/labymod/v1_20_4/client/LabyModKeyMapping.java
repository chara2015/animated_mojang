...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends evg {
    private static final Function<Hotkey, evg> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        evg labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static evg create(Hotkey hotkey) {
