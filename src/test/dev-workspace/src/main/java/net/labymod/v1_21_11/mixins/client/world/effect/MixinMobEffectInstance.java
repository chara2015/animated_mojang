...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/world/effect/MixinMobEffectInstance.class */
@Mixin({cfm.class})
...
public abstract class MixinMobEffectInstance implements PotionEffect {
    ...
    @Final
    private jd<cfk> g;
    private amo labyMod$iconSprite;
    ...
    public String getTranslationKey() {
        Component component = Laby.labyAPI().minecraft().componentMapper().fromMinecraftComponent(((cfk) this.g.a()).g());
    ...
    @Override // net.labymod.api.client.world.effect.PotionEffect
    public Icon getIcon() {
        amo spriteLocation = labyMod$cacheIcon();
        if (spriteLocation == null) {
            return null;
        }
        ilo sprites = gfj.V().aL().a(ml.h);
        ilp sprite = sprites.a(spriteLocation);
        return Icon.sprite(sprite.h(), sprite.a(), sprite.b(), 18, 18, 256, 128);
    }

    @Override // net.labymod.api.client.world.effect.PotionEffect
    public void renderIcon(ScreenContext context, int x, int y, int width, int height) {
        Object poseStackObject;
        amo sprite = labyMod$cacheIcon();
        if (sprite == null || (poseStackObject = context.stack().getProvider().getPoseStack()) == null) {
            return;
        }
        if (this.labyMod$graphics == null) {
            gfj minecraft = gfj.V();
            this.labyMod$graphics = new gir(minecraft, GameRendererAccessor.self(gfj.V().i).labyMod$getGuiRenderState(), 0, 0);
        }
        this.labyMod$graphics.setPose((Matrix3x2fStack) poseStackObject);
        this.labyMod$graphics.a(hpa.at, sprite, x, y, width, height, -1);
    }
    ...
    private amo labyMod$cacheIcon() {
        if (this.labyMod$iconSprite != null) {
            return this.labyMod$iconSprite;
        }
        amo resourceLocation = mi.d.b((cfk) this.g.a());
        if (resourceLocation == null) {
            return null;
        }
        this.labyMod$iconSprite = giq.a(this.g);
        return this.labyMod$iconSprite;
    }
}
