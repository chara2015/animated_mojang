...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/gui/screen/VersionedScreenWrapperFactory.class */
@Singleton
...
public class VersionedScreenWrapperFactory implements ScreenWrapper.Factory {
    ...
    public ScreenWrapper create(Object vanillaScreen) {
        if (!(vanillaScreen instanceof fod)) {
            throw new IllegalArgumentException(vanillaScreen.getClass().getName() + " is not an instance of " + fod.class.getName());
        }
        fod screen = (fod) vanillaScreen;
