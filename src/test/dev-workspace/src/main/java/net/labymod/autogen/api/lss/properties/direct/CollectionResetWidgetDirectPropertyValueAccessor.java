...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/CollectionResetWidgetDirectPropertyValueAccessor.class */
public class CollectionResetWidgetDirectPropertyValueAccessor extends ButtonWidgetDirectPropertyValueAccessor {
    LssPropertyResetter CollectionResetWidgetResetter = new CollectionResetWidgetLssPropertyResetter();
