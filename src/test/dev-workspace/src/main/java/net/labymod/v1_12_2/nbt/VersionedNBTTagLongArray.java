...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/nbt/VersionedNBTTagLongArray.class */
public class VersionedNBTTagLongArray extends gn {
    ...
    protected void a(DataInput input, int depth, gh sizeTracker) throws IOException {
        sizeTracker.a(192L);
