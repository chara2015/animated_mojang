...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/nbt/MixinCompoundTag.class */
@Mixin({qr.class})
...
public abstract class MixinCompoundTag implements NBTTagCompound {
    ...
    @Shadow
    @Final
    private Map<String, rk> x;

    @Shadow
    public abstract rk a(String str, rk rkVar);

    @Shadow
    public abstract void r(String str);

    @Shadow
    public abstract rk shadow$c(String str);
    ...
    @Shadow
    public abstract qr shadow$p(String str);

    @Shadow
    public abstract qx c(String str, int i);
