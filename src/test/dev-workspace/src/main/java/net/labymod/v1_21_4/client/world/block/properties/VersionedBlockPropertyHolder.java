...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/world/block/properties/VersionedBlockPropertyHolder.class */
public class VersionedBlockPropertyHolder extends AbstractBlockPropertyHolder {
    private final dxa<?, ?> holder;

    public VersionedBlockPropertyHolder(dxa<?, ?> holder) {
        this.holder = holder;
    }
    ...
    protected <T extends Comparable<T>> T getPropertyValue(BlockProperty blockProperty) {
        dya dyaVar = (dya) blockProperty;
        if (!this.holder.b(dyaVar)) {
            return null;
        }
        Enum r0 = (T) this.holder.c(dyaVar);
    ...
    public boolean hasProperty(BlockProperty property) {
        return this.holder.b((dya) property);
    }
}
