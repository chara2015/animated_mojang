...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/gui/screen/widget/converter/ButtonConverter.class */
public class ButtonConverter extends AbstractMinecraftWidgetConverter<dwu, ButtonWidget> {
    ...
    public ButtonWidget createDefault(dwu source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(dwu source, ButtonWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public String getWidgetId(dwu source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.g());
    }

    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public List<String> getWidgetIds(dwu source) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/gui/screen/widget/converter/ButtonConverter$ImageButtonMapper.class */
    class ImageButtonMapper implements Mapper<dwu, ButtonWidget> {
        ImageButtonMapper() {
        }

        @Override // net.labymod.api.util.function.Mapper
        public ButtonWidget map(dwu source) {
            if (!(source instanceof dxj)) {
                return null;
            }
            ImageButtonAccessor accessor = (dxj) source;
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper.class */
    class LockIconButtonMapper implements Mapper<dwu, ButtonWidget> {
        LockIconButtonMapper(ButtonConverter this$0) {
        }

        @Override // net.labymod.api.util.function.Mapper
        public ButtonWidget map(dwu source) {
            if (!(source instanceof dxl)) {
                return null;
            }
            dxl lockIconButton = (dxl) source;
            int size = source.f();
            ResourceLocation widgetsTexture = Laby.labyAPI().minecraft().textures().widgetsTexture();
            boolean locked = !lockIconButton.a();
            boolean enabled = lockIconButton.al_();
