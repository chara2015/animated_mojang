package net.labymod.v1_21_3.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({fmg.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(glb instance, flw $$0, boolean $$1, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(fmg instance, Operation<Void> original) {
