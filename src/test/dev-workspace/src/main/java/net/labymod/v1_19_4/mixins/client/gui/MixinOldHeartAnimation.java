...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/gui/MixinOldHeartAnimation.class */
@Mixin({enq.class})
public class MixinOldHeartAnimation {
    ...
    private void labyMod$applyOldHeartAnimation(ehe poseStack, int i0, int i1, int i2, int i3, int i4, int i5, Operation<Void> original) {
        ...
        original.call(new Object[]{poseStack, Integer.valueOf(i0), Integer.valueOf(i1), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5)});
    }
}
