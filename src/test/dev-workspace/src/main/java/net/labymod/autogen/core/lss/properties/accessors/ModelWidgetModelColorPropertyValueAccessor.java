...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/ModelWidgetModelColorPropertyValueAccessor.class */
public final class ModelWidgetModelColorPropertyValueAccessor implements PropertyValueAccessor<ModelWidget, Integer, Integer> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(ModelWidget widget) {
        return widget.modelColor();
    }
