...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/WheelWidgetSegmentHighlightColorPropertyValueAccessor.class */
public final class WheelWidgetSegmentHighlightColorPropertyValueAccessor implements PropertyValueAccessor<WheelWidget, Integer, Integer> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(WheelWidget widget) {
        return widget.segmentHighlightColor();
    }
