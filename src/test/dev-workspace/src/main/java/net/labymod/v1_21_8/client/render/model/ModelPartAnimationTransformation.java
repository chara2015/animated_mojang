package net.labymod.v1_21_8.client.render.model;

import net.labymod.api.util.math.Transformation;
import net.labymod.api.util.math.vector.FloatVector3;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/render/model/ModelPartAnimationTransformation.class */
public class ModelPartAnimationTransformation extends Transformation {
    public ModelPartAnimationTransformation(gqn modelPart, Transformation modelPartTransform) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/render/model/ModelPartAnimationTransformation$ModelPartPositionVector.class */
    private static class ModelPartPositionVector extends FloatVector3 {
        private final gqn modelPart;
        private final FloatVector3 modelPartTranslation;

        public ModelPartPositionVector(gqn modelPart, FloatVector3 modelPartTranslation) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/render/model/ModelPartAnimationTransformation$ModelPartRotationVector.class */
    private static class ModelPartRotationVector extends FloatVector3 {
        private final gqn modelPart;

        public ModelPartRotationVector(gqn modelPart) {
            this.modelPart = modelPart;
        }
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/render/model/ModelPartAnimationTransformation$ModelPartScaleVector.class */
    private static class ModelPartScaleVector extends FloatVector3 {
        private final gqn modelPart;

        public ModelPartScaleVector(gqn modelPart) {
            this.modelPart = modelPart;
        }
