...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/resources/pack/VersionedResourcePackScanner.class */
@Singleton
...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner {
    ...
    private void scanPack(PackResources pack, String baseDirectory, PackResources.ResourceOutput output) {
        pack.listResources(PackType.CLIENT_RESOURCES, Namespaces.MINECRAFT, baseDirectory, output);
    }
