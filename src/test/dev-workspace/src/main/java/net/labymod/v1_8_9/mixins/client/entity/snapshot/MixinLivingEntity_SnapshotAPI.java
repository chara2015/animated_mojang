...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/client/entity/snapshot/MixinLivingEntity_SnapshotAPI.class */
@Mixin({pr.class})
public class MixinLivingEntity_SnapshotAPI<E extends LivingEntity> extends MixinEntity_SnapshotAPI<E> {
    @Override // net.labymod.v1_8_9.mixins.client.entity.snapshot.MixinEntity_SnapshotAPI, net.labymod.core.client.render.state.entity.EntitySnapshotCreator
