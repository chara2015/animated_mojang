package net.labymod.v1_18_2.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({dyr.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(eql instance, float v, long l, boolean b, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(dyr instance, Operation<Void> original) {
