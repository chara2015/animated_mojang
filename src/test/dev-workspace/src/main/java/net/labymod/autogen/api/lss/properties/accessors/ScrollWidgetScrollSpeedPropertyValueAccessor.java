...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/ScrollWidgetScrollSpeedPropertyValueAccessor.class */
public final class ScrollWidgetScrollSpeedPropertyValueAccessor implements PropertyValueAccessor<ScrollWidget, Float, Float> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(ScrollWidget widget) {
        return widget.scrollSpeed();
    }
