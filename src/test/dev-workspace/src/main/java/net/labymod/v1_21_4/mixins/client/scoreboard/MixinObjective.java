...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/scoreboard/MixinObjective.class */
@Mixin({fby.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_4.mixins.client.scoreboard.MixinObjective$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        fce scoreAccess = this.a.c(fcf.c(entry), (fby) this);
    ...
    public ScoreboardScore getScore(@NotNull String entry) {
        fcc scoreInfo = this.a.d(fcf.c(entry), (fby) this);
        if (scoreInfo == null) {
            return null;
        }
