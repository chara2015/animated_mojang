...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/chat/contents/MixinScoreContents.class */
@Mixin({ud.class})
public class MixinScoreContents implements ScoreContentsAccessor {
    ...
    @Override // net.labymod.v1_20_1.client.network.chat.contents.ScoreContentsAccessor
