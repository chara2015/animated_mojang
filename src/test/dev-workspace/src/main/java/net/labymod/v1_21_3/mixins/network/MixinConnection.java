package net.labymod.v1_21_3.mixins.network;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/network/MixinConnection.class */
@Mixin({wp.class})
...
public abstract class MixinConnection implements NettyConnection {
    ...
    public xv labyMod4$modifyReason(xv component) {
        ...
        return (xv) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY))).reason());
    }
}
