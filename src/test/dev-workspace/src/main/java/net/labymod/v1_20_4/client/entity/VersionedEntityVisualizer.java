...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        ...
        dispatcher.a(caoVar, 0.0d, 0.0d, 0.0d, 0.0f, context.getTickDelta(), (eqb) context.stack().getProvider().getPoseStack(), evi.O().aO().c(), RenderEnvironmentContext.FULL_BRIGHT);
        eox.b();
