...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/MainMenuButtonsWidgetDirectPropertyValueAccessor.class */
public class MainMenuButtonsWidgetDirectPropertyValueAccessor extends AbstractWidgetDirectPropertyValueAccessor {
    LssPropertyResetter MainMenuButtonsWidgetResetter = new MainMenuButtonsWidgetLssPropertyResetter();
