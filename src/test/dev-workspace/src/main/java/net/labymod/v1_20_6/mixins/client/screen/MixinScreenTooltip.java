...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/screen/MixinScreenTooltip.class */
@Mixin({fnf.class})
public abstract class MixinScreenTooltip {
    ...
    private void labyMod$renderTooltip(fgt graphics, fgr font, List<ayl> values, fpy positioner, int mouseX, int mouseY) {
