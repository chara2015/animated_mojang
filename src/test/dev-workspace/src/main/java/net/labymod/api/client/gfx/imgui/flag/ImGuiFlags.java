package net.labymod.api.client.gfx.imgui.flag;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/api/client/gfx/imgui/flag/ImGuiFlags.class */
public final class ImGuiFlags {

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/api/client/gfx/imgui/flag/ImGuiFlags$StyleColors.class */
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/api/client/gfx/imgui/flag/ImGuiFlags$TreeNode.class */
    public static class TreeNode {
        public static final int NONE = 0;
        public static final int SELECTED = 1;
        public static final int FRAMED = 2;
        public static final int ALLOW_ITEM_OVERLAP = 4;
        public static final int NO_TREE_PUSH_ON_OPEN = 8;
        public static final int NO_AUTO_OPEN_ON_LOG = 16;
        public static final int DEFAULT_OPEN = 32;
        public static final int OPEN_ON_DOUBLE_CLICK = 64;
        public static final int OPEN_ON_ARROW = 128;
        public static final int LEAF = 256;
        public static final int BULLET = 512;
        public static final int FRAME_PADDING = 1024;
        public static final int SPAN_AVAIL_WIDTH = 2048;
        public static final int SPAN_FULL_WIDTH = 4096;
        public static final int NAV_LEFT_JUMPS_BACK_HERE = 8192;
        public static final int COLLAPSING_HEADER = 26;
    }
}
