...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/gfx/pipeline/renderer/text/FontAccessor.class */
public interface FontAccessor {
    fqy labyMod$getFontSet(alz alzVar);
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph.class */
    public static final class MinecraftGlyph extends Record {
        private final frc glyph;
        private final feq info;

        public MinecraftGlyph(frc glyph, feq info) {
            this.glyph = glyph;
            this.info = info;
        }
        ...
        public final String toString() {
            return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, MinecraftGlyph.class), MinecraftGlyph.class, "glyph;info", "FIELD:Lnet/labymod/v1_21_3/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->glyph:Lfrc;", "FIELD:Lnet/labymod/v1_21_3/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->info:Lfeq;").dynamicInvoker().invoke(this) /* invoke-custom */;
        }
        ...
        public final boolean equals(Object o) {
            return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, MinecraftGlyph.class, Object.class), MinecraftGlyph.class, "glyph;info", "FIELD:Lnet/labymod/v1_21_3/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->glyph:Lfrc;", "FIELD:Lnet/labymod/v1_21_3/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->info:Lfeq;").dynamicInvoker().invoke(this, o) /* invoke-custom */;
        }
