...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[dwl.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dwl.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[dwl.b.ordinal()] = 2;
    ...
    public hiq getWrapped() {
        return this.wrapped;
    }

    private yh decorateComponent(@NotNull hiq info, yw mutableComponent) {
        if (info.e() == dwl.d) {
            return mutableComponent.a(l.u);
        }
