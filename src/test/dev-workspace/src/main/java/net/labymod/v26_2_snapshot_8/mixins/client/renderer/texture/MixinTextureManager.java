package net.labymod.v26_2_snapshot_8.mixins.client.renderer.texture;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/mixins/client/renderer/texture/MixinTextureManager.class */
...
public abstract class MixinTextureManager implements GameTextureManager {
    ...
    @Shadow
    public abstract void register(Identifier identifier, AbstractTexture abstractTexture);
    ...
    public void registerAndRelease(ResourceLocation location, Object texture) {
        ...
        if (texture2 instanceof ReloadableTexture) {
            ...
            register((Identifier) location.getMinecraftLocation(), textureObject);
        }
