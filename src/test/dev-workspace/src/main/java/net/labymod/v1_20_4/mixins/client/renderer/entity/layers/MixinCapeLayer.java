package net.labymod.v1_20_4.mixins.client.renderer.entity.layers;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/renderer/entity/layers/MixinCapeLayer.class */
@Mixin({gby.class})
public class MixinCapeLayer {
    private final CapeParticleController labyMod$capeParticleController = LabyMod.references().capeParticleController();
    private ftp labyMod$renderType;
    ...
    private void labyMod$firePreCapeRenderEvent(eqb poseStack, fth param1, int param2, fsg clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(eqb poseStack, fth param1, int param2, fsg clientPlayer, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
        labyMod$fireCapeRenderEvent(poseStack, clientPlayer, Phase.POST);
    }

    @WrapOperation(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = {@At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;")})
    private ftp labyMod$attach(ahg location, Operation<ftp> original) {
        ftp ftpVar = (ftp) original.call(new Object[]{location});
        this.labyMod$renderType = ftpVar;
        return ftpVar;
    }

    @Insert(method = {"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V"}, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(eqb param0, fth param1, int param2, fsg player, float param4, float param5, float partialTicks, float param7, float param8, float param9, InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(eqb poseStack, fsg clientPlayer, Phase phase) {
        Player player = (Player) clientPlayer;
        PlayerModel playerModel = ((gcy) this).c();
