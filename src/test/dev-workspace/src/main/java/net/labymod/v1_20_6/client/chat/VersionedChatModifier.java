...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/chat/VersionedChatModifier.class */
@Singleton
...
public class VersionedChatModifier implements InternalChatModifier {
    ...
    public void fireChatClear(boolean clearHistory) {
        ffh.Q().l.d().a(clearHistory);
    }

    @Override // net.labymod.core.client.chat.InternalChatModifier
    public void deleteMessage(ChatMessage message) {
        VersionedChatComponent accessor = ffh.Q().l.d();
    ...
    public void editMessage(ChatMessage message, Component component) {
        ...
        ffb prevMessage = accessor.getMessages().get(index);
        VersionedChatMessageComponent versionedChatMessageComponent = new VersionedChatMessageComponent(message, (xp) this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new ffb(prevMessage.b(), versionedChatMessageComponent, prevMessage.d(), prevMessage.e()));
    ...
    private Predicate<ffb> messageFilter(ChatMessage message) {
        return m -> {
