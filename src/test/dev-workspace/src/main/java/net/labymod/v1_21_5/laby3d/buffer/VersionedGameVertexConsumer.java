package net.labymod.v1_21_5.laby3d.buffer;

import net.labymod.api.laby3d.buffer.GameVertexConsumer;
import net.labymod.laby3d.api.vertex.VertexConsumer;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/laby3d/buffer/VersionedGameVertexConsumer.class */
public class VersionedGameVertexConsumer implements GameVertexConsumer {
    private static final int MASK = 255;
    private static final int SHIFT = 16;
    private final flg delegate;

    public VersionedGameVertexConsumer(flg delegate) {
