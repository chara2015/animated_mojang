...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/renderer/renderer/atlas/MixinTextureAtlasHolder.class */
@Mixin({eye.class})
public class MixinTextureAtlasHolder implements TextureAtlasHolderAccessor {
    ...
    @Override // net.labymod.v1_17_1.client.gfx.pipeline.texture.atlas.TextureAtlasHolderAccessor
