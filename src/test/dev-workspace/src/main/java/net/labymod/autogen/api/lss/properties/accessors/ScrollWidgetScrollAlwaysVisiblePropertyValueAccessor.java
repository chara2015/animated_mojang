...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/ScrollWidgetScrollAlwaysVisiblePropertyValueAccessor.class */
public final class ScrollWidgetScrollAlwaysVisiblePropertyValueAccessor implements PropertyValueAccessor<ScrollWidget, Boolean, Boolean> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(ScrollWidget widget) {
        return widget.scrollAlwaysVisible();
    }
