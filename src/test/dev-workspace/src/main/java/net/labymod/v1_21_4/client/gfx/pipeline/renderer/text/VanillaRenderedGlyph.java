...
import net.labymod.v1_21_4.client.gfx.pipeline.blaze3d.PositionTextureColorVertexConsumer;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gfx/pipeline/renderer/text/VanillaRenderedGlyph.class */
public class VanillaRenderedGlyph implements StyledGlyphRenderable {
    ...
    private final b glyphInstance;
    private final RenderState renderState;

    public VanillaRenderedGlyph(b glyphInstance) {
        this.glyphInstance = glyphInstance;
        this.extension = BakedGlyphExtension.cast(glyphInstance.e());
    ...
    public Style style() {
        return (Style) CastUtil.cast(this.glyphInstance.f());
    }
}
