...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/WheelWidgetSegmentBackgroundColorPropertyValueAccessor.class */
public final class WheelWidgetSegmentBackgroundColorPropertyValueAccessor implements PropertyValueAccessor<WheelWidget, Integer, Integer> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(WheelWidget widget) {
        return widget.segmentBackgroundColor();
    }
