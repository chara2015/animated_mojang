...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/PanoramaWidgetDirectPropertyValueAccessor.class */
public class PanoramaWidgetDirectPropertyValueAccessor extends AbstractWidgetDirectPropertyValueAccessor {
    LssPropertyResetter PanoramaWidgetResetter = new PanoramaWidgetLssPropertyResetter();
