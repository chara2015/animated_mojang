...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/util/WatchablePlayerInfoSet.class */
public class WatchablePlayerInfoSet implements WatchableSet<ffb> {
    ...
    public void onAdd(ffb playerInfo) {
    ...
    @Override // net.labymod.core.watcher.collection.WatchableCollection
    public void onRemove(ffb playerInfo) {
        NetworkPlayerInfo networkPlayerInfo = findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(ffb info) {
