...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/component/VersionedIconContents.class */
public class VersionedIconContents implements xh {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull yd style) {
