...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends fzx {
    private static final Map<amj, a> CUSTOM_CATEGORIES = new HashMap();
    private static final Function<Hotkey, fzx> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        amj categoryId = amj.b("labymod", hotkey.namespace());
    ...
    public static fzx create(Hotkey hotkey) {
