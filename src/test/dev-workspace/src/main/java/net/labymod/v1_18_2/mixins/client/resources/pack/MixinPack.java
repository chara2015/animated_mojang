...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/resources/pack/MixinPack.class */
@Mixin({afl.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_18_2.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[afm.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[afm.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[afm.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[afm.c.ordinal()] = 3;
    ...
    public File labyMod$getFile() {
        aex aexVar = (afa) this.c.get();
        try {
            if (aexVar instanceof aex) {
                aex r = aexVar;
                File file = r.a;
                if (aexVar != null) {
                    aexVar.close();
