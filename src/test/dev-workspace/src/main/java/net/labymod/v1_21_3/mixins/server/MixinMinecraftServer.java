...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/server/MixinMinecraftServer.class */
...
public class MixinMinecraftServer implements MinecraftServerAccessor {
    ...
    @Override // net.labymod.v1_21_3.server.MinecraftServerAccessor
