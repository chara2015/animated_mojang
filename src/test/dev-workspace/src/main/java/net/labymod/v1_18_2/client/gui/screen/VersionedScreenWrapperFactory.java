...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gui/screen/VersionedScreenWrapperFactory.class */
@Singleton
...
public class VersionedScreenWrapperFactory implements ScreenWrapper.Factory {
    ...
    public ScreenWrapper create(Object vanillaScreen) {
        if (!(vanillaScreen instanceof edw)) {
            throw new IllegalArgumentException(vanillaScreen.getClass().getName() + " is not an instance of " + edw.class.getName());
        }
        edw screen = (edw) vanillaScreen;
