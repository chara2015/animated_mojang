...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/client/gui/components/MixinGuiEventListener.class */
@Mixin({dmi.class})
public interface MixinGuiEventListener {
    default boolean handleConvertedWidget(BiFunction<AbstractWidgetConverter, AbstractWidget<?>, Boolean> converterFunction) {
        ...
        AbstractWidgetConverter<?, ?> widgetConverter;
        if (!(this instanceof ConvertableMinecraftWidget) || (widgetConverter = (watcher = ((ConvertableMinecraftWidget) this).getWatcher()).getWidgetConverter()) == null) {
            return false;
        }
    ...
    default boolean a(double mouseX, double mouseY, int button) {
        return handleConvertedWidget((converter, widget) -> {
            return Boolean.valueOf(Laby.labyAPI().minecraft().updateMouse(mouseX, mouseY, mouse -> {
