...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/entity/item/MixinPrimedTnt.class */
@Mixin({bvi.class})
...
public abstract class MixinPrimedTnt extends MixinEntity implements PrimedTnt {
    ...
    public LivingEntity primedTnt$getOwner() {
        LivingEntity livingEntityShadow$j = shadow$j();
        if (livingEntityShadow$j == null) {
            return null;
        }
        return livingEntityShadow$j;
    }
}
