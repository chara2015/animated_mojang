...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/renderer/renderer/atlas/MixinTextureAtlas.class */
@Mixin({hkp.class})
public abstract class MixinTextureAtlas implements TextureAtlas {
    ...
    @Shadow
    public abstract hkq a(alr alrVar);
    ...
    public TextureSprite findSprite(ResourceLocation location) {
        TextureSprite textureSpriteA = a((alr) location.getMinecraftLocation());
