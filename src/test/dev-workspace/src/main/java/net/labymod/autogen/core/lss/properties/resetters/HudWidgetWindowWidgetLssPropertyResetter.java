...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/HudWidgetWindowWidgetLssPropertyResetter.class */
public class HudWidgetWindowWidgetLssPropertyResetter extends SimpleWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof HudWidgetWindowWidget) {
        }
        super.reset(widget);
    }
}
