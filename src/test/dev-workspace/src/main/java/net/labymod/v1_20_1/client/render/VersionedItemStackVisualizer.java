package net.labymod.v1_20_1.client.render;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/render/VersionedItemStackVisualizer.class */
@Singleton
...
public class VersionedItemStackVisualizer implements ItemStackVisualizer {
    ...
    public void submitItem(ScreenContext context, ItemStack itemStack, int x, int y, boolean decorate) {
        eox currentGuiGraphics = MinecraftUtil.getCurrentGuiGraphics();
        currentGuiGraphics.b((cfz) CastUtil.cast(itemStack), x, y);
        if (decorate) {
            currentGuiGraphics.a(enn.N().h, (cfz) CastUtil.cast(itemStack), x, y);
        }
    }
}
