...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/compatibility/optifine/MixinOptiFineShadersRender.class */
@Pseudo
...
public class MixinOptiFineShadersRender {
    ...
    private static fzm labyMod$store(Operation<fzm> original) {
        fzm pose = (fzm) original.call(new Object[0]);
