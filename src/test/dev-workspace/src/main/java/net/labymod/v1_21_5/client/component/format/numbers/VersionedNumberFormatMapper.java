package net.labymod.v1_21_5.client.component.format.numbers;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/component/format/numbers/VersionedNumberFormatMapper.class */
@Singleton
...
public class VersionedNumberFormatMapper implements NumberFormatMapper {
    ...
    public NumberFormat fromMinecraft(Object obj) {
        ...
        if (!(obj instanceof yw)) {
            throw new IllegalArgumentException("Object is not an instance of " + String.valueOf(yw.class));
        }
        yv yvVar = (yw) obj;
        if (yvVar instanceof yu) {
            return NumberFormat.blank();
        }
        if (yvVar instanceof yv) {
            yv fixedFormat = yvVar;
            return NumberFormat.fixed(this.componentMapper.fromMinecraftComponent(fixedFormat.b));
        }
        if (yvVar instanceof yz) {
            yz styledFormat = (yz) yvVar;
            return NumberFormat.styled(styledFormat.e);
        }
        throw new IllegalArgumentException("Unsupported number format: " + String.valueOf(yvVar.getClass()));
    }
    ...
    public Object toMinecraft(NumberFormat format) {
        ...
        if (format instanceof FixedFormat) {
            ...
            return new yv((xg) this.componentMapper.toMinecraftComponent(fixedFormat.value()));
        }
        if (format instanceof StyledFormat) {
            StyledFormat styledFormat = (StyledFormat) format;
            return new yz(styledFormat.style());
        }
