package net.labymod.v1_20_6.mixins.client.resources.pack;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/resources/pack/MixinPack.class */
@Mixin({atx.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_20_6.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/resources/pack/MixinPack$1.class */
    ...
    public File labyMod$getFile() {
        asy asyVar = this.c;
        if (asyVar instanceof asy) {
            asy packResources = asyVar;
