package net.labymod.v1_21_10.mixins.client.entity.decoration;
...
import net.labymod.v1_21_10.mixins.client.entity.MixinEntity;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/entity/decoration/MixinItemFrame.class */
@Mixin({cvj.class})
...
public abstract class MixinItemFrame extends MixinEntity implements ItemFrame {
    ...
    public ResourceLocation getFrameType() {
        return ItemUtil.getFrameType(this instanceof cvh);
    }
}
