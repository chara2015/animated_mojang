...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends enl {
    private static final Function<Hotkey, enl> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        enl labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static enl create(Hotkey hotkey) {
