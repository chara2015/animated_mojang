...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({hfk.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(gmj instance, gdd graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
