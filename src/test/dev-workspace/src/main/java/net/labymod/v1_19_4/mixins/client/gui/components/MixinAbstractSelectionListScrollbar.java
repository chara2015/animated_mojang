...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/gui/components/MixinAbstractSelectionListScrollbar.class */
@Mixin({enw.class})
public abstract class MixinAbstractSelectionListScrollbar {
    ...
    private int labyMod$render(enw instance) {
        ...
        int x = c();
        Bounds scrollBar = new PositionedBounds(x, this.f, x + 6, this.k);
        float scrollBarHeight = scrollBar.getHeight();
        int contentHeight = a() - this.o;
