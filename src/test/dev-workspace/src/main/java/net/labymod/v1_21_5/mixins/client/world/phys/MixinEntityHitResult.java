...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({ffz.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(bxe entity, fgc position, InsertInfo info) {
