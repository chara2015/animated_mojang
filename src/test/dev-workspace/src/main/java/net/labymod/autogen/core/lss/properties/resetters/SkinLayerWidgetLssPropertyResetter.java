...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/SkinLayerWidgetLssPropertyResetter.class */
public class SkinLayerWidgetLssPropertyResetter extends HorizontalListWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof SkinLayerWidget) {
        }
        super.reset(widget);
    }
}
