...
import net.labymod.v1_20_6.client.gui.EditBoxAccessor;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/gui/screen/widget/converter/TextFieldConverter.class */
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<fhp, TextFieldWidget> {
    ...
    public TextFieldWidget createDefault(fhp source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(fhp source, TextFieldWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
