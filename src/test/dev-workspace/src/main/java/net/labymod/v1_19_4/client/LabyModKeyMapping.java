package net.labymod.v1_19_4.client;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends emf {
    private static final Function<Hotkey, emf> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        emf labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static emf create(Hotkey hotkey) {
