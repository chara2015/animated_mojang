...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/session/VersionedMinecraftAuthenticator.class */
@Singleton
...
public class VersionedMinecraftAuthenticator extends DefaultsAbstractMinecraftAuthenticator {
    ...
    public VersionedMinecraftAuthenticator() {
        ...
        YggdrasilAuthenticationService yggdrasilAuthenticationServiceY = dvp.C().Y();
