...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/compatibility/optifine/MixinOptiFineLevelRenderer_CustomBlockOutline.class */
@Pseudo
...
public class MixinOptiFineLevelRenderer_CustomBlockOutline {
    ...
    @Dynamic
    private void labyMod$renderCustomBlockOutline(glv instance, ffv poseStack, ffz lineConsumer, bum entity, double x, double y, double z, ji blockPos, dwy blockState, int color, Operation<Void> original) {
