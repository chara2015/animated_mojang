...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/server/packs/resources/MixinSimpleResource.class */
@Mixin({acn.class})
public class MixinSimpleResource {
    ...
    private void labyMod$transformResourceInputStream(acn resource, InputStream stream) {
