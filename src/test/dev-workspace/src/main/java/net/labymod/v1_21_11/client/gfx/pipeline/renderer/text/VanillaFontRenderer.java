...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/gfx/pipeline/renderer/text/VanillaFontRenderer.class */
@Singleton
...
public class VanillaFontRenderer implements MinecraftFontRenderer {
    ...
    public void render(Matrix4f pose, Component text, float x, float y, int argb, int packedLightCoords, int backgroundArgb, int flags) {
        gio font = getFont();
        font.a((yh) this.componentMapper.toMinecraftComponent(text), x, y, argb, FontFlags.isShadow(flags), pose, getBufferSource(), getDisplayMode(flags), backgroundArgb, packedLightCoords);
    }
    ...
    public TextState prepareText(FormattedTextLayout textLayout, float x, float y, int argb, int packedLightCoords, int backgroundArgb, int flags) {
        ...
        font.a(vanillaText.getSequence(), x, y, argb, FontFlags.isShadow(flags), false, backgroundArgb).a(builder);
    ...
    public float getWidth(Component text) {
        return getFont().a((yh) this.componentMapper.toMinecraftComponent(text));
    }
    ...
    public String trimTextToWidth(String text, float maxWidth, StringStart start) {
        gfu splitter = getFont().b();
        if (start == StringStart.LEFT) {
            return splitter.b(text, MathHelper.ceil(maxWidth), zf.a);
        }
        return splitter.c(text, MathHelper.ceil(maxWidth), zf.a);
    }

    @Override // net.labymod.api.client.gfx.pipeline.renderer.text.FontRenderer
    public float getWidth(int codepoint, Style style) {
        return StringSplitterAccessor.cast(getFont().b()).getWidthProvider().getWidth(codepoint, (zf) CastUtil.cast(style));
    }

    private hon getBufferSource() {
        return gfj.V().aU().c();
    }
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/gfx/pipeline/renderer/text/VanillaFontRenderer$TextStateVisitor.class */
    private static class TextStateVisitor implements b {
        ...
        public void a(gnz textRenderable) {
