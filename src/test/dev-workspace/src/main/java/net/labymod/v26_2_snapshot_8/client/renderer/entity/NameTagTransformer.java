package net.labymod.v26_2_snapshot_8.client.renderer.entity;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/renderer/entity/NameTagTransformer.class */
public class NameTagTransformer {
    private static final NameTagRenderer TAG_RENDERER = new NameTagRenderer();

    public static void transform(@NotNull SubmitNodeCollector instance, @NotNull PoseStack poseStack, @NotNull Vec3 vec3, int i0, @NotNull Component component, boolean b, int i1, @NotNull CameraRenderState cameraRenderState, @NotNull Operation<Void> original, @NotNull EntityRenderState entityRenderState) {
        poseStack.pushPose();
        ...
        original.call(new Object[]{instance, poseStack, vec3, Integer.valueOf(i0), displayName.get(), Boolean.valueOf(b), Integer.valueOf(i1), cameraRenderState});
