...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/chat/contents/MixinLiteralContents.class */
@Mixin({a.class})
public class MixinLiteralContents implements LiteralContentsAccessor {
    ...
    @Override // net.labymod.v1_20_4.client.network.chat.contents.LiteralContentsAccessor
