...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({glz.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(gmj screen, gdd graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
