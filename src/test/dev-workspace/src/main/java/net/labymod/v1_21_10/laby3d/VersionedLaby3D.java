package net.labymod.v1_21_10.laby3d;
...
import net.labymod.v1_21_10.client.resources.texture.NativeGameImage;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/laby3d/VersionedLaby3D.class */
@Singleton
...
public class VersionedLaby3D extends Laby3D {
    ...
    public DeviceTextureView lightTextureView() {
        hfk renderer = fzz.W().i;
        return TextureViewProvider.cast(renderer.p()).getDeviceTextureView();
    }
    ...
    public void writeToTexture(@NotNull DeviceTexture texture, @NotNull GameImage image) throws MatchException {
        if (image instanceof NativeGameImage) {
            try {
                fsy nativeImage = ((NativeGameImage) image).image();
