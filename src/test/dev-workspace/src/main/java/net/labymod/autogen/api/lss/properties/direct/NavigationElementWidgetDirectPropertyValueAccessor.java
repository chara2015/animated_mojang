...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/NavigationElementWidgetDirectPropertyValueAccessor.class */
public class NavigationElementWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter NavigationElementWidgetResetter = new NavigationElementWidgetLssPropertyResetter();
