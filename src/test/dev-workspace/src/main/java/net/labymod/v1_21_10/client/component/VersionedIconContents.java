package net.labymod.v1_21_10.client.component;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/component/VersionedIconContents.class */
public class VersionedIconContents implements xy {
    ...
    public MapCodec<? extends xy> a() {
        return CODEC;
    }

    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull yv style) {
