...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/client/renderer/texture/atlas/MixinTextureAtlas.class */
@Mixin({bmh.class})
public abstract class MixinTextureAtlas implements TextureAtlas {
    ...
    @Shadow
    public abstract bmi a(String str);
    ...
    private void labyMod$setAtlasDimension(bmf stitcher) {
        stitcher.c();
