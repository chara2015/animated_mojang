...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends edw implements FileDropHandler, LabyScreenAccessor {
    ...
    public void a(@NotNull dtm poseStack, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(@NotNull dyr mc, int width, int height) {
        this.screen.pushCustomFontStack();
