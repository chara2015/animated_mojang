...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/nbt/MixinListTag.class */
@Mixin({qx.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, rk rkVar);

    @Shadow
    public abstract boolean a(int i, rk rkVar);

    @Shadow
    public abstract void c(int i, rk rkVar);

    @Shadow
    public abstract rk shadow$c(int i);
