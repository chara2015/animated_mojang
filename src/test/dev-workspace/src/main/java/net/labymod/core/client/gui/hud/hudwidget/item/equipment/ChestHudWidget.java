...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/core/client/gui/hud/hudwidget/item/equipment/ChestHudWidget.class */
@SpriteSlot(x = 1, y = 7)
public class ChestHudWidget extends EquipmentHudWidget<EquipmentWidgetConfig> {
    public ChestHudWidget() {
        super("chest");
    }

    @Override // net.labymod.api.client.gui.hud.hudwidget.item.ItemHudWidget
    public Icon createPlaceholderIcon() {
        return Textures.SpriteHudPlaceholder.CHESTPLATE;
    }
    ...
    public void initializePreConfigured(EquipmentWidgetConfig config) {
        ...
        config.setDropzone(NamedHudWidgetDropzones.ITEM_BOTTOM_LEFT);
