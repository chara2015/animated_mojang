...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/entity/MixinLivingEntity.class */
@Mixin({btr.class})
...
public abstract class MixinLivingEntity extends MixinEntity implements LivingEntity {
    private final Map<ji<bsc>, PotionEffect> labyMod$activePotionEffects = Maps.newHashMap();
    ...
    @Shadow
    public abstract cur a(btd btdVar);

    @Shadow
    public abstract boolean shadow$fL();

    @Shadow
    public abstract double g(ji<buu> jiVar);

    @Intrinsic
    public float livingEntity$getHealth() {
        return labyMod$getLivingEntity().eA();
    }
    ...
    public int getItemUseDurationTicks() {
        return labyMod$getLivingEntity().fz();
    }
    ...
    public boolean isMainHandRight() {
        return labyMod$getLivingEntity().fu() == btl.b;
    }

    @Override // net.labymod.api.client.entity.LivingEntity
    public ItemStack getMainHandItemStack() {
        return MinecraftUtil.fromMinecraft(labyMod$getLivingEntity().eX());
    }

    @Override // net.labymod.api.client.entity.LivingEntity
    public ItemStack getRightHandItemStack() {
        if (labyMod$getLivingEntity().fu() == btl.b) {
    ...
    public ItemStack getLeftHandItemStack() {
        if (labyMod$getLivingEntity().fu() == btl.a) {
            return getMainHandItemStack();
        }
        return getOffHandItemStack();
    }
    ...
    public ItemStack getOffHandItemStack() {
        return MinecraftUtil.fromMinecraft(labyMod$getLivingEntity().eY());
    }
    ...
    public float getHeadRotationX() {
        return labyMod$getLivingEntity().dH();
    }

    @Override // net.labymod.api.client.entity.LivingEntity
    public void setHeadRotationX(float rotationX) {
        labyMod$getLivingEntity().s(rotationX);
    }
    ...
    private void labyMod$useWatchableMap(btc param0, dca param1, CallbackInfo ci) {
