...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/gui/screen/widget/converter/TabLayoutConverter.class */
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<gmv, AbstractWidget<?>> {
    ...
    public /* bridge */ /* synthetic */ void update(Object obj, AbstractWidget abstractWidget, @NotNull WidgetReplacementStrategy widgetReplacementStrategy) {
        update((gmv) obj, (AbstractWidget<?>) abstractWidget, widgetReplacementStrategy);
    }
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public AbstractWidget<?> createDefault(gmv source) {
        TabNavigationBarAccessor accessor = (TabNavigationBarAccessor) source;
        gmu tabManager = accessor.getTabManager();
        gmt currentTab = tabManager.a();
    ...
    public void update(gmv source, AbstractWidget<?> destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
