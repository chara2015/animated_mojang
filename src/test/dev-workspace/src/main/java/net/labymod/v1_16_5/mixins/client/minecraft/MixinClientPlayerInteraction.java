...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/client/minecraft/MixinClientPlayerInteraction.class */
@Mixin({djz.class})
public class MixinClientPlayerInteraction {
    ...
    private aou labyMod$onUseItemOn(dww gamemode, dzm player, dwt clientLevel, aot hand, dcj blockHit, Operation<aou> op) {
        ...
        return (aou) op.call(new Object[]{gamemode, player, clientLevel, hand, blockHit});
    }
}
