...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/laby3d/pipeline/RenderTypeResolver.class */
public final class RenderTypeResolver {
    ...
    private static final Function<LevelMaterial, gry> DYNAMIC_TYPES = MEMOIZE.memoize(levelMaterial -> {
        d dVar;
        i iVar;
        ...
        a aVarA = b.a().a(new j((alr) ((TextureBinding) levelMaterial.getTextures().get(0)).location().getMinecraftLocation(), bbf.b, false));
        ...
        return gry.a(renderTypeName, 65536, renderPipeline, aVarA2.a(iVar).a(false));
    });
    ...
    public gry resolve(Material material) {
