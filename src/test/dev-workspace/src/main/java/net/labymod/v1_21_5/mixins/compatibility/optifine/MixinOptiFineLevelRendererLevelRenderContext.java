...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/compatibility/optifine/MixinOptiFineLevelRendererLevelRenderContext.class */
...
public class MixinOptiFineLevelRendererLevelRenderContext {
    ...
    private fld labyMod$storePoseStack(Operation<fld> original) {
        fld poseStack = (fld) original.call(new Object[0]);
