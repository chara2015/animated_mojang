...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/PanoramaWidgetLssPropertyResetter.class */
public class PanoramaWidgetLssPropertyResetter extends AbstractWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof PanoramaWidget) {
        }
        super.reset(widget);
    }
}
