...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/compatibility/optifine/MixinOptiFineShadersRender.class */
@Pseudo
...
public class MixinOptiFineShadersRender {
    ...
    private static faa labyMod$store(Operation<faa> original) {
        faa pose = (faa) original.call(new Object[0]);
