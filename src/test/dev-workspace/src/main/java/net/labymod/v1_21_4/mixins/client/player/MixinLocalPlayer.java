...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/player/MixinLocalPlayer.class */
@Mixin({gkx.class})
public abstract class MixinLocalPlayer extends MixinAbstractLocalPlayer implements ClientPlayer {
    ...
    public boolean isUsingBow() {
        return labyMod$getClientPlayer().fB().h() == cwu.pa;
    }
    ...
    public float getForwardMovingSpeed() {
        return labyMod$getClientPlayer().k.c;
    }
    ...
    private void labyMod$cancelHandSwingPacket(bsk hand, InsertInfo ci) {
    ...
    private gkx labyMod$getClientPlayer() {
        return (gkx) this;
    }
}
