package net.labymod.v1_21_1.client.renderer.entity.layers;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/client/renderer/entity/layers/VersionedShopItemLayer.class */
public class VersionedShopItemLayer extends gov<gdy, fwp<gdy>> {
    private final fwp<gdy> playerModel;
    private final ShopLayerVisualizer visualizer;

    public VersionedShopItemLayer(gmf<gdy, fwp<gdy>> layerParent) {
        super(layerParent);
    ...
    public void a(@NotNull fbi poseStack, @NotNull gez bufferSource, int lightCoords, @NotNull gdy player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
