...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        ...
        dispatcher.a(ckuVar, 0.0d, 0.0d, 0.0d, context.getTickDelta(), (fgs) context.stack().getProvider().getPoseStack(), fmg.Q().aR().c(), RenderEnvironmentContext.FULL_BRIGHT);
        ffo.d();
