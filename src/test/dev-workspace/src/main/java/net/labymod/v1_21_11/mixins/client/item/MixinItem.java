...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/item/MixinItem.class */
@Mixin({dlp.class})
public abstract class MixinItem implements Item {
    ...
    public ResourceLocation getIdentifier() {
        if (this.labyMod$identifier == null) {
            this.labyMod$identifier = mi.h.b((dlp) this);
        }
    ...
    public int getMaximumDamage() {
        return ((Integer) f().a(ki.d, 0)).intValue();
    }
