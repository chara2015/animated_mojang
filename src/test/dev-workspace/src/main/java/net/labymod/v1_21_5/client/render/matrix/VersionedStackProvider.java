...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/render/matrix/VersionedStackProvider.class */
public final class VersionedStackProvider extends AbstractStackProvider<fld, Matrix3f, Matrix4f> {
    public VersionedStackProvider(fld poseStack) {
        super(poseStack, () -> {
    ...
    public void rotate(float angle, float x, float y, float z) {
        ...
        ((fld) this.stack).a((Quaternionf) MAPPER.toQuaternion(ROTATION_VECTOR.rotationDegrees(angle)));
    }

    @Override // net.labymod.api.client.render.matrix.StackProvider
    public void rotateRadians(float radians, float x, float y, float z) {
        ROTATION_VECTOR.set(x, y, z);
        ((fld) this.stack).a((Quaternionf) MAPPER.toQuaternion(ROTATION_VECTOR.rotation(radians)));
    }
