...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/SectionedListWidgetSpaceBetweenEntriesPropertyValueAccessor.class */
public final class SectionedListWidgetSpaceBetweenEntriesPropertyValueAccessor implements PropertyValueAccessor<SectionedListWidget, Float, Float> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(SectionedListWidget widget) {
