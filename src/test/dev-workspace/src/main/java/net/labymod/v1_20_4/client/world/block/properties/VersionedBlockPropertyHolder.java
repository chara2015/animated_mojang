...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/world/block/properties/VersionedBlockPropertyHolder.class */
public class VersionedBlockPropertyHolder extends AbstractBlockPropertyHolder {
    private final djj<?, ?> holder;

    public VersionedBlockPropertyHolder(djj<?, ?> holder) {
        this.holder = holder;
    }
    ...
    protected <T extends Comparable<T>> T getPropertyValue(BlockProperty blockProperty) {
        dkk dkkVar = (dkk) blockProperty;
        if (!this.holder.b(dkkVar)) {
            return null;
        }
        Enum r0 = (T) this.holder.c(dkkVar);
    ...
    public boolean hasProperty(BlockProperty property) {
        return this.holder.b((dkk) property);
    }
}
