package net.labymod.v1_21_8.client.font.component;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/font/component/VersionedComponentMapper.class */
...
public class VersionedComponentMapper implements ComponentMapper {
    ...
    public String getTranslationKeyOfComponent(Object minecraftComponent) {
        if (minecraftComponent instanceof xo) {
            xo component = (xo) minecraftComponent;
            yz yzVarB = component.b();
            if (yzVarB instanceof yz) {
                return yzVarB.b();
            }
            return null;
        }
