...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/util/VersionedGameMathMapper.class */
@Singleton
...
public class VersionedGameMathMapper implements GameMathMapper {
    ...
    @Override // net.labymod.api.util.math.GameMathMapper
    public org.joml.Matrix4f toJomlMatrix4f(Object matrix) {
        if (!(matrix instanceof Matrix4f)) {
            return new org.joml.Matrix4f();
        }
        Matrix4f matrix4f = (Matrix4f) matrix;
        org.joml.Matrix4f mat = new org.joml.Matrix4f();
        mat.set(matrix4f.m00, matrix4f.m01, matrix4f.m02, matrix4f.m03, matrix4f.m10, matrix4f.m11, matrix4f.m12, matrix4f.m13, matrix4f.m20, matrix4f.m21, matrix4f.m22, matrix4f.m23, matrix4f.m30, matrix4f.m31, matrix4f.m32, matrix4f.m33);
        return mat;
    }
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [T, bqq] */
    @Override // net.labymod.api.util.math.GameMathMapper
    public <T> T toMatrix4f(org.joml.Matrix4f matrix4f) {
        ?? r0 = (T) new bqq();
        ((bqq) r0).m00 = matrix4f.m00();
        ((bqq) r0).m01 = matrix4f.m01();
        ((bqq) r0).m02 = matrix4f.m02();
        ((bqq) r0).m03 = matrix4f.m03();
        ((bqq) r0).m10 = matrix4f.m10();
        ((bqq) r0).m11 = matrix4f.m11();
        ((bqq) r0).m12 = matrix4f.m12();
        ((bqq) r0).m13 = matrix4f.m13();
        ((bqq) r0).m20 = matrix4f.m20();
        ((bqq) r0).m21 = matrix4f.m21();
        ((bqq) r0).m22 = matrix4f.m22();
        ((bqq) r0).m23 = matrix4f.m23();
        ((bqq) r0).m30 = matrix4f.m30();
        ((bqq) r0).m31 = matrix4f.m31();
        ((bqq) r0).m32 = matrix4f.m32();
        ((bqq) r0).m33 = matrix4f.m33();
        return r0;
    }
    ...
    public AxisAlignedBoundingBox fromAABB(Object aabb) {
        if (!(aabb instanceof aug)) {
            return BOX_IDENTITY;
        }
        aug gameAABB = (aug) aabb;
    ...
    public <T> T toAABB(AxisAlignedBoundingBox axisAlignedBoundingBox) {
        return (T) new aug(axisAlignedBoundingBox.getMinX(), axisAlignedBoundingBox.getMinY(), axisAlignedBoundingBox.getMinZ(), axisAlignedBoundingBox.getMaxX(), axisAlignedBoundingBox.getMaxY(), axisAlignedBoundingBox.getMaxZ());
    }
