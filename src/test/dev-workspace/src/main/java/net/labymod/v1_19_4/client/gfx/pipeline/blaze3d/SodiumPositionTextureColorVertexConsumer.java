package net.labymod.v1_19_4.client.gfx.pipeline.blaze3d;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/gfx/pipeline/blaze3d/SodiumPositionTextureColorVertexConsumer.class */
public class SodiumPositionTextureColorVertexConsumer extends Blaze3DVertexProvider implements ehi, VertexBufferWriter {
    ...
    public ehi a(double x, double y, double z) {
        this.current = new Blaze3DVertex((float) x, (float) y, (float) z);
        return this;
    }

    public ehi a(int red, int green, int blue, int alpha) {
        this.current.setArgb(red, green, blue, alpha);
        return this;
    }

    public ehi a(float u, float v) {
        this.current.setUv(u, v);
        return this;
    }

    public ehi a(int i, int i1) {
        return this;
    }

    public ehi b(int var1, int var2) {
        return this;
    }

    public ehi b(float var1, float var2, float var3) {
        return this;
    }
