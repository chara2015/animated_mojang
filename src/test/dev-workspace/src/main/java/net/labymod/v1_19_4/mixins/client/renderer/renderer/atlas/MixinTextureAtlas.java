...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/renderer/renderer/atlas/MixinTextureAtlas.class */
@Mixin({ftb.class})
public abstract class MixinTextureAtlas implements TextureAtlas {
    ...
    @Shadow
    public abstract ftc a(add addVar);
    ...
    public TextureSprite findSprite(ResourceLocation location) {
        TextureSprite textureSpriteA = a((add) location.getMinecraftLocation());
