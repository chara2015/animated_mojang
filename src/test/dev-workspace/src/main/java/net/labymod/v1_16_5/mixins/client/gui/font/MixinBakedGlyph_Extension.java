...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/mixins/client/gui/font/MixinBakedGlyph_Extension.class */
@Mixin({dmz.class})
public class MixinBakedGlyph_Extension implements BakedGlyphExtension {
    ...
    @Override // net.labymod.v1_16_5.client.gfx.pipeline.renderer.text.BakedGlyphExtension
