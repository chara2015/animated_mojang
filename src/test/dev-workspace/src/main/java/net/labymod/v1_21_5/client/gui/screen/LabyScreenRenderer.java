...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends fzq implements FileDropHandler, LabyScreenAccessor {
    private final VanillaLabyScreen screen;

    public LabyScreenRenderer(LabyScreen screen) {
        super((xg) Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull ftk graphics, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(ftk graphics, int mouseX, int mouseY, float tickDelta) {
        Stack stack = graphics.c().stack();
    ...
    public void a(@NotNull fqq mc, int width, int height) {
        this.screen.pushCustomFontStack();
