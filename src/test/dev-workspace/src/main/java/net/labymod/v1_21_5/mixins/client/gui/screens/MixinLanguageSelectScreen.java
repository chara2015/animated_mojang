...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/gui/screens/MixinLanguageSelectScreen.class */
@Mixin({gcs.class})
public class MixinLanguageSelectScreen {
    ...
    private boolean labyMod$fasterLanguageReload(fqq instance) {
