...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({eql.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(edw instance, dtm poseStack, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
