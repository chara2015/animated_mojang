...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<ghd> getTabs();

    ghe getTabManager();

    VersionedTab versionedTabOf(ghd ghdVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gui/TabNavigationBarAccessor$VersionedTab.class */
    public static class VersionedTab extends ComponentTab {
        ...
        private final ghd tab;

        public VersionedTab(ghd tab) {
            this.tab = tab;
        }

        @Override // net.labymod.api.client.gui.screen.widget.widgets.navigation.tab.ComponentTab
        public Component createComponent() {
            return COMPONENT_MAPPER.fromMinecraftComponent(this.tab.b());
        }
