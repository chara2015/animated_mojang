...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/resources/MixinResourceLocation.class */
@Mixin({acq.class})
...
public abstract class MixinResourceLocation implements ResourceLocation {
    ...
    public InputStream openStream() throws IOException {
        ...
        return ((akv) enn.N().Y().getResource((acq) getMinecraftLocation()).orElseThrow(IOException::new)).d();
    }

    @Override // net.labymod.api.client.resources.ResourceLocation
    public boolean exists() {
        return ResourcesUtil.hasResource((ResourceLocation) getMinecraftLocation()) || enn.N().Y().getResource((acq) getMinecraftLocation()).isPresent();
    }
