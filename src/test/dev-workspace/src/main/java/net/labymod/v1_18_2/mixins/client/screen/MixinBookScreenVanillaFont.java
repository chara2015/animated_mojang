...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/screen/MixinBookScreenVanillaFont.class */
@Mixin({efa.class, eez.class})
public class MixinBookScreenVanillaFont {
    @Insert(method = {"render"}, at = @At("HEAD"))
    public void labyMod$enableVanillaFont(dtm stack, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
    ...
    public void labyMod$resetFont(dtm stack, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        RenderAttributesStack renderAttributesStack = renderAttributesStack();
