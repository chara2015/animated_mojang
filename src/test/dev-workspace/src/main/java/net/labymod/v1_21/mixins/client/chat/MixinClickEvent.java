...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/chat/MixinClickEvent.class */
@Mixin({wx.class})
...
public abstract class MixinClickEvent implements ClickEvent {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21.mixins.client.chat.MixinClickEvent$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/chat/MixinClickEvent$1.class */
