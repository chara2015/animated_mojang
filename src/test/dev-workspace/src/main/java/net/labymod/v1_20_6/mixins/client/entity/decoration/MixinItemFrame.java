package net.labymod.v1_20_6.mixins.client.entity.decoration;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/entity/decoration/MixinItemFrame.class */
@Mixin({cjc.class})
...
public abstract class MixinItemFrame extends MixinEntity implements ItemFrame {
    ...
    public ResourceLocation getFrameType() {
        return ItemUtil.getFrameType(this instanceof cja);
    }
}
