...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/client/screen/MixinGuiScreenWidgetWatcher.class */
@Mixin({axu.class})
public abstract class MixinGuiScreenWidgetWatcher {
    @Shadow
    protected abstract void a(avs avsVar);
    ...
    private void labyMod$watchWidget(axu instance, avs button) {
