...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/gui/screen/widget/converter/TabLayoutConverter.class */
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<ezj, AbstractWidget<?>> {
    ...
    public /* bridge */ /* synthetic */ void update(Object obj, AbstractWidget abstractWidget, @NotNull WidgetReplacementStrategy widgetReplacementStrategy) {
        update((ezj) obj, (AbstractWidget<?>) abstractWidget, widgetReplacementStrategy);
    }
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public AbstractWidget<?> createDefault(ezj source) {
        TabNavigationBarAccessor accessor = (TabNavigationBarAccessor) source;
        ezi tabManager = accessor.getTabManager();
        ezh currentTab = tabManager.a();
    ...
    public void update(ezj source, AbstractWidget<?> destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
