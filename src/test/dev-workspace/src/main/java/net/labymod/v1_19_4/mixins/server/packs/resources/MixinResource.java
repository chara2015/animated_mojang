...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/server/packs/resources/MixinResource.class */
@Mixin({alf.class})
public class MixinResource {
    ...
    private ajv labyMod$unwrapPackResources(alf instance, Operation<ajv> original) {
        return PackUtil.unwrap((ajv) original.call(new Object[]{instance}));
    }
}
