...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/ModelWidgetBaseScalePropertyValueAccessor.class */
public final class ModelWidgetBaseScalePropertyValueAccessor implements PropertyValueAccessor<ModelWidget, Float, Float> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(ModelWidget widget) {
        return widget.baseScale();
    }
