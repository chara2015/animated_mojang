...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({fzg.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(fzq screen, ftk graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
