...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gui/screen/VersionedScreenWrapperFactory.class */
@Singleton
...
public class VersionedScreenWrapperFactory implements ScreenWrapper.Factory {
    ...
    public ScreenWrapper create(Object vanillaScreen) {
        if (!(vanillaScreen instanceof fum)) {
            throw new IllegalArgumentException(vanillaScreen.getClass().getName() + " is not an instance of " + fum.class.getName());
        }
        fum screen = (fum) vanillaScreen;
