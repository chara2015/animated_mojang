...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/gui/components/MixinAbstractSelectionListScrollbar.class */
@Mixin({foa.class})
public abstract class MixinAbstractSelectionListScrollbar extends fnx {
    ...
    public MixinAbstractSelectionListScrollbar(int $$0, int $$1, int $$2, int $$3, xv $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(foa instance) {
        ...
        int x = q();
        Bounds scrollBar = new PositionedBounds(x, E(), x + 6, G());
        float scrollBarHeight = scrollBar.getHeight();
        int contentHeight = l() - this.f;
