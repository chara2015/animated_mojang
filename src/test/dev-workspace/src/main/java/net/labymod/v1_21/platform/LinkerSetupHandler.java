...
import net.labymod.v1_21.laby3d.pipeline.MinecraftRenderState;
import net.labymod.v1_21.laby3d.pipeline.MinecraftRenderStates;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/platform/LinkerSetupHandler.class */
