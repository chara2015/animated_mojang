...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/gui/components/MixinImageButton.class */
@Mixin({fos.class})
public abstract class MixinImageButton extends MixinAbstractButton implements ImageButtonAccessor {
    ...
    @Override // net.labymod.v1_21_3.mixins.client.gui.components.MixinAbstractButton
