...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/resetters/MainOverlayWidgetLssPropertyResetter.class */
public class MainOverlayWidgetLssPropertyResetter extends AbstractWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof MainOverlayWidget) {
        }
        super.reset(widget);
    }
}
