...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gui/screen/widget/converter/ButtonConverter.class */
public class ButtonConverter extends AbstractMinecraftWidgetConverter<avs, ButtonWidget> {
    ...
    public ButtonWidget createDefault(avs source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(avs source, ButtonWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gui/screen/widget/converter/ButtonConverter$GuiButtonLanguageMapper.class */
    static class GuiButtonLanguageMapper implements Mapper<avs, ButtonWidget> {
        ...
        public ButtonWidget map(avs source) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gui/screen/widget/converter/ButtonConverter$GuiLockIconButtonMapper.class */
