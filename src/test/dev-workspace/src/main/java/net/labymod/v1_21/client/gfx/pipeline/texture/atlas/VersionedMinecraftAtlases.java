package net.labymod.v1_21.client.gfx.pipeline.texture.atlas;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/gfx/pipeline/texture/atlas/VersionedMinecraftAtlases.class */
@Singleton
...
public class VersionedMinecraftAtlases implements MinecraftAtlases {
    ...
    public TextureAtlas getGuiAtlas() {
        TextureAtlasHolderAccessor accessor = fgo.Q().aG();
