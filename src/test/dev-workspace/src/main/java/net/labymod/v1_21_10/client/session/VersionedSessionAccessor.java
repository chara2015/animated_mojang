package net.labymod.v1_21_10.client.session;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<gal> {
    ...
    public gal toGameSession(Session session) {
        return (gal) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(gal gameSession) {
        if (gameSession == null) {
            return null;
        }
