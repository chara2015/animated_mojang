package net.labymod.v1_20_1.mixins.client.gui.components.tabs;
...
import net.labymod.v1_20_1.client.gui.TabNavigationBarAccessor;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/mixins/client/gui/components/tabs/MixinTabNavigationBar.class */
@Mixin({erb.class})
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends eqr implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor {
    private final WidgetWatcher<T> watcher = new WidgetWatcher<>();
    private final Map<eqz, TabNavigationBarAccessor.VersionedTab> versionedTabs = new HashMap();

    @Shadow
    @Final
    private ImmutableList<eqz> i;

    @Shadow
    @Final
    private era h;
    private eqz labyMod$currentTab;

    @Override // net.labymod.v1_20_1.client.gui.TabNavigationBarAccessor
    public ImmutableList<eqz> getTabs() {
        return this.i;
    }

    @Override // net.labymod.v1_20_1.client.gui.TabNavigationBarAccessor
    public era getTabManager() {
        return this.h;
    }
    ...
    @Override // net.labymod.v1_20_1.client.gui.TabNavigationBarAccessor
    public TabNavigationBarAccessor.VersionedTab versionedTabOf(eqz tab) {
