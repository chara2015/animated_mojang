...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/gui/screen/VersionedScreenWrapperFactory.class */
@Singleton
...
public class VersionedScreenWrapperFactory implements ScreenWrapper.Factory {
    ...
    public ScreenWrapper create(Object vanillaScreen) {
        if (!(vanillaScreen instanceof blk)) {
            throw new IllegalArgumentException(vanillaScreen.getClass().getName() + " is not an instance of " + blk.class.getName());
        }
        blk screen = (blk) vanillaScreen;
