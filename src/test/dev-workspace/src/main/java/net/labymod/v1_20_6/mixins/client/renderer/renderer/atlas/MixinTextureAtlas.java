...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/client/renderer/renderer/atlas/MixinTextureAtlas.class */
@Mixin({gpa.class})
public abstract class MixinTextureAtlas implements TextureAtlas {
    ...
    @Shadow
    public abstract gpb a(alf alfVar);
    ...
    public TextureSprite findSprite(ResourceLocation location) {
        TextureSprite textureSpriteA = a((alf) location.getMinecraftLocation());
