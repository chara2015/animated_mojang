...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/renderer/entity/MixinItemRenderer.class */
@Mixin({esv.class})
...
public abstract class MixinItemRenderer implements ItemStackRenderer {
    @Shadow
    public abstract void a(dwl dwlVar, bqq bqqVar, int i, int i2);

    @Shadow
    public abstract void c(bqq bqqVar, int i, int i2);
    ...
    public void renderItemStack(Stack stack, ItemStack itemStack, int x, int y, boolean decorate, float alpha) {
        bqq minecraftItemStack = MinecraftUtil.toMinecraft(itemStack);
        ...
        if (decorate) {
            a(dvp.C().h, minecraftItemStack, x, y);
        }
        modelViewStack.pop();
        RenderSystem.applyModelViewMatrix();
    }
