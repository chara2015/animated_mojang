...
import net.labymod.autogen.core.lss.properties.resetters.GlobalSettingWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/GlobalSettingWidgetDirectPropertyValueAccessor.class */
public class GlobalSettingWidgetDirectPropertyValueAccessor extends HorizontalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter GlobalSettingWidgetResetter = new GlobalSettingWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.GlobalSettingWidgetResetter;
    }
}
