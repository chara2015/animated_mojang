...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/DivWidgetDirectPropertyValueAccessor.class */
public class DivWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter DivWidgetResetter = new DivWidgetLssPropertyResetter();
