...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/TileWidgetDirectPropertyValueAccessor.class */
public class TileWidgetDirectPropertyValueAccessor extends WrappedWidgetDirectPropertyValueAccessor {
    LssPropertyResetter TileWidgetResetter = new TileWidgetLssPropertyResetter();
