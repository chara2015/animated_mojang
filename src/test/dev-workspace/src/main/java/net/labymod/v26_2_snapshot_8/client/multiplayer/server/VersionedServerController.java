package net.labymod.v26_2_snapshot_8.client.multiplayer.server;
...
import net.labymod.v26_2_snapshot_8.client.multiplayer.server.storage.VersionedServerList;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/multiplayer/server/VersionedServerController.class */
@Singleton
...
public class VersionedServerController extends DefaultAbstractServerController {
    ...
    public void leaveServer() {
        ...
        minecraft.gui.setScreen(display);
    }
    ...
    public void joinServer(@NotNull JoinServerRequest request) {
        ...
        if (Minecraft.getInstance().gui.screen() instanceof DisconnectedScreen) {
    ...
    public boolean isOfflineMode() {
        ...
        ClientPacketListener connection = Minecraft.getInstance().getConnection();
        return connection == null || !connection.getConnection().isSecureTransport();
    }
