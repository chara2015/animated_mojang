...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/ColorPickerSelectorWidgetDirectPropertyValueAccessor.class */
public class ColorPickerSelectorWidgetDirectPropertyValueAccessor extends AbstractWidgetDirectPropertyValueAccessor {
    LssPropertyResetter ColorPickerSelectorWidgetResetter = new ColorPickerSelectorWidgetLssPropertyResetter();
