...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({bib.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(buq instance, float lvt_1_1_, long lvt_2_1_, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(bib instance, Operation<Void> original) {
