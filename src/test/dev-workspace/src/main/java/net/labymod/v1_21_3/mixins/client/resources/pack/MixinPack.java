package net.labymod.v1_21_3.mixins.client.resources.pack;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/resources/pack/MixinPack.class */
@Mixin({avd.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_3.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[ave.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[ave.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[ave.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[ave.c.ordinal()] = 3;
    ...
    private Icon labymod4$loadPackIcon() {
        ...
        LabyExecutors.executeBackgroundTask(() -> {
            try {
                aug resources = f();
                try {
                    avn<InputStream> rootResource = resources.a(new String[]{"pack.png"});
