package net.labymod.v1_19_4.mixins.authlib;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/authlib/MixinYggdrasilMinecraftSessionService.class */
...
public abstract class MixinYggdrasilMinecraftSessionService {
    ...
    @Overwrite
    public void joinServer(GameProfile profile, String authenticationToken, String serverId) throws InsufficientPrivilegesException, AuthenticationException, InvalidCredentialsException, AuthenticationUnavailableException, UserBannedException {
        try {
