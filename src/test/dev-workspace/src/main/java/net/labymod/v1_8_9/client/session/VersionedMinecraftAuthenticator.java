...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/session/VersionedMinecraftAuthenticator.class */
@Singleton
...
public class VersionedMinecraftAuthenticator extends DefaultsAbstractMinecraftAuthenticator {
    ...
    public VersionedMinecraftAuthenticator() {
        ...
        YggdrasilAuthenticationService yggdrasilAuthenticationServiceAa = ave.A().aa();
        if (yggdrasilAuthenticationServiceAa instanceof YggdrasilAuthenticationService) {
            yggdrasilAuthenticationService = yggdrasilAuthenticationServiceAa;
        } else {
