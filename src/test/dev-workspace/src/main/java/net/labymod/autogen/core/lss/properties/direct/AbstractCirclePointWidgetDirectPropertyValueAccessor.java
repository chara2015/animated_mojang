...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/AbstractCirclePointWidgetDirectPropertyValueAccessor.class */
public class AbstractCirclePointWidgetDirectPropertyValueAccessor extends AbstractWidgetDirectPropertyValueAccessor {
    LssPropertyResetter AbstractCirclePointWidgetResetter = new AbstractCirclePointWidgetLssPropertyResetter();
