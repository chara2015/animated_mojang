package net.labymod.v1_21.laby3d.render.buffer;
...
import net.labymod.v1_21.laby3d.buffer.VersionedGameVertexConsumer;
import net.labymod.v1_21.laby3d.pipeline.RenderTypeResolver;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/laby3d/render/buffer/VersionedRenderBufferSource.class */
@Singleton
