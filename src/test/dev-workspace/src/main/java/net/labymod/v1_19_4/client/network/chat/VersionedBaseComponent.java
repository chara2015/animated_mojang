...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/network/chat/VersionedBaseComponent.class */
public abstract class VersionedBaseComponent<T extends Component, C> implements BaseComponent<T> {
    public final tw holder;

    public VersionedBaseComponent(tw holder) {
        this.holder = holder;
    }
    ...
    public T copy() {
        return this.holder.e().getLabyComponent();
    }

    @Override // net.labymod.api.client.component.BaseComponent, net.labymod.api.client.component.Component
    public T style(Style style) {
        this.holder.b((uf) style);
        return this;
    }
