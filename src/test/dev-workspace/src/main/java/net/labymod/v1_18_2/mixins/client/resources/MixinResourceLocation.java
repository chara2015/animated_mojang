...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/mixins/client/resources/MixinResourceLocation.class */
@Mixin({yt.class})
...
public abstract class MixinResourceLocation implements ResourceLocation {
    ...
    public InputStream openStream() throws IOException {
        ...
        return dyr.D().N().getResource((yt) getMinecraftLocation()).b();
    }

    @Override // net.labymod.api.client.resources.ResourceLocation
    public boolean exists() {
        return ResourcesUtil.hasResource((ResourceLocation) getMinecraftLocation()) || dyr.D().N().a((yt) getMinecraftLocation());
    }
