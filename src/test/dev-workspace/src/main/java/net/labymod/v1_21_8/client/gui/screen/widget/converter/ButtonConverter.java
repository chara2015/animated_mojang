...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/screen/widget/converter/ButtonConverter.class */
public class ButtonConverter extends AbstractMinecraftWidgetConverter<fxe, ButtonWidget> {
    ...
    public ButtonWidget createDefault(fxe source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(fxe source, ButtonWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public String getWidgetId(fxe source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.A());
    }

    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public List<String> getWidgetIds(fxe source) {
        return this.componentMapper.getTranslationKeysOfComponent(source.A());
    }

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/screen/widget/converter/ButtonConverter$ImageButtonMapper.class */
    class ImageButtonMapper implements Mapper<fxe, ButtonWidget> {
        ImageButtonMapper() {
        }

        @Override // net.labymod.api.util.function.Mapper
        public ButtonWidget map(fxe source) {
            if (!(source instanceof fya)) {
                return null;
            }
            ImageButtonAccessor accessor = (fya) source;
            ResourceLocation location = accessor.getResourceLocation();
            Icon icon = Icon.sprite(location, accessor.getXTexStart(), accessor.getYTexStart(), source.z(), source.y(), accessor.getTextureWidth(), accessor.getTextureHeight());
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper.class */
    class LockIconButtonMapper implements Mapper<fxe, ButtonWidget> {
        ...
        public ButtonWidget map(fxe source) {
            ...
            if (!(source instanceof fyf)) {
                return null;
            }
            fyf lockIconButton = (fyf) source;
            source.z();
        ...
        /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/gui/screen/widget/converter/ButtonConverter$LockIconButtonMapper$LockIconSprite.class */
        enum LockIconSprite {
