...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/IconWidgetCleanupOnDisposePropertyValueAccessor.class */
public final class IconWidgetCleanupOnDisposePropertyValueAccessor implements PropertyValueAccessor<IconWidget, Boolean, Boolean> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(IconWidget widget) {
        return widget.cleanupOnDispose();
    }
