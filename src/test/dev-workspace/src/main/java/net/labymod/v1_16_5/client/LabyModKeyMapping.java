...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends djw {
    private static final Function<Hotkey, djw> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        djw labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static djw create(Hotkey hotkey) {
