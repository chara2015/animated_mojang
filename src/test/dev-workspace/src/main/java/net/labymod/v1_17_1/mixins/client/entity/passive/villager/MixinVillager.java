package net.labymod.v1_17_1.mixins.client.entity.passive.villager;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/entity/passive/villager/MixinVillager.class */
@Mixin({bjr.class})
public abstract class MixinVillager implements Villager {
    @Shadow
    public abstract bjs fH();
