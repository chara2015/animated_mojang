...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/screen/VersionedScreenWrapper.class */
public class VersionedScreenWrapper implements ScreenWrapper {
    ...
    public VersionedScreenWrapper(fzq screen) {
        if (screen == null) {
    ...
    public void render(ScreenContext context) {
        this.graphics.setPose((fld) context.stack().getProvider().getPoseStack());
