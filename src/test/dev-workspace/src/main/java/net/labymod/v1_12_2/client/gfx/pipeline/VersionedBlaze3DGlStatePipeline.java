...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/gfx/pipeline/VersionedBlaze3DGlStatePipeline.class */
@Singleton
...
public final class VersionedBlaze3DGlStatePipeline extends AbstractBlaze3DGlStatePipeline implements Blaze3DGlStatePipeline {
    ...
    public void bindTexture(DeviceTextureView textureView) {
        ShaderTextures.setShaderTexture(bus.q, textureView);
        bus.i(textureView.texture().getId());
    }
}
