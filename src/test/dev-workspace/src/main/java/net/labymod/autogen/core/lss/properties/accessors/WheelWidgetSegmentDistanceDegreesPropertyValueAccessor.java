...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/accessors/WheelWidgetSegmentDistanceDegreesPropertyValueAccessor.class */
public final class WheelWidgetSegmentDistanceDegreesPropertyValueAccessor implements PropertyValueAccessor<WheelWidget, Float, Float> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(WheelWidget widget) {
        return widget.segmentDistanceDegrees();
    }
