...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/render/matrix/VersionedStackProvider.class */
public final class VersionedStackProvider extends AbstractStackProvider<ffv, Matrix3f, Matrix4f> {
    public VersionedStackProvider(ffv poseStack) {
        super(poseStack, () -> {
    ...
    public void rotate(float angle, float x, float y, float z) {
        ...
        ((ffv) this.stack).a((Quaternionf) MAPPER.toQuaternion(ROTATION_VECTOR.rotationDegrees(angle)));
    }

    @Override // net.labymod.api.client.render.matrix.StackProvider
    public void rotateRadians(float radians, float x, float y, float z) {
        ROTATION_VECTOR.set(x, y, z);
        ((ffv) this.stack).a((Quaternionf) MAPPER.toQuaternion(ROTATION_VECTOR.rotation(radians)));
    }
