...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({fip.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(bzm entity, fis position, InsertInfo info) {
