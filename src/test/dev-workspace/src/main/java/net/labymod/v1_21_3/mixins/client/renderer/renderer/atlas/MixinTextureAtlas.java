...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/renderer/renderer/atlas/MixinTextureAtlas.class */
@Mixin({hbk.class})
public abstract class MixinTextureAtlas implements TextureAtlas {
    ...
    @Shadow
    public abstract hbl a(alz alzVar);
    ...
    public TextureSprite findSprite(ResourceLocation location) {
        TextureSprite textureSpriteA = a((alz) location.getMinecraftLocation());
