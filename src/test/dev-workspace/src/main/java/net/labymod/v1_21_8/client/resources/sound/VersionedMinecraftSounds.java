package net.labymod.v1_21_8.client.resources.sound;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/resources/sound/VersionedMinecraftSounds.class */
@Singleton
...
public class VersionedMinecraftSounds implements MinecraftSounds {
    ...
    public void playChatFilterSound() {
        fue.R().al().a(hvm.a(ayz.tk, 1.0f));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch) {
        playSound(hvm.a(ayy.a((ame) location.getMinecraftLocation(), 16.0f), pitch, volume));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch, FloatVector3 position) {
        playSound(new hvm((ame) location.getMinecraftLocation(), aza.a, volume, pitch, hvr.t(), false, 0, a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    ...
    private void playSound(hvm sound) {
        sound.a(fue.R().al());
        fue.R().al().a(sound);
    }
}
