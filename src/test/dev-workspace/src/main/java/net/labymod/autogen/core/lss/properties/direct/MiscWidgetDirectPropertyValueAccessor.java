...
import net.labymod.autogen.core.lss.properties.resetters.MiscWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/MiscWidgetDirectPropertyValueAccessor.class */
public class MiscWidgetDirectPropertyValueAccessor extends HorizontalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter MiscWidgetResetter = new MiscWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.MiscWidgetResetter;
    }
}
