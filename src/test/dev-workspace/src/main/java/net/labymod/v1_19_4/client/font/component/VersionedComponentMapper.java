...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/client/font/component/VersionedComponentMapper.class */
...
public class VersionedComponentMapper implements ComponentMapper {
    ...
    public String getTranslationKeyOfComponent(Object minecraftComponent) {
        if (minecraftComponent instanceof tj) {
            tj component = (tj) minecraftComponent;
            ut utVarB = component.b();
            if (utVarB instanceof ut) {
                return utVarB.a();
            }
            return null;
        }
