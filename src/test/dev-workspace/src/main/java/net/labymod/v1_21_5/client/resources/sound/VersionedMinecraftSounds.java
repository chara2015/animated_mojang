package net.labymod.v1_21_5.client.resources.sound;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/resources/sound/VersionedMinecraftSounds.class */
@Singleton
...
public class VersionedMinecraftSounds implements MinecraftSounds {
    ...
    public void playChatFilterSound() {
        fqq.Q().ak().a(hoi.a(awy.sK, 1.0f));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch) {
        playSound(hoi.a(awx.a((alr) location.getMinecraftLocation(), 16.0f), pitch, volume));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch, FloatVector3 position) {
        playSound(new hoi((alr) location.getMinecraftLocation(), awz.a, volume, pitch, hon.t(), false, 0, a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    ...
    private void playSound(hoi sound) {
        sound.a(fqq.Q().ak());
        fqq.Q().ak().a(sound);
    }
}
