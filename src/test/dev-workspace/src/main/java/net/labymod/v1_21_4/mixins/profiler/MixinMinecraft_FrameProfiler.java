package net.labymod.v1_21_4.mixins.profiler;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/profiler/MixinMinecraft_FrameProfiler.class */
@Mixin({flk.class})
public class MixinMinecraft_FrameProfiler {
    ...
    private void labyMod$frameProfiler$render(glq instance, fla $$0, boolean $$1, Operation<Void> original) {
    ...
    private void labyMod$frameProfiler$tick(flk instance, Operation<Void> original) {
