...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/server/VersionedIntegratedServer.class */
@Singleton
...
public class VersionedIntegratedServer extends AbstractIntegratedServer {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21.server.VersionedIntegratedServer$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/server/VersionedIntegratedServer$1.class */
