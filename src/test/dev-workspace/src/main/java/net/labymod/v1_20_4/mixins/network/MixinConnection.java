package net.labymod.v1_20_4.mixins.network;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/network/MixinConnection.class */
@Mixin({ug.class})
...
public abstract class MixinConnection implements NettyConnection {
    ...
    public vf labyMod4$modifyReason(vf component) {
        ...
        return (vf) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY))).reason());
    }
}
