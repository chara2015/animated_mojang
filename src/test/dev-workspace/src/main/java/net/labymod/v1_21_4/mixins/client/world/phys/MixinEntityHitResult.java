...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({fay.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(bum entity, fbb position, InsertInfo info) {
