...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/component/VersionedIconContents.class */
public class VersionedIconContents implements yi {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull zf style) {
