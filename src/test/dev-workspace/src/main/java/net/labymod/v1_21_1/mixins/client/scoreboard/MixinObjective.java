...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/scoreboard/MixinObjective.class */
@Mixin({exy.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_1.mixins.client.scoreboard.MixinObjective$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        eye scoreAccess = this.a.c(eyf.c(entry), (exy) this);
    ...
    public ScoreboardScore getScore(@NotNull String entry) {
        eyc scoreInfo = this.a.d(eyf.c(entry), (exy) this);
        if (scoreInfo == null) {
            return null;
        }
