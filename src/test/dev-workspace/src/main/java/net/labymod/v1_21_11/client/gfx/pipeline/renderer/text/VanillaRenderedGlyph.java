...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/gfx/pipeline/renderer/text/VanillaRenderedGlyph.class */
public class VanillaRenderedGlyph implements StyledGlyphRenderable {
    private final gnz renderable;
    private final RenderState renderState;

    public VanillaRenderedGlyph(gnz renderable) {
        this.renderable = renderable;
        this.renderState = FontRenderStates.resolve(TextDrawMode.NORMAL, VanillaGlyphUtil.isColored(renderable.f()));
    }
    ...
    public DeviceTextureView textureView() {
        return (DeviceTextureView) CastUtil.requireInstanceOf(this.renderable.g(), DeviceTextureView.class);
    }
    ...
    public Style style() {
        a aVar = this.renderable;
        if (aVar instanceof a) {
            a styled = aVar;
            return (Style) CastUtil.cast(styled.a());
        }
        return Style.EMPTY;
    }
}
