...
import net.labymod.v1_21_8.client.component.VersionedIconContents;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/network/chat/VersionedIconComponent.class */
public class VersionedIconComponent extends VersionedBaseComponent<IconComponent, VersionedIconContents> implements IconComponent {
    public VersionedIconComponent(yc holder) {
        super(holder);
    }
