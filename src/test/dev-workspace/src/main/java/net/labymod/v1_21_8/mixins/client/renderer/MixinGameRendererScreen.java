...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({gxb.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(get instance, fxb graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
