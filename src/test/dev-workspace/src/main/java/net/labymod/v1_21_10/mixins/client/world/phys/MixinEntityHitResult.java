...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/world/phys/MixinEntityHitResult.class */
@Mixin({foe.class})
public abstract class MixinEntityHitResult extends MixinHitResult implements EntityHitResult {
    ...
    private void createApiEntity(cdv entity, foh position, InsertInfo info) {
