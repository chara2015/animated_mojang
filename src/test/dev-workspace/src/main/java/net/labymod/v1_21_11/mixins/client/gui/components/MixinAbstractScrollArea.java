...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/gui/components/MixinAbstractScrollArea.class */
@Mixin({gix.class})
public abstract class MixinAbstractScrollArea extends gjc {
    @Shadow
    ...
    public MixinAbstractScrollArea(int $$0, int $$1, int $$2, int $$3, yh $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(gix instance, Operation<Boolean> original) {
        int maxScroll = instance.j();
        if (maxScroll <= 0) {
            return false;
        }
        ...
        int x = m();
        Bounds scrollBar = new PositionedBounds(x, aU_(), x + 6, F());
        ...
        int scrolled = (((int) h()) * (((int) scrollBarHeight) - scrollButtonHeight)) / maxScroll;
        if (scrolled < 0) {
            scrolled = 0;
        }
