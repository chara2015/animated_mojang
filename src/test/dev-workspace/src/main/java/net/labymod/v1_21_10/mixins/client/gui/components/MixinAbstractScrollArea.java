...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/gui/components/MixinAbstractScrollArea.class */
@Mixin({gdi.class})
public abstract class MixinAbstractScrollArea extends gdn {
    @Shadow
    ...
    public MixinAbstractScrollArea(int $$0, int $$1, int $$2, int $$3, xx $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(gdi instance, Operation<Boolean> original) {
        ...
        int x = m();
        Bounds scrollBar = new PositionedBounds(x, aU_(), x + 6, E());
