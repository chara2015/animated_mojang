package net.labymod.v26_2_snapshot_8.client.overlay;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/overlay/CustomLoadingOverlay.class */
public class CustomLoadingOverlay extends LoadingOverlay {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        Stack apiStack = Stack.create((StackProvider) JomlMatrix3x2fStackProvider.fromGuiGraphics(graphics));
