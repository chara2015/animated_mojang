package net.labymod.v1_8_9.client.gui.screen.key.mapper;

import net.labymod.api.client.gui.screen.key.Key;
import net.labymod.core.client.gui.screen.key.mapper.DefaultKey;
import org.lwjgl.glfw.GLFW;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gui/screen/key/mapper/VersionedKey.class */
public class VersionedKey extends DefaultKey {
    ...
    protected String getKeyName(int keyCode) {
        return GLFW.glfwGetKeyName(getGlfwKeyCode(), -1);
    }
}
