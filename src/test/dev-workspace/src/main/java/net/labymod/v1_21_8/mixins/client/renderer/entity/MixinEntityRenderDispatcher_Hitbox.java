...
import net.labymod.v1_21_8.client.gfx.pipeline.blaze3d.program.LabyRenderType;
import org.joml.Vector3f;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/renderer/entity/MixinEntityRenderDispatcher_Hitbox.class */
@Mixin({hec.class})
public class MixinEntityRenderDispatcher_Hitbox {
    ...
    private gxz labyMod$getRenderType(Operation<gxz> original) {
        ...
        return (gxz) original.call(new Object[0]);
    }
    ...
    private static void labyMod$renderHitbox(fod $$0, fog $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7, float red, float green, float blue, float alpha, Operation<Void> original) {
    ...
    private static void labyMod$renderHitboxViewVector(fod $$0, fog $$1, Vector3f $$2, fis $$3, int $$4, Operation<Void> original) {
        LabyConfig config = Laby.labyAPI().config();
