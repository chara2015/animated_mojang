...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/player/MixinAvatarClientState.class */
@Mixin({gcv.class})
public class MixinAvatarClientState implements ClientAvatarStateAccessor {
    ...
    @Override // net.labymod.v1_21_10.client.player.ClientAvatarStateAccessor
