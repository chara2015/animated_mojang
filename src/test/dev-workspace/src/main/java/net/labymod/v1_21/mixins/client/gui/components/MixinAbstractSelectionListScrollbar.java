package net.labymod.v1_21.mixins.client.gui.components;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/client/gui/components/MixinAbstractSelectionListScrollbar.class */
@Mixin({fih.class})
public abstract class MixinAbstractSelectionListScrollbar extends fie {
    ...
    public MixinAbstractSelectionListScrollbar(int $$0, int $$1, int $$2, int $$3, wz $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(fih instance) {
