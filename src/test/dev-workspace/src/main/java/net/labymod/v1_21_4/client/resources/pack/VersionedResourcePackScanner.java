...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/resources/pack/VersionedResourcePackScanner.class */
@Singleton
...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner {
    ...
    private void scanPack(atc pack, String baseDirectory, a output) {
        pack.a(ate.a, Namespaces.MINECRAFT, baseDirectory, output);
    }

    private Collection<String> collectIgnoredFiles(atc pack) {
        Set<String> ignoredFiles = new HashSet<>();
        for (String namespace : pack.a(ate.a)) {
            auh<InputStream> resource = pack.a(ate.a, akv.a(namespace, "labymod/ignored_files.json"));
            if (resource != null) {
                try {
