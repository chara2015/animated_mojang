...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/scoreboard/MixinObjective.class */
@Mixin({fuj.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        fup scoreAccess = this.a.c(fuq.c(entry), (fuj) this);
    ...
    public ScoreboardScore getScore(@NotNull String entry) {
        fun scoreInfo = this.a.d(fuq.c(entry), (fuj) this);
        if (scoreInfo == null) {
            return null;
        }
