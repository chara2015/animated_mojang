...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_16_5/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<dkm> {
    ...
    public dkm toGameSession(Session session) {
        return (dkm) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(dkm gameSession) {
        if (gameSession == null) {
            return null;
        }
