...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/nbt/MixinListTag.class */
@Mixin({uy.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract void c(int i, vp vpVar);

    @Shadow
    public abstract vp shadow$c(int i);
