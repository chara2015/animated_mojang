...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({gej.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(get screen, fxb graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
