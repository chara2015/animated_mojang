package net.labymod.v26_1_2.client.network.chat.serializer;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1_2/client/network/chat/serializer/VersionedComponentSerializerWrapper.class */
public class VersionedComponentSerializerWrapper implements Serializer, JsonDeserializer<VersionedBaseComponent<?, ?>>, JsonSerializer<Component> {
    ...
    public VersionedBaseComponent<?, ?> m2308deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
