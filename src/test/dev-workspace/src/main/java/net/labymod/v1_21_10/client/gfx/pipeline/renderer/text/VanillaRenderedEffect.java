...
import net.labymod.v1_21_10.client.gfx.pipeline.blaze3d.PositionTextureColorVertexConsumer;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/gfx/pipeline/renderer/text/VanillaRenderedEffect.class */
public class VanillaRenderedEffect implements GlyphRenderable {
    private final gih renderable;
    private final RenderState renderState;

    public VanillaRenderedEffect(gih renderable) {
        this.renderable = renderable;
        this.renderState = FontRenderStates.resolve(TextDrawMode.NORMAL, VanillaGlyphUtil.isColored(renderable.a()));
    }
    ...
    public DeviceTextureView textureView() {
        return (DeviceTextureView) CastUtil.requireInstanceOf(this.renderable.b(), DeviceTextureView.class);
    }
    ...
    public void buildVertices(Matrix4f pose, VertexConsumer consumer, int lightCoords, boolean ignoreDepthOffset, GlyphProperties properties) {
        ...
        this.renderable.a(pose, vertexConsumer, lightCoords, ignoreDepthOffset);
