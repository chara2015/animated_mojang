...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/renderer/feature/MixinItemFeatureRenderer_Events.class */
@Mixin({hys.class})
public class MixinItemFeatureRenderer_Events {
    ...
    private void labyMod$submitItem(b instance, fua poseStack, hgy submitNodeCollector, int lightCoords, int overlayCoords, int outlineColor, Operation<Void> original) {
        ItemStackRenderStateAccessor accessor = (ItemStackRenderStateAccessor) this;
        cew livingEntity = accessor.labyMod$getLivingEntity();
        ...
        dhp itemStack = accessor.labyMod$getItemStack();
        boolean leftHand = accessor.labyMod$isLeftHand();
        dhn displayContext = accessor.labyMod$getItemDisplayContext();
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(Phase phase, fua poseStack, cew livingEntity, dhp itemStack, dhn type, boolean leftHand, int combinedLight) {
