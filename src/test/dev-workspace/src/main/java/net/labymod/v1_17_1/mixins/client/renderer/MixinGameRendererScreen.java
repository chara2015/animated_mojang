...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({enb.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(eaq instance, dql poseStack, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
