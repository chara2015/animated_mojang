...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/GridWidgetIteratePropertyValueAccessor.class */
public final class GridWidgetIteratePropertyValueAccessor implements PropertyValueAccessor<GridWidget, Orientation, Orientation> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(GridWidget widget) {
        return widget.iterate();
    }
