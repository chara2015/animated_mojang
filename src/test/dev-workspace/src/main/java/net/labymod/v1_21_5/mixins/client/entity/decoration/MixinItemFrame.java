...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/entity/decoration/MixinItemFrame.class */
@Mixin({cog.class})
...
public abstract class MixinItemFrame extends MixinEntity implements ItemFrame {
    ...
    public ResourceLocation getFrameType() {
        return ItemUtil.getFrameType(this instanceof coe);
    }
}
