...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/render/model/ModelPartAnimationTransformation.class */
public class ModelPartAnimationTransformation extends Transformation {
    public ModelPartAnimationTransformation(fxc modelPart, Transformation modelPartTransform) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/render/model/ModelPartAnimationTransformation$ModelPartPositionVector.class */
    private static class ModelPartPositionVector extends FloatVector3 {
        ...
        public ModelPartPositionVector(fxc modelPart, FloatVector3 modelPartTranslation) {
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/render/model/ModelPartAnimationTransformation$ModelPartRotationVector.class */
    private static class ModelPartRotationVector extends FloatVector3 {
        private final fxc modelPart;

        public ModelPartRotationVector(fxc modelPart) {
            this.modelPart = modelPart;
        }
