...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/gui/MixinPlayerTabOverlay.class */
@Mixin({ger.class})
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(gdd graphics, int screenWidth, fpn scoreboard, fpf objective, InsertInfo ci) {
