package net.labymod.v26_1_2.mixins.server.packs.resources;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;
import net.labymod.api.client.resources.pack.ResourcePack;
import net.labymod.v26_1_2.client.resources.pack.ModifiedPackResources;
import net.labymod.v26_1_2.client.resources.pack.SilentReloadableResourceManager;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1_2/mixins/server/packs/resources/MixinMultiPackResourceManager.class */
...
public class MixinMultiPackResourceManager implements SilentReloadableResourceManager {
    ...
    @Override // net.labymod.v26_1_2.client.resources.pack.SilentReloadableResourceManager
