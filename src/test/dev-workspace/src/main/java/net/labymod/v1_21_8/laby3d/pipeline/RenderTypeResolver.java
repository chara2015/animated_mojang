...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/laby3d/pipeline/RenderTypeResolver.class */
public final class RenderTypeResolver {
    ...
    private static final Function<LevelMaterial, gxz> DYNAMIC_TYPES = MEMOIZE.memoize(levelMaterial -> {
        d dVar;
        i iVar;
        ...
        a aVarA = b.a().a(new j((ame) ((TextureBinding) levelMaterial.getTextures().get(0)).location().getMinecraftLocation(), false));
        ...
        return gxz.a(renderTypeName, 65536, renderPipeline, aVarA2.a(iVar).a(false));
    });
    ...
    public gxz resolve(Material material) {
