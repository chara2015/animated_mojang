...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/resources/pack/MixinPack.class */
@Mixin({aww.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_8.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[awx.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[awx.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[awx.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[awx.c.ordinal()] = 3;
    ...
    public File labyMod$getFile() {
        avy avyVar = this.c;
        if (avyVar instanceof avy) {
            avy packResources = avyVar;
    ...
    private Icon labymod4$loadPackIcon() {
        ...
        LabyExecutors.executeBackgroundTask(() -> {
            try {
                awb resources = f();
                try {
                    axg<InputStream> rootResource = resources.a(new String[]{"pack.png"});
