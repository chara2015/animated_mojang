...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/gui/components/MixinAbstractScrollArea.class */
@Mixin({fom.class})
public abstract class MixinAbstractScrollArea extends fos {
    ...
    public MixinAbstractScrollArea(int $$0, int $$1, int $$2, int $$3, wp $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(fom instance, Operation<Boolean> original) {
