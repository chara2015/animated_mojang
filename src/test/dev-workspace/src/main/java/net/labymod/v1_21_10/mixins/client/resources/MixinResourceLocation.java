package net.labymod.v1_21_10.mixins.client.resources;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/resources/MixinResourceLocation.class */
@Mixin({amj.class})
...
public abstract class MixinResourceLocation implements ResourceLocation {
    ...
    public InputStream openStream() throws IOException {
        ...
        return ((ban) fzz.W().ai().getResource((amj) getMinecraftLocation()).orElseThrow(IOException::new)).d();
    }

    @Override // net.labymod.api.client.resources.ResourceLocation
    public boolean exists() {
        return ResourcesUtil.hasResource((ResourceLocation) getMinecraftLocation()) || fzz.W().ai().getResource((amj) getMinecraftLocation()).isPresent();
    }
