...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/api/event/labymod/labyconnect/session/chat/LabyConnectChatMessageDeleteEvent.class */
public class LabyConnectChatMessageDeleteEvent extends LabyConnectChatEvent {
    private final ChatMessage message;

    public LabyConnectChatMessageDeleteEvent(LabyConnect api, Chat chat, ChatMessage message) {
        super(api, chat);
