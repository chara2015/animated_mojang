...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/network/chat/VersionedBaseComponent.class */
public abstract class VersionedBaseComponent<T extends Component, C> implements BaseComponent<T> {
    public final ym holder;

    public VersionedBaseComponent(ym holder) {
        this.holder = holder;
    }
    ...
    public T style(Style style) {
        this.holder.b((yv) CastUtil.cast(style));
        return this;
    }
