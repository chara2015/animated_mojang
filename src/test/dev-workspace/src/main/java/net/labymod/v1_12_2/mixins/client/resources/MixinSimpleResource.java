...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/mixins/client/resources/MixinSimpleResource.class */
@Mixin({cew.class})
public class MixinSimpleResource {
    ...
    private void labyMod$transformResourceInputStream(cew resource, InputStream stream) {
