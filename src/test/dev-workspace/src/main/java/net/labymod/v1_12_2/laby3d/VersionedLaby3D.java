...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/laby3d/VersionedLaby3D.class */
@Singleton
...
public class VersionedLaby3D extends Laby3D {
    ...
    public void setupOverlayAndLightingTextures() {
        buq entityRenderer = bib.z().o;
        ShaderTextures.setShaderTexture(1, UnknownGlDeviceTextureView.ofUnknown(caa.j.b()));
    ...
    public DeviceTextureView overlayTextureView() {
        return UnknownGlDeviceTextureView.ofUnknown(caf.j.b());
    }

    @Override // net.labymod.api.laby3d.Laby3D
    @NotNull
    public DeviceTextureView lightTextureView() {
        return TextureViewProvider.cast(bib.z().o).getDeviceTextureView();
    }
}
