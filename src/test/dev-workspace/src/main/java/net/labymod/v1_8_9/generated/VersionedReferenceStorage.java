package net.labymod.v1_8_9.generated;
...
import net.labymod.v1_8_9.client.chat.VersionedChatExecutor;
import net.labymod.v1_8_9.client.chat.VersionedChatModifier;
import net.labymod.v1_8_9.client.client.particle.VersionedParticleController;
import net.labymod.v1_8_9.client.component.VersionedComponentService;
import net.labymod.v1_8_9.client.crash.VersionedGameCrashReportFactory;
import net.labymod.v1_8_9.client.entity.VersionedEntityVisualizer;
import net.labymod.v1_8_9.client.font.component.VersionedComponentMapper;
import net.labymod.v1_8_9.client.gfx.VersionedGFXBridge;
import net.labymod.v1_8_9.client.gfx.pipeline.VersionedBlaze3DGlStatePipeline;
import net.labymod.v1_8_9.client.gfx.pipeline.renderer.text.VanillaFontRenderer;
import net.labymod.v1_8_9.client.gfx.pipeline.renderer.text.VanillaFormattedTextLayoutFactory;
import net.labymod.v1_8_9.client.gfx.pipeline.renderer.text.VersionedVanillaGlyphStorage;
import net.labymod.v1_8_9.client.gui.background.VersionedPanoramaRenderer;
import net.labymod.v1_8_9.client.gui.screen.VersionedScreenWrapperFactory;
import net.labymod.v1_8_9.client.gui.screen.key.mapper.VersionedKeyMapper;
import net.labymod.v1_8_9.client.render.VersionedItemStackVisualizer;
import net.labymod.v1_8_9.client.render.VersionedRenderConstants;
import net.labymod.v1_8_9.client.render.VersionedRenderPipeline;
import net.labymod.v1_8_9.client.render.item.VersionedAnimationTypeMapper;
import net.labymod.v1_8_9.client.render.matrix.VersionedStackProviderFactory;
import net.labymod.v1_8_9.client.resources.VersionedResourceLocationFactory;
import net.labymod.v1_8_9.client.resources.pack.VersionedResourcePackRepository;
import net.labymod.v1_8_9.client.resources.pack.VersionedResourcePackScanner;
import net.labymod.v1_8_9.client.resources.sound.VersionedMinecraftSounds;
import net.labymod.v1_8_9.client.resources.texture.BufferedGameImageProvider;
import net.labymod.v1_8_9.client.resources.texture.VersionedTextureRepository;
import net.labymod.v1_8_9.client.server.VersionedServerController;
import net.labymod.v1_8_9.client.session.VersionedMinecraftAuthenticator;
import net.labymod.v1_8_9.client.session.VersionedSessionAccessor;
import net.labymod.v1_8_9.client.util.VersionedGameMathMapper;
import net.labymod.v1_8_9.client.util.VersionedSystemInfo;
...
import net.labymod.v1_8_9.client.world.block.VersionedBlockColorProvider;
import net.labymod.v1_8_9.client.world.block.VersionedBlocks;
import net.labymod.v1_8_9.client.world.block.properties.VersionedBlockProperties;
import net.labymod.v1_8_9.client.world.item.VersionedItemStackFactory;
import net.labymod.v1_8_9.client.world.lighting.VersionedLightingLayerMapper;
import net.labymod.v1_8_9.client.world.phys.hit.VersionedHitResultController;
import net.labymod.v1_8_9.laby3d.VersionedGameTransformations;
import net.labymod.v1_8_9.laby3d.VersionedLaby3D;
import net.labymod.v1_8_9.laby3d.buffer.VersionedGameBufferProvider;
import net.labymod.v1_8_9.laby3d.util.VersionedDirtyFramebufferClear;
import net.labymod.v1_8_9.mojang.texture.VersionedMojangTextureService;
import net.labymod.v1_8_9.nbt.VersionedNBTFactory;
import net.labymod.v1_8_9.server.VersionedIntegratedServer;
import net.labymod.v1_8_9.server.VersionedServerAddressResolver;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/generated/VersionedReferenceStorage.class */
...
public class VersionedReferenceStorage extends ReferenceStorage implements ReferenceStorageAccessor {
    ...
    private final Reference<BossBarRegistry> bossBarRegistryReference = new SingletonReference(BossBarRegistry.class, () -> {
        return new VersionedBossBarRegistry();
    });
