...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/network/chat/VersionedBaseComponent.class */
public abstract class VersionedBaseComponent<T extends Component, C> implements BaseComponent<T> {
    public final yd holder;

    public VersionedBaseComponent(yd holder) {
        this.holder = holder;
    }
