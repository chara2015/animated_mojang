package net.labymod.v1_21_10.laby3d.pipeline.target;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    private final fsk wrapped;

    public VersionedRenderTarget(fsk wrapped) {
    ...
    public DeviceTextureView findColorTexture(int index) {
        ...
        fsd glTexture = (fsd) CastUtil.requireInstanceOf(colorTexture, fsd.class);
    ...
    public DeviceTextureView findDepthTexture() {
        ...
        fsd glTexture = (fsd) CastUtil.requireInstanceOf(depthTexture, fsd.class);
        return new ExternalGlDeviceTextureView(glTexture.a(), glTexture.getWidth(0), glTexture.getHeight(0));
    }
    ...
    public int getId() {
        frx device = RenderSystem.getDevice();
        ...
        fsd glTexture = (fsd) CastUtil.requireInstanceOf(fboColorTexture, fsd.class);
