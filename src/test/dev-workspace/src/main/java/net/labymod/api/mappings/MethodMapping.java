...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/api/mappings/MethodMapping.class */
public class MethodMapping extends AbstractMapping implements ScopedMapping<ClassMapping> {
    ...
    public MethodMapping(String original, String originalDescriptor, String mapped, String mappedDescriptor) {
