...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/gui/window/VersionedWindow.class */
public class VersionedWindow extends DefaultAbstractWindow {
    ...
    public ScreenWrapper currentScreen() {
        ...
        if (screen != this.currentScreen) {
            ...
            boolean previousScreen = !(screen instanceof dzp);
    ...
    public Object mostInnerScreen() throws TooManyIterationsException {
        return getMostInnerScreen(dvp.C().y);
    }
