...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/chat/contents/MixinKeybindContents.class */
@Mixin({ys.class})
public abstract class MixinKeybindContents implements KeybindContentsAccessor {
    ...
    @Override // net.labymod.v1_21_8.client.network.chat.contents.KeybindContentsAccessor
