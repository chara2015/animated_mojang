...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/FoldingWidgetContentOffsetPropertyValueAccessor.class */
public final class FoldingWidgetContentOffsetPropertyValueAccessor implements PropertyValueAccessor<FoldingWidget, Float, Float> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(FoldingWidget widget) {
