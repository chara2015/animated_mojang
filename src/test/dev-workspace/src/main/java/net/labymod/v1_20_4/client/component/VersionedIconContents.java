...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/component/VersionedIconContents.class */
public class VersionedIconContents implements vg {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull b<T> consumer, @NotNull wc style) {
