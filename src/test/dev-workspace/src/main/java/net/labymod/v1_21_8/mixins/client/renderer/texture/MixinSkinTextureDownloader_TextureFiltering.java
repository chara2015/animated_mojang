...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/renderer/texture/MixinSkinTextureDownloader_TextureFiltering.class */
@Mixin({hrl.class})
public class MixinSkinTextureDownloader_TextureFiltering {
    ...
    private static void labyMod$setTextureFiltering(hru instance, ame $$0, hrc $$1, Operation<Void> original) {
