...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/EntityWidgetEntityScalePropertyValueAccessor.class */
public final class EntityWidgetEntityScalePropertyValueAccessor implements PropertyValueAccessor<EntityWidget, Float, Float> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(EntityWidget widget) {
        return widget.entityScale();
    }
