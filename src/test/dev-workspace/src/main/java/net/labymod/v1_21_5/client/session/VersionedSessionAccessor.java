package net.labymod.v1_21_5.client.session;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<frc> {
    ...
    public frc toGameSession(Session session) {
        return (frc) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(frc gameSession) {
        if (gameSession == null) {
            return null;
        }
