...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/gfx/pipeline/renderer/text/BakedGlyphExtension.class */
public interface BakedGlyphExtension {
    ...
    void labyMod$renderGlyph(GlyphInstance glyphInstance, Matrix4f matrix4f, fae faeVar, int i, boolean z);
