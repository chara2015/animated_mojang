...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/mixins/client/gui/MixinPlayerTabOverlay.class */
@Mixin({gkg.class})
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(gir graphics, int screenWidth, fur scoreboard, fuj objective, InsertInfo ci) {
