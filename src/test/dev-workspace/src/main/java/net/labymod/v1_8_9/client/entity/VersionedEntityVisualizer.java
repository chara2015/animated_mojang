package net.labymod.v1_8_9.client.entity;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/entity/VersionedEntityVisualizer.class */
@Singleton
...
public class VersionedEntityVisualizer implements EntityVisualizer {
    ...
    private void renderEntity(ScreenContext context, Entity entity, Quaternionf cameraOrientation) {
        ...
        renderManager.a((pk) entity, 0.0d, 0.0d, 0.0d, 0.0f, context.getTickDelta(), false);
