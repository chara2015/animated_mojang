...
import net.labymod.v1_21_3.client.resources.texture.VersionedLabyTexture;
import org.jetbrains.annotations.NotNull;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/util/MinecraftUtil.class */
public final class MinecraftUtil {
    ...
    public static Stack obtainStackFromGraphics(fns graphics) {
        return graphics.c().stack();
    }

    public static void obtainScreenContextFromGraphics(fns graphics, Consumer<ScreenContext> callback) {
    ...
    public static void obtainScreenContextFromGraphics(fns graphics, int mouseX, int mouseY, float tickDelta, Consumer<ScreenContext> callback) {
    ...
    public static ItemStack fromMinecraftSlot(bwg entity, LivingEntity.EquipmentSpot spot) {
        return fromMinecraft(entity.a(toMinecraft(spot)));
    }

    public static ItemStack fromMinecraft(cxp itemStack) {
        return (ItemStack) itemStack;
    }

    public static cxp toMinecraft(ItemStack itemStack) {
        return (cxp) itemStack;
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static Direction fromMinecraft(jm direction) throws MatchException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static jm toMinecraft(@NotNull Direction direction) throws MatchException {
        switch (direction) {
            case DOWN:
                return jm.a;
            case UP:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static bvs toMinecraft(LivingEntity.EquipmentSpot spot) throws MatchException {
        switch (spot) {
            case HEAD:
                return bvs.f;
            case CHEST:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static ModelTransformType fromMinecraft(cxn context) throws MatchException {
    ...
    public static ServerType fromMinecraft(gfz data) {
        if (data.e()) {
    ...
    public static void exportScreenshotToFile(ffs image, File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(Player player) {
        gro dispatcher = fmg.Q().aq();
        gwx gwxVarA = dispatcher.a((bvk) player);
        if (!(gwxVarA instanceof gwx)) {
            throw new IllegalStateException("Renderer for the player could not be found");
        }
        gwx playerRenderer = gwxVarA;
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_3.client.util.MinecraftUtil$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/util/MinecraftUtil$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$item$ItemDisplayContext = new int[cxn.values().length];
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.a.ordinal()] = 1;
            } catch (NoSuchFieldError e13) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.b.ordinal()] = 2;
            } catch (NoSuchFieldError e14) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.c.ordinal()] = 3;
            } catch (NoSuchFieldError e15) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.d.ordinal()] = 4;
            } catch (NoSuchFieldError e16) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.e.ordinal()] = 5;
            } catch (NoSuchFieldError e17) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.f.ordinal()] = 6;
            } catch (NoSuchFieldError e18) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.g.ordinal()] = 7;
            } catch (NoSuchFieldError e19) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.h.ordinal()] = 8;
            } catch (NoSuchFieldError e20) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cxn.i.ordinal()] = 9;
            ...
            $SwitchMap$net$minecraft$core$Direction = new int[jm.values().length];
            try {
                $SwitchMap$net$minecraft$core$Direction[jm.a.ordinal()] = 1;
            ...
            try {
                $SwitchMap$net$minecraft$core$Direction[jm.c.ordinal()] = 3;
            } catch (NoSuchFieldError e34) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[jm.d.ordinal()] = 4;
            } catch (NoSuchFieldError e35) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[jm.e.ordinal()] = 5;
            } catch (NoSuchFieldError e36) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[jm.f.ordinal()] = 6;
    ...
    public static CookieStorage fromMinecraft(ggd state) {
        if (state == null) {
            return null;
        }
    ...
    public static ggd toMinecraft(CookieStorage storage) {
        Map<ResourceLocation, byte[]> apiCookies = storage.cookies();
        Map<alz, byte[]> cookies = new HashMap<>(apiCookies.size());
        for (Map.Entry<ResourceLocation, byte[]> entry : apiCookies.entrySet()) {
            cookies.put((alz) entry.getKey().getMinecraftLocation(), entry.getValue());
        }
        return new ggd(cookies);
    }

    public static azq fromText(String text, Style style) {
        us language = us.a();
    ...
    public static haw toMinecraft(Object texture) {
        return TEXTURES.apply(texture);
    }

    public static fns getCurrentGuiGraphics() {
        return currentGuiGraphics;
    }

    public static void setCurrentGuiGraphics(fns currentGuiGraphics2) {
        currentGuiGraphics = currentGuiGraphics2;
    }

    public static bvk unwrapEntity(bvk entity) {
        if (entity instanceof ckr) {
            ckr part = (ckr) entity;
            return part.a;
        }
        return entity;
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/util/MinecraftUtil$LevelRenderContext.class */
    public static class LevelRenderContext {
        ...
        public void setPoseStack(fgs poseStack) {
