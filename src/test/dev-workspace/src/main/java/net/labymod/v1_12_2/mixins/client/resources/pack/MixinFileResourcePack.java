...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/mixins/client/resources/pack/MixinFileResourcePack.class */
@Mixin({cej.class})
            ...
            while (entries.hasMoreElements()) {
                ...
                if (!entry.isDirectory()) {
                    ...
                    if (!name.endsWith(".mcmeta") && name.startsWith(path)) {
                        ...
                        locationConsumer.accept(new nf(namespace, locationPath));
                    }
                }
            }
        } catch (IOException e) {
