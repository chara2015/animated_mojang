...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/gui/font/MixinFontSet_TextureWrapper.class */
@Mixin({dym.class})
public class MixinFontSet_TextureWrapper {
    ...
    private dyn labyMod$addGlyph(ww textureLocation, boolean colored, Operation<dyn> original) {
        dyn fontTexture = (dyn) original.call(new Object[]{textureLocation, Boolean.valueOf(colored)});
