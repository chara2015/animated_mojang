...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/MinecraftLogoWidgetDirectPropertyValueAccessor.class */
public class MinecraftLogoWidgetDirectPropertyValueAccessor extends AbstractWidgetDirectPropertyValueAccessor {
    LssPropertyResetter MinecraftLogoWidgetResetter = new MinecraftLogoWidgetLssPropertyResetter();
