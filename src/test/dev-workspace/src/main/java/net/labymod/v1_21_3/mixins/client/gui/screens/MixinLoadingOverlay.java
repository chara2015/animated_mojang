...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({fto.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(fty screen, fns graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
