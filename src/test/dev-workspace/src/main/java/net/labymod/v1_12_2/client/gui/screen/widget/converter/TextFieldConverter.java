...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/client/gui/screen/widget/converter/TextFieldConverter.class */
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<bje, TextFieldWidget> {
    ...
    public TextFieldWidget createDefault(bje source) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public void update(bje source, TextFieldWidget destination, @NotNull WidgetReplacementStrategy replacementStrategy) {
    ...
    public void updateText(bje mc, AbstractWidget<?> widget) {
    ...
    public void updateText(bje mc, TextFieldWidget widget) {
    ...
    @Override // net.labymod.api.client.gui.screen.widget.converter.AbstractWidgetConverter
    public String getWidgetId(bje source) {
