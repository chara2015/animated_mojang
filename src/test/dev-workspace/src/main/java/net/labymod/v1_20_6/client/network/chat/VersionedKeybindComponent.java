...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/network/chat/VersionedKeybindComponent.class */
public class VersionedKeybindComponent extends VersionedBaseComponent<KeybindComponent, xq> implements KeybindComponent {
    public VersionedKeybindComponent(yd holder) {
        super(holder);
    }

    @Override // net.labymod.api.client.component.KeybindComponent
    public String getKeybind() {
        yt ytVar = (xq) getContents();
        if (ytVar instanceof yt) {
            yt keybind = ytVar;
            return keybind.b();
        }
