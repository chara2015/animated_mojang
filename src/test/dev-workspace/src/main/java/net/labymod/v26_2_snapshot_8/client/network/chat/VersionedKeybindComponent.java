...
import net.labymod.v26_2_snapshot_8.client.network.chat.contents.KeybindContentsAccessor;
import net.minecraft.network.chat.ComponentContents;
import net.minecraft.network.chat.MutableComponent;
import net.minecraft.network.chat.contents.KeybindContents;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/network/chat/VersionedKeybindComponent.class */
