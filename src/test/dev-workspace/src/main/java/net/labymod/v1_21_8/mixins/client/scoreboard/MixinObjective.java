package net.labymod.v1_21_8.mixins.client.scoreboard;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/scoreboard/MixinObjective.class */
@Mixin({fjp.class})
public class MixinObjective implements ScoreboardObjective {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_8.mixins.client.scoreboard.MixinObjective$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/scoreboard/MixinObjective$1.class */
    ...
    public ScoreboardScore getOrCreateScore(@NotNull String entry) {
        fjv scoreAccess = this.a.c(fjw.c(entry), (fjp) this);
    ...
    public ScoreboardScore getScore(@NotNull String entry) {
        fjt scoreInfo = this.a.d(fjw.c(entry), (fjp) this);
        if (scoreInfo == null) {
            return null;
        }
