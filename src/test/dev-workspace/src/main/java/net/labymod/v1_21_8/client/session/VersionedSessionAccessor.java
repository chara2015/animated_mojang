package net.labymod.v1_21_8.client.session;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<fuq> {
    ...
    public fuq toGameSession(Session session) {
        return (fuq) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(fuq gameSession) {
        if (gameSession == null) {
            return null;
        }
