...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/ImageViewerWidgetDirectPropertyValueAccessor.class */
public class ImageViewerWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter ImageViewerWidgetResetter = new ImageViewerWidgetLssPropertyResetter();
