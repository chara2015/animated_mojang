...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/laby3d/pipeline/MinecraftRenderState.class */
public final class MinecraftRenderState {
    ...
    private final Lazy<erd> shaderInstance;

    public MinecraftRenderState(RenderState renderState, dtr vertexFormat, b drawMode, ResourceLocation configId) {
        this(renderState, vertexFormat, drawMode, configId, false);
    }

    public MinecraftRenderState(RenderState renderState, dtr vertexFormat, b drawMode, ResourceLocation configId, boolean affectsCrumbling) {
    ...
    public b create(LevelMaterial material, boolean outline) {
        ...
        Lazy<erd> lazy = this.shaderInstance;
        Objects.requireNonNull(lazy);
        a aVarA3 = aVarA2.a(new l(lazy::get)).a(new m((yt) ((TextureBinding) material.getTextures().get(0)).location().getMinecraftLocation(), false, false));
    ...
    private erd createShaderProgram() {
        try {
            return new LabyShaderInstance(dyr.D().N(), this.configId, getVertexFormat());
        } catch (IOException exception) {
            throw new RuntimeException(exception);
        }
    }

    /* JADX INFO: renamed from: net.labymod.v1_18_2.laby3d.pipeline.MinecraftRenderState$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/laby3d/pipeline/MinecraftRenderState$1.class */
