...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends fum implements FileDropHandler, LabyScreenAccessor {
    private final VanillaLabyScreen screen;

    public LabyScreenRenderer(LabyScreen screen) {
        super((wp) Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull fof graphics, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(fof graphics, int mouseX, int mouseY, float tickDelta) {
        Stack stack = graphics.c().stack();
    ...
    public void a(@NotNull flk mc, int width, int height) {
        this.screen.pushCustomFontStack();
