...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/network/chat/VersionedTranslatableComponent.class */
public class VersionedTranslatableComponent extends VersionedBaseComponent<TranslatableComponent, TranslatableContentsAccessor> implements TranslatableComponent {
    public VersionedTranslatableComponent(tj holder) {
        super(holder);
    }
    ...
    public TranslatableComponent plainCopy() {
        return (TranslatableComponent) sw.b(getKey()).getLabyComponent();
    }
