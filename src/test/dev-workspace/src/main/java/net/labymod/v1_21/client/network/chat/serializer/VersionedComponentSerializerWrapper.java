package net.labymod.v1_21.client.network.chat.serializer;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/client/network/chat/serializer/VersionedComponentSerializerWrapper.class */
public class VersionedComponentSerializerWrapper implements Serializer, JsonDeserializer<VersionedBaseComponent<?, ?>>, JsonSerializer<Component> {
    ...
    public VersionedBaseComponent<?, ?> m1661deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
