...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/resources/pack/rich/VanillaPackDetails.class */
public class VanillaPackDetails implements ResourcePackDetails {
    private final bnk pack;
    private Icon icon = null;

    public VanillaPackDetails(bnk pack) {
        this.pack = pack;
    }
