...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/gui/screens/MixinConnectScreenThread.class */
...
public class MixinConnectScreenThread {
    ...
    private Optional<gtb> labyMod$resolveAddress(gte resolver, gtc address) {
        InetSocketAddress resolved = ConnectAddressResolver.resolve(address.a(), address.b(), this.e);
        return resolved == null ? Optional.empty() : Optional.of(gtb.a(resolved));
    }
    ...
    public xo labyMod$fireServerKickEvent(xo reason) {
        ...
        return (xo) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN))).reason());
    }
}
