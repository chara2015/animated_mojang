...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mixins/client/component/MixinChatComponentScore.class */
@Mixin({ex.class})
...
public abstract class MixinChatComponentScore extends MixinChatComponentStyle<ScoreComponent> implements ScoreComponent {
    ...
    public ScoreboardObjective getScoreboardObjective() {
        MinecraftServer server = MinecraftServer.N();
        if (server != null && server.O()) {
            auo scoreboard = server.a(0).Z();
