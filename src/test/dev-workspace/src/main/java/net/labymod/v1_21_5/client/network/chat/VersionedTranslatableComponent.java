...
import net.labymod.v1_21_5.client.network.chat.contents.TranslatableContentsAccessor;
import org.jetbrains.annotations.Nullable;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/network/chat/VersionedTranslatableComponent.class */
public class VersionedTranslatableComponent extends VersionedBaseComponent<TranslatableComponent, TranslatableContentsAccessor> implements TranslatableComponent {
    public VersionedTranslatableComponent(xu holder) {
        super(holder);
    }
    ...
    public TranslatableComponent plainCopy() {
        return (TranslatableComponent) xg.b(getKey()).getLabyComponent();
    }
