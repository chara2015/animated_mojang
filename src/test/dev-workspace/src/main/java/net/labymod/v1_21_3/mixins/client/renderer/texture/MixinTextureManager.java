...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/mixins/client/renderer/texture/MixinTextureManager.class */
@Mixin({hbm.class})
public abstract class MixinTextureManager implements GameTextureManager {
    ...
    @Shadow
    public abstract void a(alz alzVar, haw hawVar);

    @Override // net.labymod.core.client.resources.texture.GameTextureManager
    public boolean hasResource(ResourceLocation location) {
        return this.c.get((alz) location) != null;
    }

    @Override // net.labymod.core.client.resources.texture.GameTextureManager
    public void registerAndRelease(ResourceLocation location, Object texture) {
        haw textureObject = (haw) CastUtil.requireInstanceOf(MinecraftUtil.toMinecraft(texture), haw.class);
        haw currentTexture = this.c.get((alz) location);
        a((alz) location, textureObject);
