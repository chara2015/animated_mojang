...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/resources/pack/MixinPack.class */
@Mixin({azx.class})
...
public abstract class MixinPack implements ResourcePackDetails {
    ...
    @Shadow
    public abstract azb f();

    @Shadow
    public abstract boolean j();

    @Shadow
    public abstract bab l();
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_10.mixins.client.resources.pack.MixinPack$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/resources/pack/MixinPack$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility = new int[azy.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[azy.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[azy.b.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[azy.c.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$server$packs$repository$PackCompatibility[azy.d.ordinal()] = 4;
    ...
    public File labyMod$getFile() {
        ayy ayyVar = this.c;
        if (ayyVar instanceof ayy) {
            ayy packResources = ayyVar;
    ...
    private Icon labymod4$loadPackIcon() {
        ...
        LabyExecutors.executeBackgroundTask(() -> {
            try {
                azb resources = f();
                try {
                    bah<InputStream> rootResource = resources.a(new String[]{"pack.png"});
