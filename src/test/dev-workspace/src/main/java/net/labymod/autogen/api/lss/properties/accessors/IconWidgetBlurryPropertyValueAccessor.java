...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/accessors/IconWidgetBlurryPropertyValueAccessor.class */
public final class IconWidgetBlurryPropertyValueAccessor implements PropertyValueAccessor<IconWidget, Boolean, Boolean> {
    @Override // net.labymod.api.client.gui.lss.property.PropertyValueAccessor
    public LssProperty getProperty(IconWidget widget) {
        return widget.blurry();
    }
