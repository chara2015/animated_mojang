...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/resources/pack/VersionedResourcePackScanner.class */
@Singleton
...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner {
    ...
    private void scanPack(azb pack, String baseDirectory, a output) {
        pack.a(azd.a, Namespaces.MINECRAFT, baseDirectory, output);
    }

    private Collection<String> collectIgnoredFiles(azb pack) {
        Set<String> ignoredFiles = new HashSet<>();
        for (String namespace : pack.a(azd.a)) {
            bah<InputStream> resource = pack.a(azd.a, amj.a(namespace, "labymod/ignored_files.json"));
            if (resource != null) {
                try {
