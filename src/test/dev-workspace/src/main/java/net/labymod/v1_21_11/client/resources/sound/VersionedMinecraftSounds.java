...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_11/client/resources/sound/VersionedMinecraftSounds.class */
@Singleton
...
public class VersionedMinecraftSounds implements MinecraftSounds {
    ...
    public void playChatFilterSound() {
        gfj.V().ap().a(iph.a(bda.uA, 1.0f));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch) {
        playSound(iph.a(bcz.a((amo) location.getMinecraftLocation(), 16.0f), pitch, volume));
    }

    @Override // net.labymod.api.client.resources.sound.MinecraftSounds
    public void playSound(ResourceLocation location, float volume, float pitch, FloatVector3 position) {
        playSound(new iph((amo) location.getMinecraftLocation(), bdb.a, volume, pitch, ipm.u(), false, 0, a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    ...
    private void playSound(iph sound) {
        sound.a(gfj.V().ap());
        gfj.V().ap().a(sound);
    }
}
