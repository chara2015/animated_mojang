...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/gui/screens/MixinLoadingOverlay.class */
@Mixin({fuc.class})
public class MixinLoadingOverlay {
    ...
    private void labyMod$renderScreen(fum screen, fof graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
