...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/mixins/client/renderer/state/MixinEntityRenderState.class */
...
public class MixinEntityRenderState implements EntityRenderStateAccessor<Entity> {
    ...
    @Override // net.labymod.v26_1.client.util.EntityRenderStateAccessor
