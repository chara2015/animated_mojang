...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_2_snapshot_8/client/chat/VersionedChatModifier.class */
@Singleton
...
public class VersionedChatModifier implements InternalChatModifier {
    ...
    public void fireChatClear(boolean clearHistory) {
        Minecraft.getInstance().gui.hud.getChat().clearMessages(clearHistory);
    }

    @Override // net.labymod.core.client.chat.InternalChatModifier
    public void deleteMessage(ChatMessage message) {
        VersionedChatComponent accessor = Minecraft.getInstance().gui.hud.getChat();
    ...
    public void editMessage(ChatMessage message, Component component) {
        ...
        accessor.getMessages().set(index, new GuiMessage(prevMessage.addedTime(), versionedChatMessageComponent, prevMessage.signature(), prevMessage.source(), prevMessage.tag()));
