...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gfx/pipeline/renderer/text/FontAccessor.class */
public interface FontAccessor {
    ebr labyMod$getFontSet(yt ytVar);
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph.class */
    public static final class MinecraftGlyph extends Record {
        private final ebu glyph;
        private final drq info;

        public MinecraftGlyph(ebu glyph, drq info) {
            this.glyph = glyph;
            this.info = info;
        }
        ...
        public final String toString() {
            return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, MinecraftGlyph.class), MinecraftGlyph.class, "glyph;info", "FIELD:Lnet/labymod/v1_18_2/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->glyph:Lebu;", "FIELD:Lnet/labymod/v1_18_2/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->info:Ldrq;").dynamicInvoker().invoke(this) /* invoke-custom */;
        }
        ...
        public final boolean equals(Object o) {
            return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, MinecraftGlyph.class, Object.class), MinecraftGlyph.class, "glyph;info", "FIELD:Lnet/labymod/v1_18_2/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->glyph:Lebu;", "FIELD:Lnet/labymod/v1_18_2/client/gfx/pipeline/renderer/text/FontAccessor$MinecraftGlyph;->info:Ldrq;").dynamicInvoker().invoke(this, o) /* invoke-custom */;
        }
