...
import net.labymod.v1_20_6.client.resources.texture.VersionedLabyTexture;
import org.jetbrains.annotations.NotNull;
import org.joml.Matrix4f;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/util/MinecraftUtil.class */
public final class MinecraftUtil {
    ...
    private static final faa VIEW_MATRIX_STACK = new faa();
    ...
    public static Stack obtainStackFromGraphics(fgt graphics) {
        return graphics.c().stack();
    }

    public static void obtainScreenContextFromGraphics(fgt graphics, Consumer<ScreenContext> callback) {
    ...
    public static void obtainScreenContextFromGraphics(fgt graphics, int mouseX, int mouseY, float tickDelta, Consumer<ScreenContext> callback) {
    ...
    public static ItemStack fromMinecraftSlot(btr entity, LivingEntity.EquipmentSpot spot) {
        return fromMinecraft(entity.a(toMinecraft(spot)));
    }

    public static ItemStack fromMinecraft(cur itemStack) {
        return (ItemStack) itemStack;
    }

    public static cur toMinecraft(ItemStack itemStack) {
        return (cur) itemStack;
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static Direction fromMinecraft(je direction) throws MatchException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static je toMinecraft(@NotNull Direction direction) throws MatchException {
        switch (direction) {
            case DOWN:
                return je.a;
            case UP:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static btd toMinecraft(LivingEntity.EquipmentSpot spot) throws MatchException {
        switch (spot) {
            case HEAD:
                return btd.f;
            case CHEST:
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    public static ModelTransformType fromMinecraft(cuo context) throws MatchException {
    ...
    public static ServerType fromMinecraft(fyl data) {
        if (data.e()) {
    ...
    public static void exportScreenshotToFile(ezb image, File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(Player player) {
        gix dispatcher = ffh.Q().ap();
        goe goeVarA = dispatcher.a((bsw) player);
    ...
    /* JADX INFO: renamed from: net.labymod.v1_20_6.client.util.MinecraftUtil$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/util/MinecraftUtil$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$item$ItemDisplayContext = new int[cuo.values().length];
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.a.ordinal()] = 1;
            } catch (NoSuchFieldError e13) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.b.ordinal()] = 2;
            } catch (NoSuchFieldError e14) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.c.ordinal()] = 3;
            } catch (NoSuchFieldError e15) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.d.ordinal()] = 4;
            } catch (NoSuchFieldError e16) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.e.ordinal()] = 5;
            } catch (NoSuchFieldError e17) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.f.ordinal()] = 6;
            } catch (NoSuchFieldError e18) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.g.ordinal()] = 7;
            } catch (NoSuchFieldError e19) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.h.ordinal()] = 8;
            } catch (NoSuchFieldError e20) {
            }
            try {
                $SwitchMap$net$minecraft$world$item$ItemDisplayContext[cuo.i.ordinal()] = 9;
            ...
            $SwitchMap$net$minecraft$core$Direction = new int[je.values().length];
            try {
                $SwitchMap$net$minecraft$core$Direction[je.a.ordinal()] = 1;
            ...
            try {
                $SwitchMap$net$minecraft$core$Direction[je.c.ordinal()] = 3;
            } catch (NoSuchFieldError e34) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[je.d.ordinal()] = 4;
            } catch (NoSuchFieldError e35) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[je.e.ordinal()] = 5;
            } catch (NoSuchFieldError e36) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[je.f.ordinal()] = 6;
    ...
    public static CookieStorage fromMinecraft(fyp state) {
        if (state == null) {
            return null;
        }
    ...
    public static fyp toMinecraft(CookieStorage storage) {
        Map<ResourceLocation, byte[]> apiCookies = storage.cookies();
        Map<alf, byte[]> cookies = new HashMap<>(apiCookies.size());
        for (Map.Entry<ResourceLocation, byte[]> entry : apiCookies.entrySet()) {
            cookies.put((alf) entry.getKey().getMinecraftLocation(), entry.getValue());
        }
        return new fyp(cookies);
    }
    ...
    public static gom toMinecraft(Object texture) {
        return TEXTURES.apply(texture);
    }

    public static fgt getCurrentGuiGraphics() {
        return currentGuiGraphics;
    }

    public static void setCurrentGuiGraphics(fgt currentGuiGraphics2) {
        currentGuiGraphics = currentGuiGraphics2;
    }

    public static bsw unwrapEntity(bsw entity) {
        if (entity instanceof cib) {
            cib part = (cib) entity;
            return part.b;
        }
        return entity;
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/util/MinecraftUtil$LevelRenderContext.class */
    public static class LevelRenderContext {
        ...
        public void setPoseStack(faa poseStack) {
