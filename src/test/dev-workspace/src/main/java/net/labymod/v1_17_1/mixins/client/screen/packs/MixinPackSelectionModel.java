package net.labymod.v1_17_1.mixins.client.screen.packs;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/client/screen/packs/MixinPackSelectionModel.class */
@Mixin({edh.class})
public class MixinPackSelectionModel {
    ...
    private List<adg> getAvailablePacks() {
