package net.labymod.v1_17_1.client.player;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/player/VersionedNetworkPlayerInfo.class */
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo {
    private final ejm wrapped;
    private final Component usernameComponent = Component.text(profile().getUsername());
    private Metadata metadata = Metadata.create();

    public VersionedNetworkPlayerInfo(ejm wrapped) {
    ...
    /* JADX INFO: renamed from: net.labymod.v1_17_1.client.player.VersionedNetworkPlayerInfo$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/player/VersionedNetworkPlayerInfo$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$world$level$GameType = new int[bwn.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$world$level$GameType[bwn.a.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$GameType[bwn.b.ordinal()] = 2;
    ...
    public ejm getWrapped() {
        return this.wrapped;
    }

    private os decorateComponent(@NotNull ejm info, oy mutableComponent) {
        if (info.b() == bwn.d) {
