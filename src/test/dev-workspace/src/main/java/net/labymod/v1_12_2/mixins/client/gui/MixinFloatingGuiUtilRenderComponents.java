...
import net.labymod.v1_12_2.client.font.text.FloatingFontRenderer;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;
import org.spongepowered.asm.mixin.injection.At;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_12_2/mixins/client/gui/MixinFloatingGuiUtilRenderComponents.class */
@Mixin({bjc.class})
public abstract class MixinFloatingGuiUtilRenderComponents {
    @Shadow
    public static String a(String lvt_0_1_, boolean lvt_1_1_) {
        return null;
    }

    @Insert(method = {"splitText"}, at = @At("HEAD"), cancellable = true)
    private static void labyMod$splitTextFloat(hh rawText, int maxWidth, bip renderer, boolean removeLeadingSpaces, boolean p_splitText_4_, InsertInfoReturnable<List<hh>> callback) {
