...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<fqj> getTabs();

    fqk getTabManager();

    VersionedTab versionedTabOf(fqj fqjVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_3/client/gui/TabNavigationBarAccessor$VersionedTab.class */
