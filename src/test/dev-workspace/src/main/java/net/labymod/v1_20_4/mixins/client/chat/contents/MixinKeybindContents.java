...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/mixins/client/chat/contents/MixinKeybindContents.class */
@Mixin({wj.class})
public abstract class MixinKeybindContents implements KeybindContentsAccessor {
    ...
    @Shadow
    protected abstract vf c();

    @Override // net.labymod.v1_20_4.client.network.chat.contents.KeybindContentsAccessor
