...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/direct/FileChooserWidgetDirectPropertyValueAccessor.class */
public class FileChooserWidgetDirectPropertyValueAccessor extends ButtonWidgetDirectPropertyValueAccessor {
    LssPropertyResetter FileChooserWidgetResetter = new FileChooserWidgetLssPropertyResetter();
