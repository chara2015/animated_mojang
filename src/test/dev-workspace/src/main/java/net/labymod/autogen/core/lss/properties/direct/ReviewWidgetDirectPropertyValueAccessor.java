...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/ReviewWidgetDirectPropertyValueAccessor.class */
public class ReviewWidgetDirectPropertyValueAccessor extends VerticalListWidgetDirectPropertyValueAccessor {
    LssPropertyResetter ReviewWidgetResetter = new ReviewWidgetLssPropertyResetter();
