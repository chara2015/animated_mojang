...
import net.labymod.autogen.core.lss.properties.resetters.WaveTextWidgetLssPropertyResetter;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/core/lss/properties/direct/WaveTextWidgetDirectPropertyValueAccessor.class */
public class WaveTextWidgetDirectPropertyValueAccessor extends SimpleWidgetDirectPropertyValueAccessor {
    LssPropertyResetter WaveTextWidgetResetter = new WaveTextWidgetLssPropertyResetter();
    ...
    public LssPropertyResetter getPropertyResetter() {
        return this.WaveTextWidgetResetter;
    }
}
