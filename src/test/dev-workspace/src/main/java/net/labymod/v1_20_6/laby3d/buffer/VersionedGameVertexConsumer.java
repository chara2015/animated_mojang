package net.labymod.v1_20_6.laby3d.buffer;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/laby3d/buffer/VersionedGameVertexConsumer.class */
public class VersionedGameVertexConsumer implements GameVertexConsumer {
    ...
    public VersionedGameVertexConsumer(fae delegate) {
