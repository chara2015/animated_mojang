...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/mixins/nbt/MixinListTag.class */
@Mixin({ng.class})
...
public abstract class MixinListTag implements NBTTagList {
    ...
    @Shadow
    public abstract boolean b(int i, ns nsVar);

    @Shadow
    public abstract boolean a(int i, ns nsVar);

    @Shadow
    public abstract void c(int i, ns nsVar);

    @Shadow
    public abstract ns shadow$c(int i);
