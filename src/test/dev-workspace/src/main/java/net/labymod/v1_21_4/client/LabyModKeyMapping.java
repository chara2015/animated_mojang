package net.labymod.v1_21_4.client;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends fli {
    private static final Function<Hotkey, fli> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        fli labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static fli create(Hotkey hotkey) {
