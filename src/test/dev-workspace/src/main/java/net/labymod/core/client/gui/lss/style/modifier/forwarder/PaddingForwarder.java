...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/core/client/gui/lss/style/modifier/forwarder/PaddingForwarder.class */
    ...
    public void forward(Widget widget, String key, ProcessedObject object) {
        if (widget instanceof AbstractWidget) {
            ...
            if (value instanceof String) {
                ...
                if (sides.length > 0) {
                    abstractWidget.paddingTop().set(Float.valueOf(Float.parseFloat(sides[0])));
                }
                if (sides.length > 1) {
                    abstractWidget.paddingRight().set(Float.valueOf(Float.parseFloat(sides[1])));
                }
                if (sides.length > 2) {
                    abstractWidget.paddingBottom().set(Float.valueOf(Float.parseFloat(sides[2])));
                }
                if (sides.length > 3) {
                    abstractWidget.paddingLeft().set(Float.valueOf(Float.parseFloat(sides[3])));
                    return;
                }
                return;
            }
            float padding = ((Float) value).floatValue();
            abstractWidget.paddingLeft().set(Float.valueOf(padding));
            abstractWidget.paddingTop().set(Float.valueOf(padding));
            abstractWidget.paddingRight().set(Float.valueOf(padding));
            abstractWidget.paddingBottom().set(Float.valueOf(padding));
        }
    }
