package net.labymod.v1_21_4.laby3d.pipeline.target;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/laby3d/pipeline/target/VersionedRenderTarget.class */
public class VersionedRenderTarget implements RenderTarget, GlResource {
    private final fef wrapped;

    public VersionedRenderTarget(fef wrapped) {
    ...
    public DeviceTextureView findDepthTexture() {
        return new ExternalGlDeviceTextureView(this.wrapped.h(), this.wrapped.c, this.wrapped.d);
    }
