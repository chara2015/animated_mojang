package net.labymod.v1_8_9.mojang;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/mojang/WrappedPropertyMap.class */
public class WrappedPropertyMap extends PropertyMap {
    ...
    public boolean putAll(@NotNull Multimap<? extends String, ? extends com.mojang.authlib.properties.Property> multimap) {
        ...
        for (Map.Entry<? extends String, ? extends com.mojang.authlib.properties.Property> entry : multimap.entries()) {
            Collection<Property> properties = getProperties((String) entry.getKey());
            properties.add(createProperty((com.mojang.authlib.properties.Property) entry.getValue()));
        }
        return putAllSuccess;
    }
