...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/mixins/client/screen/MixinBookScreenVanillaFont.class */
@Mixin({fvj.class, fvi.class})
public class MixinBookScreenVanillaFont {
    @Insert(method = {"render"}, at = @At("HEAD"))
    public void labyMod$enableVanillaFont(fof graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
    ...
    public void labyMod$resetFont(fof graphics, int mouseX, int mouseY, float partialTicks, InsertInfo ci) {
        RenderAttributesStack renderAttributesStack = renderAttributesStack();
