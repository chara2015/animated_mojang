...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<eqz> getTabs();

    era getTabManager();

    VersionedTab versionedTabOf(eqz eqzVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_1/client/gui/TabNavigationBarAccessor$VersionedTab.class */
