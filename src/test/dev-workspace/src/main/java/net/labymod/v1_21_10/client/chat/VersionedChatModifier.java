...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/chat/VersionedChatModifier.class */
@Singleton
...
public class VersionedChatModifier implements InternalChatModifier {
    ...
    public void fireChatClear(boolean clearHistory) {
        fzz.W().j.e().a(clearHistory);
    }

    @Override // net.labymod.core.client.chat.InternalChatModifier
    public void deleteMessage(ChatMessage message) {
        VersionedChatComponent accessor = fzz.W().j.e();
    ...
    public void editMessage(ChatMessage message, Component component) {
        ...
        fzs prevMessage = accessor.getMessages().get(index);
        VersionedChatMessageComponent versionedChatMessageComponent = new VersionedChatMessageComponent(message, (xx) this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new fzs(prevMessage.b(), versionedChatMessageComponent, prevMessage.d(), prevMessage.e()));
    ...
    private Predicate<fzs> messageFilter(ChatMessage message) {
        return m -> {
