...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/TabNavigationBarAccessor.class */
public interface TabNavigationBarAccessor {
    ImmutableList<fwb> getTabs();

    fwc getTabManager();

    VersionedTab versionedTabOf(fwb fwbVar);

    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/client/gui/TabNavigationBarAccessor$VersionedTab.class */
