package net.labymod.v1_19_4.mixins.client.world.chunk;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_19_4/mixins/client/world/chunk/MixinChunkAccess.class */
@Mixin({ddn.class})
public abstract class MixinChunkAccess implements Chunk {
    ...
    @Shadow
    @Final
    protected Map<gt, cze> i;

    @Shadow
    public abstract dgz a(a aVar);

    @Shadow
    public abstract ddz b(int i);

    @Shadow
    public abstract ddz[] d();
    ...
    public boolean isLoaded() {
        return !(this instanceof ddu);
    }

    @Override // net.labymod.api.client.world.chunk.Chunk
    public BlockState getBlockState(int x, int y, int z) {
        int index = ((ddn) this).e(y);
        if (index < 0 || index >= this.k.length) {
            return cpj.a.o();
        }
        ddz section = this.k[index];
        if (section == null) {
            return cpj.a.o();
        }
        int yPos = y & 15;
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (Map.Entry<gt, cze> entry : this.i.entrySet()) {
            int i = index;
            index++;
