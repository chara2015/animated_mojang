package net.labymod.v1_21_8.client.util.math;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/client/util/math/VersionedGameMathMapper.class */
@Singleton
...
public class VersionedGameMathMapper implements GameMathMapper {
    ...
    public AxisAlignedBoundingBox fromAABB(Object aabb) {
        if (!(aabb instanceof fin)) {
            return BOX_IDENTITY;
        }
        fin gameAABB = (fin) aabb;
    ...
    public <T> T toAABB(AxisAlignedBoundingBox axisAlignedBoundingBox) {
        return (T) new fin(axisAlignedBoundingBox.getMinX(), axisAlignedBoundingBox.getMinY(), axisAlignedBoundingBox.getMinZ(), axisAlignedBoundingBox.getMaxX(), axisAlignedBoundingBox.getMaxY(), axisAlignedBoundingBox.getMaxZ());
    }
