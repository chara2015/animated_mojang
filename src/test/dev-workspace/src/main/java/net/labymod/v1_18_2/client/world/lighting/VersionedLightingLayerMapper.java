package net.labymod.v1_18_2.client.world.lighting;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/world/lighting/VersionedLightingLayerMapper.class */
@Singleton
...
public class VersionedLightingLayerMapper implements LightingLayerMapper {
    ...
    public LightType fromMinecraft(Object value) throws MatchException {
        if (!(value instanceof cbe)) {
            throw new IllegalArgumentException(value.getClass().getName() + " is not an instance of " + cbe.class.getName());
        }
        cbe lightLayer = (cbe) value;
    ...
    /* JADX INFO: renamed from: net.labymod.v1_18_2.client.world.lighting.VersionedLightingLayerMapper$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/world/lighting/VersionedLightingLayerMapper$1.class */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$minecraft$world$level$LightLayer = new int[cbe.values().length];
            try {
                $SwitchMap$net$minecraft$world$level$LightLayer[cbe.a.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$world$level$LightLayer[cbe.b.ordinal()] = 2;
