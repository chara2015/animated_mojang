...
import net.labymod.v1_8_9.client.gfx.pipeline.renderer.OptiFineFontAccessor;
import org.jetbrains.annotations.Nullable;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage.class */
@Singleton
...
public class VersionedVanillaGlyphStorage extends VanillaGlyphStorage {
    ...
    private final Supplier<avn> fontRenderer;
    ...
    public void reload(ResourceLocation defaultFontLocation) {
        clear();
        FontRendererAccessor accessor = (avn) this.fontRenderer.get();
    ...
    /* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext.class */
    static final class FontContext extends Record {
        ...
        public final String toString() {
            return (String) ObjectMethods.bootstrap(MethodHandles.lookup(), "toString", MethodType.methodType(String.class, FontContext.class), FontContext.class, "accessor;ofAccessor;boldOffset", "FIELD:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext;->accessor:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/FontRendererAccessor;", "FIELD:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext;->ofAccessor:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/OptiFineFontAccessor;", "FIELD:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext;->boldOffset:F").dynamicInvoker().invoke(this) /* invoke-custom */;
        }
        ...
        public final boolean equals(Object o) {
            return (boolean) ObjectMethods.bootstrap(MethodHandles.lookup(), "equals", MethodType.methodType(Boolean.TYPE, FontContext.class, Object.class), FontContext.class, "accessor;ofAccessor;boldOffset", "FIELD:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext;->accessor:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/FontRendererAccessor;", "FIELD:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext;->ofAccessor:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/OptiFineFontAccessor;", "FIELD:Lnet/labymod/v1_8_9/client/gfx/pipeline/renderer/text/VersionedVanillaGlyphStorage$FontContext;->boldOffset:F").dynamicInvoker().invoke(this, o) /* invoke-custom */;
        }
