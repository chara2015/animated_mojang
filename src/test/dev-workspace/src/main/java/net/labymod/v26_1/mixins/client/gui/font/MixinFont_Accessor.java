package net.labymod.v26_1.mixins.client.gui.font;

import net.labymod.api.util.CastUtil;
import net.labymod.v26_1.client.gfx.pipeline.renderer.text.FontAccessor;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v26_1/mixins/client/gui/font/MixinFont_Accessor.class */
@Mixin({Font.class})
public abstract class MixinFont_Accessor implements FontAccessor {
    ...
    @Override // net.labymod.v26_1.client.gfx.pipeline.renderer.text.FontAccessor
