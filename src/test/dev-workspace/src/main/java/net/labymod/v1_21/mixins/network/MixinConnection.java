...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21/mixins/network/MixinConnection.class */
@Mixin({vt.class})
...
public abstract class MixinConnection implements NettyConnection {
    ...
    public wz labyMod4$modifyReason(wz component) {
        ...
        return (wz) componentMapper.toMinecraftComponent(((ServerKickEvent) Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY))).reason());
    }
}
