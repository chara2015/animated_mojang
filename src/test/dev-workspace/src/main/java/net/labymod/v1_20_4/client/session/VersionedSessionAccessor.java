...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_4/client/session/VersionedSessionAccessor.class */
@Singleton
@Implements(SessionAccessor.class)
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<evx> {
    ...
    public evx toGameSession(Session session) {
        return (evx) this.userFactory.createUser(session);
    }

    @Override // net.labymod.core.client.session.DefaultAbstractSessionAccessor
    public Session fromGameSession(evx gameSession) {
        if (gameSession == null) {
            return null;
        }
