...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/mixins/world/level/block/entity/MixinBlockEntity.class */
@Mixin({dpj.class})
...
public abstract class MixinBlockEntity implements BlockEntity {
    ...
    @Shadow
    public abstract iz ay_();

    @Shadow
    public abstract boolean o();

    @Shadow
    public abstract dse n();
