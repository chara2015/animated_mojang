...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_8/mixins/client/chat/contents/MixinScoreContents.class */
@Mixin({yw.class})
public class MixinScoreContents implements ScoreContentsAccessor {
    ...
    @Override // net.labymod.v1_21_8.client.network.chat.contents.ScoreContentsAccessor
