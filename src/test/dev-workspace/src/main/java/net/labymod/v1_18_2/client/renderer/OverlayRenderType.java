...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_18_2/client/renderer/OverlayRenderType.class */
public class OverlayRenderType extends era {
    ...
    public OverlayRenderType() {
        super("labymod_overlay", dtk.n, b.h, 256, false, true, () -> {
            Laby.references().laby3D().storeStates();
            RenderSystem.setShader(eql::q);
