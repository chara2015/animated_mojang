...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/client/util/BlockOutlineUtil.class */
public class BlockOutlineUtil {
    public static void renderBlockOutline(drq level, hfw bufferSource, fud lineConsumer, fua poseStack, double x, double y, double z, ibn renderState, int color) {
        ja blockPos = renderState.a();
        ...
        if (overlayColor != null) {
            fud overlayConsumer = bufferSource.a(hgk.z());
    ...
    private static a drawLines(fud vertexConsumer, a pose, double x, double y, double z, Color color) {
        ...
        return (minX, minY, minZ, maxX, maxY, maxZ) -> {
            ...
            float offset = bfh.c((blockX * blockX) + (blockY * blockY) + (blockZ * blockZ));
    ...
    private static a drawBoxes(fud vertexConsumer, a pose, double x, double y, double z, Color color) {
        float red = color.getRed() / 255.0f;
        float green = color.getGreen() / 255.0f;
        float blue = color.getBlue() / 255.0f;
        float alpha = color.getAlpha() / 255.0f;
    ...
    private static fud addVertex(fud vertexConsumer, Matrix4f matrix, double x, double y, double z) {
