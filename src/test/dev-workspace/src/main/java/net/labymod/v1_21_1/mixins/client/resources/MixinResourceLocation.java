...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_1/mixins/client/resources/MixinResourceLocation.class */
@Mixin({akr.class})
...
public abstract class MixinResourceLocation implements ResourceLocation {
    ...
    public InputStream openStream() throws IOException {
        ...
        return ((auc) fgo.Q().ab().getResource((akr) getMinecraftLocation()).orElseThrow(IOException::new)).d();
    }

    @Override // net.labymod.api.client.resources.ResourceLocation
    public boolean exists() {
        return ResourcesUtil.hasResource((ResourceLocation) getMinecraftLocation()) || fgo.Q().ab().getResource((akr) getMinecraftLocation()).isPresent();
    }
