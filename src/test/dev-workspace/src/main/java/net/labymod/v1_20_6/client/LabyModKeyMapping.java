...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/LabyModKeyMapping.class */
public class LabyModKeyMapping extends fff {
    private static final Function<Hotkey, fff> KEY_MAPPINGS = Laby.references().functionMemoizeStorage().memoize(hotkey -> {
        String category = hotkey.category();
        fff labyModKeyMapping = new LabyModKeyMapping(I18n.translate(hotkey.translationKey(), new Object[0]), hotkey.accessor(), category);
    ...
    public static fff create(Hotkey hotkey) {
