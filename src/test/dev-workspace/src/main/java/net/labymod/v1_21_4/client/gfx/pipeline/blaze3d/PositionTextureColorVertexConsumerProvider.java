...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gfx/pipeline/blaze3d/PositionTextureColorVertexConsumerProvider.class */
public class PositionTextureColorVertexConsumerProvider {
    private static boolean initialized;
    private static boolean isVertexBufferWriterPresent = false;

    public static ffz create() {
        check();
