...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_17_1/client/gui/screen/LabyScreenRenderer.class */
public class LabyScreenRenderer extends eaq implements FileDropHandler, LabyScreenAccessor {
    private final VanillaLabyScreen screen;

    public LabyScreenRenderer(LabyScreen screen) {
        super((os) Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull dql poseStack, int mouseX, int mouseY, float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(@NotNull dvp mc, int width, int height) {
        this.screen.pushCustomFontStack();
