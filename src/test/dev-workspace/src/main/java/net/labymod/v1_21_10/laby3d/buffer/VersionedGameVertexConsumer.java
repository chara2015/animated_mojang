...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/laby3d/buffer/VersionedGameVertexConsumer.class */
public class VersionedGameVertexConsumer implements GameVertexConsumer {
    private static final int MASK = 255;
    private static final int SHIFT = 16;
    private final fud delegate;

    public VersionedGameVertexConsumer(fud delegate) {
