...
import net.labymod.v1_20_6.client.player.VersionedNetworkPlayerInfo;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_20_6/client/util/WatchablePlayerInfoSet.class */
public class WatchablePlayerInfoSet implements WatchableSet<fyi> {
    ...
    public void onAdd(fyi playerInfo) {
    ...
    @Override // net.labymod.core.watcher.collection.WatchableCollection
    public void onRemove(fyi playerInfo) {
        NetworkPlayerInfo networkPlayerInfo = findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(fyi info) {
