...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/autogen/api/lss/properties/resetters/ShadeSelectorWidgetLssPropertyResetter.class */
public class ShadeSelectorWidgetLssPropertyResetter extends SelectorWidgetLssPropertyResetter {
    ...
    public void reset(Widget widget) {
        if (widget instanceof ShadeSelectorWidget) {
        }
        super.reset(widget);
    }
}
