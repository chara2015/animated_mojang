...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_5/mixins/client/renderer/MixinGameRendererScreen.class */
@Mixin({grd.class})
public class MixinGameRendererScreen {
    ...
    private void labyMod$storeStack(fzq instance, ftk graphics, int mouseX, int mouseY, float tickDelta, Operation<Void> original) {
