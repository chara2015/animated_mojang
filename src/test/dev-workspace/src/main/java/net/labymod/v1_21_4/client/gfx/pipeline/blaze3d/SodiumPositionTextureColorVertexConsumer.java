package net.labymod.v1_21_4.client.gfx.pipeline.blaze3d;
...
/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_4/client/gfx/pipeline/blaze3d/SodiumPositionTextureColorVertexConsumer.class */
public class SodiumPositionTextureColorVertexConsumer extends Blaze3DVertexProvider implements ffz, VertexBufferWriter {
    ...
    public ffz a(float x, float y, float z) {
        this.current = new Blaze3DVertex(x, y, z);
        return this;
    }

    public ffz a(int red, int green, int blue, int alpha) {
        this.current.setArgb(red, green, blue, alpha);
        return this;
    }

    public ffz a(float u, float v) {
        this.current.setUv(u, v);
        return this;
    }

    public ffz a(int var1, int var2) {
        return null;
    }

    public ffz b(int var1, int var2) {
        return null;
    }

    public ffz b(float var1, float var2, float var3) {
        return null;
    }

    public void push(MemoryStack memoryStack, long ptr, int count, fga description) {
