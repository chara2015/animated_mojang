...
import net.labymod.v1_21_10.client.gui.WrappedIntRangeBase;
import net.labymod.v1_21_10.mixins.client.gui.components.MixinAbstractSliderButton;
import org.jetbrains.annotations.Nullable;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Shadow;

/* JADX INFO: loaded from: LabyMod-4.jar:net/labymod/v1_21_10/mixins/client/MixinOptionInstanceSliderButton.class */
@Mixin({i.class})
public abstract class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton {
    ...
    @Override // net.labymod.v1_21_10.mixins.client.gui.components.MixinAbstractSliderButton, net.labymod.core.client.accessor.gui.SliderButtonAccessor
    ...
    private g labyMod$createWrappedIntRangeBase() {
        ...
        if (g.class.isAssignableFrom(cls)) {
            return new WrappedIntRangeBase(this.l);
        }
        return null;
    }
}
