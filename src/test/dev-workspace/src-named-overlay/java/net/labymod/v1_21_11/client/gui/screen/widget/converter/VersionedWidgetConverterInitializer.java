...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/gui/screen/widget/converter/VersionedWidgetConverterInitializer.class */
...
public class VersionedWidgetConverterInitializer implements WidgetConverterInitializer {
    public void initialize(WidgetConverterRegistry registry) {
        registry.exclude(new Class[]{SocialInteractionsScreen.class, InventoryScreen.class, CraftingScreen.class, FurnaceScreen.class, BlastFurnaceScreen.class, SmokerScreen.class, ChatScreen.class, AnvilScreen.class, CreativeModeInventoryScreen.class, AdvancementsScreen.class, CommandBlockEditScreen.class, MinecartCommandBlockEditScreen.class, JigsawBlockEditScreen.class, StructureBlockEditScreen.class, TestBlockEditScreen.class, TestInstanceBlockEditScreen.class, TitleScreen.class});
        registry.exclude(ExclusionStrategy.widget(InBedChatScreen.class, EditBox.class));
        registry.exclude(ExclusionStrategy.parent(DialogScreen.class));
        registry.exclude(PageButton.class);
        registry.register(new ButtonConverter(), new Class[]{Button.class, CycleButton.class, ImageButton.class, LockIconButton.class});
        registry.register(new SliderConverter(), new Class[]{AbstractSliderButton.class, AbstractOptionSliderButton.class, OptionInstance.OptionInstanceSliderButton.class});
        registry.register(new TextFieldConverter(), new Class[]{EditBox.class});
        registry.register(new TabLayoutConverter(), new Class[]{TabNavigationBar.class});
        registry.register(new StringConverter(), new Class[]{StringWidget.class});
    }
}
