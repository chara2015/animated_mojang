...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/component/format/numbers/VersionedNumberFormatMapper.class */
@Singleton
...
public class VersionedNumberFormatMapper implements NumberFormatMapper {
    ...
    public NumberFormat fromMinecraft(Object obj) {
        ...
        if (!(obj instanceof net.minecraft.network.chat.numbers.NumberFormat)) {
            throw new IllegalArgumentException("Object net.minecraft.core.BlockPos not an instance of " + String.valueOf(net.minecraft.network.chat.numbers.NumberFormat.class));
        }
