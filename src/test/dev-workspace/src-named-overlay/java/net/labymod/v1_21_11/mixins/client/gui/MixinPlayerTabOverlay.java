...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/gui/MixinPlayerTabOverlay.class */
...
public class MixinPlayerTabOverlay implements TabList {
    ...
    private void shouldRenderWidgetList(GuiGraphics graphics, int screenWidth, Scoreboard scoreboard, Objective objective, InsertInfo ci) {
        if (((Boolean) Laby.labyAPI().config().multiplayer().customPlayerList().get()).booleanValue()) {
            ci.cancel();
        }
    }
