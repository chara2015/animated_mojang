...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/mixins/client/gui/components/MixinGuiEventListener.class */
...
public interface MixinGuiEventListener {
    ...
    @Overwrite
    default boolean a(MouseButtonEvent event, boolean doubleClick) {
    ...
    @Overwrite
    default boolean b(MouseButtonEvent event) {
        double mouseX = event.x();
        double mouseY = event.y();
        int button = event.button();
        return handleConvertedWidget((converter, widget) -> {
    ...
    @Overwrite
    default boolean a(MouseButtonEvent event, double deltaX, double deltaY) {
        double mouseX = event.x();
        double mouseY = event.y();
        int button = event.button();
        return handleConvertedWidget((converter, widget) -> {
    ...
    @Overwrite
    default boolean a(CharacterEvent event) {
        return handleConvertedWidget((converter, widget) -> {
            boolean flag = false;
    ...
    @Overwrite
    default boolean a(KeyEvent event) {
        return handleConvertedWidget((converter, widget) -> {
    ...
    @Overwrite
    default boolean b(KeyEvent event) {
        return handleConvertedWidget((converter, widget) -> {
