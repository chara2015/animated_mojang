...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/multiplayer/server/VersionedServerData.class */
public class VersionedServerData extends ServerData {
    ...
    public void acceptCodeOfConduct(@NotNull String codeOfConduct) {
        ...
        StorageServerData storageServerData = this.serverData;
        if (storageServerData instanceof StorageServerData) {
            StorageServerData storageServerData2 = storageServerData;
            storageServerData2.setAcceptedCodeOfConduct(this.acceptedCodeOfConduct);
        }
    }
    ...
    public void setResourcePackStatus(@NotNull ServerData.ServerPackStatus packStatus) {
        ...
        if (storageServerData instanceof StorageServerData) {
            StorageServerData storageServerData2 = storageServerData;
            storageServerData2.setResourcePackStatus(of(packStatus));
        }
    }
    ...
    public static ServerData.ServerPackStatus of(ServerResourcePackStatus resourcePackStatus) {
        switch (AnonymousClass1.$SwitchMap$net$labymod$api$client$network$server$storage$ServerResourcePackStatus[resourcePackStatus.ordinal()]) {
            case 1:
    ...
    /* JADX INFO: renamed from: net.labymod.v1_21_11.client.multiplayer.server.VersionedServerData$1, reason: invalid class name */
    /* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/multiplayer/server/VersionedServerData$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$labymod$api$client$network$server$storage$ServerResourcePackStatus;
