...
/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/multiplayer/server/storage/VersionedServerList.class */
public class VersionedServerList extends DefaultServerList {
    ...
    private StorageServerData tagToServerData(CompoundTag tag) throws MatchException {
        ...
        if (tag.contains("acceptedCodeOfConduct")) {
            data.setAcceptedCodeOfConduct(tag.getIntOr("acceptedCodeOfConduct", 0));
        }
        return data;
    }
}
