...
import net.labymod.v1_21_11.client.network.chat.contents.LiteralContentsAccessor;
import net.minecraft.network.chat.ComponentContents;
import net.minecraft.network.chat.MutableComponent;
import net.minecraft.network.chat.contents.PlainTextContents;

/* JADX INFO: loaded from: LabyMod-4-v1_21_11-named.jar:net/labymod/v1_21_11/client/network/chat/VersionedTextComponent.class */
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, ComponentContents> implements TextComponent {
    ...
    public TextComponent m22plainCopy() {
        return this.empty ? ComponentService.empty() : ComponentService.textComponent(getText());
    }

    @Override // net.labymod.v1_21_11.client.network.chat.VersionedBaseComponent
